...
public class KacoBlueplanetImpl extends AbstractSunSpecPvInverter
		implements KacoBlueplanet, SunSpecPvInverter, ManagedSymmetricPvInverter, ModbusComponent, AsymmetricMeter,
		SymmetricMeter, OpenemsComponent, EventHandler, ModbusSlave {
	...
	public KacoBlueplanetImpl() throws OpenemsException {
		super(//
				ACTIVE_MODELS, //
				...
				KacoBlueplanet.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(KacoBlueplanetImpl.class, accessMode, 100) //
						.build());
	}
}
