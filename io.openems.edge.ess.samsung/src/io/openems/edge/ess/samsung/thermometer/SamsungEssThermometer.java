...
public interface SamsungEssThermometer
	...
	public static enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		COMMUNICATION_FAILED(Doc.of(Level.FAULT)
				.text("Samsung ESS not reachable or false output!")),
        PV_PW(Doc.of(OpenemsType.DOUBLE).text("PV Power")),
        ACTIVE_PRODUCTION_ENERGY(Doc.of(OpenemsType.INTEGER).text("Active Production Energy"));
