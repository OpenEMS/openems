...
public class SamsungEssImpl extends AbstractOpenemsComponent
	...
	private void fetchAndUpdateEssRealtimeStatus() {
	    try {
	        ...
	        log.debug("Fetched Real-time Status: " + necessaryData);
	        ...
	        log.debug("PvPw: " + PvPw + ", PcsPw: " + PcsPw + ", btSoc: " + btSoc + ", BtStusCd: " + BtStusCd);
	        ...
	        switch (BtStusCd) {
	            case 0:
	                ...
	                if (PcsPw > 0) {
	                    ...
	                    log.info("Discharging0: " + PcsPw);

	                } else {
	                	this._setDcDischargePower((int) -PcsPw);
	                    this.calculateAcChargeEnergy.update((int) -PcsPw);
	                    this.calculateAcDischargeEnergy.update(0);
	                    log.info("Discharging1: " + -PcsPw);
	            ...
	            case 1:
	                ...
	                if (PcsPw > 0) {
	                    ...
	                    this.calculateAcChargeEnergy.update((int) PcsPw);
	                    this.calculateAcDischargeEnergy.update(0);
	                    log.info("Charging:0" + PcsPw);

	                } else {
	        	        this._setDcDischargePower((int) -PcsPw);
	                    this.calculateAcChargeEnergy.update(0);
	                    this.calculateAcDischargeEnergy.update((int) -PcsPw);
	                    log.info("Charging:1" + -PcsPw);
	...
	public Integer getSurplusPower() {
	    try {
	        // Fetch the necessary data from the API
	        JsonObject necessaryData = samsungApi.getEssRealtimeStatus();
	        log.debug("Fetched Real-time Status for Surplus Power Calculation: " + necessaryData);
	        ...
	        log.info("Surplus Power: " + surplusPower);
