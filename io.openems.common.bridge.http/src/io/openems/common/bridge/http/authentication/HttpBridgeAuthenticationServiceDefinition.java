...
public record HttpBridgeAuthenticationServiceDefinition(//
	...
	public HttpBridgeAuthenticationServiceDefinition(Supplier<CompletableFuture<HttpHeader>> authHeaderSupplier) {
		this(authHeaderSupplier, DEFAULT_SESSION_EXPIRED_PREDICATE);
	}
	...
	public HttpBridgeAuthenticationService create(//
		...
		return new HttpBridgeAuthenticationService(bridgeHttp, this.authHeaderSupplier(),
				this.sessionExpiredPredicate());
	}
}
