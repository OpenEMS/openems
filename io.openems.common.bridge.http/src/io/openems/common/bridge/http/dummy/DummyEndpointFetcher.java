...
public class DummyEndpointFetcher implements EndpointFetcher {
	...
	public record DummyHandler(//
			boolean singleUse, //
			ThrowingFunction<BridgeHttp.Endpoint, HttpResponse<String>, HttpError> handler //
	) {
	 ...
	 */
	public void addEndpointHandler(ThrowingFunction<BridgeHttp.Endpoint, HttpResponse<String>, HttpError> handler) {
	 ...
	 */
	public void addSingleUseEndpointHandler(
			ThrowingFunction<BridgeHttp.Endpoint, HttpResponse<String>, HttpError> handler) {
