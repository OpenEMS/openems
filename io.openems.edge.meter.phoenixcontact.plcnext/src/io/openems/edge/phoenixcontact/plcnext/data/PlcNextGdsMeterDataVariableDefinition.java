package io.openems.edge.phoenixcontact.plcnext.data;
...
public enum PlcNextGdsMeterDataVariableDefinition implements PlcNextGdsDataVariableDefinition {
	...
	VOLTAGE_LINE_L12("voltageMeasurement.VoltageL12", List.of(PlcNextDevice.ChannelId.VOLTAGE_LINE_L12)), //
	VOLTAGE_LINE_L23("voltageMeasurement.VoltageL23", List.of(PlcNextDevice.ChannelId.VOLTAGE_LINE_L23)), //
	VOLTAGE_LINE_L31("voltageMeasurement.VoltageL23", List.of(PlcNextDevice.ChannelId.VOLTAGE_LINE_L31)), //
	...
	CURRENT_NEUTRAL("currentMeasurement.neutralCurrent", List.of(PlcNextDevice.ChannelId.CURRENT_NEUTRAL)), //
	...
	APPARENT_POWER("powerMeasurement.apparentPower", List.of(PlcNextDevice.ChannelId.APPARENT_POWER)), //
	APPARENT_POWER_L1("powerMeasurement.apparentPowerL1", List.of(PlcNextDevice.ChannelId.APPARENT_POWER_L1)), //
	APPARENT_POWER_L2("powerMeasurement.apparentPowerL2", List.of(PlcNextDevice.ChannelId.APPARENT_POWER_L2)), //
	APPARENT_POWER_L3("powerMeasurement.apparentPowerL3", List.of(PlcNextDevice.ChannelId.APPARENT_POWER_L3)), //
	POWER_FACTOR("powerMeasurement.powerFactor", List.of(PlcNextDevice.ChannelId.POWER_FACTOR)), //
