...
@interface Config {
	...
	// This will eventually be replaced by GridBuySoftLimit in Meta
	@Deprecated()
	...
	@AttributeDefinition(name = "Balancing Grid Setpoint", description = "The target setpoint for grid during BALANCING state. Positive for buy-from-grid; negative for sell-to-grid.")
	int balancingGridSetpoint() default 0;
