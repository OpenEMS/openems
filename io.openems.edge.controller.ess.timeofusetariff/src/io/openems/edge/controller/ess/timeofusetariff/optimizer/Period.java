...
public record Period(ZonedDateTime time, int production, int consumption, int essInitial, int essMaxCharge,
	...
	public static String header() {
		return "Time Production Consumption EssInitial EssMaxCharge EssMaxDischarge State State EssChargeDischarge Grid Price";
	}
	...
	public String toString() {
		return String.format(Locale.GERMAN, "%s %d %d %d %d %d %d %s %d %d %.2f", //
				...
				this.essChargeDischarge, this.grid, this.price);
	}
}