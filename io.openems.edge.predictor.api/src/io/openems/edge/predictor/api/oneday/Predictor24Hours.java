...
public interface Predictor24Hours extends OpenemsComponent {
	...
	/**
	 * Gives a prediction for the next 24 h; one value per 15 minutes; 96 values in
	 * total.
	 * 
	 * <p>
	 * E.g. if called at 10:30, the first value stands for 10:00 to 10:15; second
	 * value for 10:15 to 10:30.
	 * 
	 * @return the {@link Prediction24Hours}
	 */
	Prediction24Hours get24HoursPrediction();
