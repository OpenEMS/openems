...
public class FeneconMiniCoreImpl extends AbstractOpenemsModbusComponent
		implements FeneconMiniCore, SymmetricEss, OpenemsComponent, EventHandler {
	private String modbusBridgeId;
	private final Logger log = LoggerFactory.getLogger(FeneconMiniCoreImpl.class);
	...
	private FeneconMiniEss ess = null;
	...
	private FeneconMiniCharger charger = null;
	...
	private FeneconMiniGridMeter gridMeter = null;
...
//		Channel<Integer> activePower = this.channel(FeneconMiniCore.ChannelId.ACTIVE_POWER);
//		int actvPower = activePower.value().orElse(0);
//		syso
//	}
...
//
	private void defineWorkState() {
		...
		if (lastDefineWorkState == null || now.minusMinutes(1).isAfter(this.lastDefineWorkState)) {
			...
			IntegerWriteChannel setWorkStateChannel = this.channel(FeneconMiniCore.ChannelId.SET_WORK_STATE);
			try {
