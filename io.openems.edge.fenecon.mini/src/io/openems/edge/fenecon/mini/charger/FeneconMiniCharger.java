...
@Component( //
		name = "Fenecon.Mini.Charger", //
		immediate = true, //
		configurationPolicy = ConfigurationPolicy.REQUIRE, //
		property = EventConstants.EVENT_TOPIC + "=" + EdgeEventConstants.TOPIC_CYCLE_AFTER_WRITE //
)
public class FeneconMiniCharger extends AbstractOpenemsComponent implements EssDcCharger, OpenemsComponent {
