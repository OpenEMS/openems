...
public class ActivateEconomicMode4Handler extends StateHandler<State, Context> {

	private final Logger log = LoggerFactory.getLogger(ActivateEconomicMode4Handler.class);
