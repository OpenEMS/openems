...
public class FeneconMiniGridMeter extends AbstractOpenemsModbusComponent
		implements SymmetricMeter, OpenemsComponent, TimedataProvider, EventHandler {
		...
		return new ModbusProtocol(this, //
				...
				new FC3ReadRegistersTask(4811, Priority.LOW, //
						m(new BitsWordElement(4811, this) //
								.bit(13, ChannelId.COMMUNICATION_BREAK))) //
		);
	}
