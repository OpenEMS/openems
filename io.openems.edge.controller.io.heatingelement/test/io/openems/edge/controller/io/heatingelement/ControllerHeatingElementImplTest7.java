...
/**
 * A test to check if the controller is behaving correctly if the mode unreachable and active_forced_limit is reached.
 */
public class ControllerHeatingElementImplTest7 {
	...
	public void testUnreachable() throws Exception {
		var test = prepareTest(19000, "04:00");
	...
	public void testActiveForce() throws Exception {
		var test = prepareTest(10000, "08:10");
