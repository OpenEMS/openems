...
/**
 * A test to simulate three days with the configuration of a task scheduler in the workmode Time.
 */
public class ControllerHeatingElementImplTest10 {
    ...
    private void daySimulation(ControllerTest test) throws Exception {
        ...
        test.next(new AbstractComponentTest.TestCase() //
                ...
                .output(STATUS, Status.INACTIVE), 8 * 3600) //
            ...
            .next(new AbstractComponentTest.TestCase()
                    ...
                    .output(LEVEL, Level.LEVEL_1)
                    .output(STATUS, Status.ACTIVE), 3600 - 1)
            ...
            .next(new AbstractComponentTest.TestCase()
                    ...
                    .input(GRID_ACTIVE_POWER, 1000)
                    .output(LEVEL, Level.LEVEL_1)
                    .output(STATUS, Status.ACTIVE_FORCED), 3600 - 2)

            .next(new AbstractComponentTest.TestCase()
                    .timeleap(CLOCK, 3600 * 10 + 1, SECONDS)
