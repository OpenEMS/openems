...
export namespace OeTester {
  ...
  export namespace ChartOptions {
    export const LINE_CHART_OPTIONS = (period: string, chartType: 'line' | 'bar', title?: string): OeChartTester.Dataset.Option => ({
      type: 'option',
      options: {
    ...
    export const BAR_CHART_OPTIONS = (period: string, chartType: 'line' | 'bar', title?: string): OeChartTester.Dataset.Option => ({
      type: 'option',
      options: {
