        ...
        Index: {
            ...
            Widgets: {
                ...
                Receipt: {
                    ...
                    createReceipt: 'Hacer una factura',
                    date: 'Fecha',
                    energy: 'Energía',
                    error: 'Seleccione un proceso de carga válido',
                    evcs: 'Carga de coche eléctrico',
                    evcsInfo: '¡Seleccione la fecha y hora del último proceso de carga!',
                    flatWidgetEvcs: 'Ahora cree un recibo de energía para el último proceso de carga del automóvil eléctrico',
                    from: 'de',
                    noComponent: 'ningún componente seleccionado',
                    oclock: 'en punto',
                    pickComponent: 'Elección de componentes',
                    pickDate: 'Elección de fecha',
                    pickTime: 'Elección de tiempo',
                    receipt: 'Recibo de energía',
                    time: 'Hora',
                    timeframe: 'Período',
                    until: 'a',
                }
