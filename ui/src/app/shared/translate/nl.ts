    ...
    Edge: {
        Index: {
            ...
            Widgets: {
                ...
                Receipt: {
                    component: 'Onderdeel',
                    createReceipt: 'Maak een rekening',
                    date: 'Datum',
                    energy: 'Energie',
                    error: 'Selecteer een geldig laadproces',
                    evcs: 'E-auto opladen',
                    evcsInfo: 'Selecteer de datum en tijd van het laatste laadproces!',
                    flatWidgetEvcs: 'Maak nu een stroombon voor het laatste laadproces van een elektrische auto',
                    from: 'van',
                    noComponent: 'geen onderdeel geselecteerd',
                    oclock: 'o klok',
                    pickComponent: 'Component keuze',
                    pickDate: 'Datum keuze',
                    pickTime: 'Tijd keuze',
                    receipt: 'Stroombon',
                    time: 'Tijd',
                    timeframe: 'Periode',
