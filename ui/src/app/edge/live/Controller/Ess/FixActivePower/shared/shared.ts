...
export namespace SharedEssFixDigitalPowerControl {
    ...
    const HIDE_ON_MODE_MANUAL_OFF = (el: { mode: Mode }) =>
        el.mode === Mode.MANUAL_OFF;
    ...
    const getFormlySharedInfoLine = (
    ...
    ): OeFormlyView["lines"] => [
        {
            ...
            name:
                translate.instant(
                    "EDGE.INDEX.WIDGETS.INFO_STORAGE_FOR_CHARGE",
                ) +
                ". " +
                translate.instant(
                    "EDGE.INDEX.WIDGETS.INFO_STORAGE_FOR_DISCHARGE",
                ),
        },
    ];
