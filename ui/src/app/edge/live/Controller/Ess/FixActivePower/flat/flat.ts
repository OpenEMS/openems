...
export class FlatComponent extends AbstractFlatWidget {
  ...
  protected override onCurrentData(currentData: CurrentData) {
    this.chargeDischargePower = Utils.convertChargeDischargePower(this.translate, currentData.allComponents[this.componentId + '/_PropertyPower']);
    this.propertyMode = currentData.allComponents[this.componentId + '/_PropertyMode'];
  }
