...
import { HeatAddTaskComponent } from "./add";

describe("ControllerHeatAddTaskComponent", () => {
    let fixture: ComponentFixture<HeatAddTaskComponent>;
    let component: HeatAddTaskComponent;
    const edgeMock = {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            imports: [HeatAddTaskComponent, TranslateModule.forRoot()],
            providers: [
        ...
        fixture = TestBed.createComponent(HeatAddTaskComponent);
        component = fixture.componentInstance;
        (component as any).edge = edgeMock;
    });

    it("hides add-task content when Askoma is read-only", () => {
        ...
        expect(template).not.toContain("oe-components-scheduler-add-task");
    });

    it("renders add-task content when Askoma is writable", () => {
        ...
        expect(template).toContain("oe-components-scheduler-add-task");
    });
});
