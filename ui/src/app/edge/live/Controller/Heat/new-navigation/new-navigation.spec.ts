...
function expectView(component: EdgeConfig.Component, edge: any, isMyPv: boolean, isAskoma: boolean, isReadOnly: boolean,
    viewContext: OeFormlyViewTester.Context, testContext: TestContext, view: OeFormlyViewTester.View): void {
    expect(OeFormlyViewTester.apply(ControllerHeatHomeComponent.generateView(testContext.translate, component, edge, isMyPv, isAskoma, isReadOnly), viewContext))
        .toEqual(view);
}
...
describe("ControllerHeatHomeComponent", () => {
    ...
    it("+generateView() for writable MyPV shows the MyPV icon and shared channel lines without the info line", () => {
        ...
        expectView(component, edge, true, false, false, VIEW_CONTEXT({
            "heat1/Status": 0,
    ...
    it("+generateView() for read-only MyPV shows the info line", () => {
        ...
        expectView(component, edge, true, false, true, VIEW_CONTEXT({
            "heat1/Status": 0,
            "heat1/ActivePower": null,
            "heat1/Temperature": null,
            "heat1/Mode": null,
    ...
    it("+generateView() hides Mode line when Mode channel is null", () => {
        ...
        expectView(component, edge, false, true, false, VIEW_CONTEXT({
            "heat0/Mode": null,
        }), testContext, {
            title: "ASKOMA",
            lines: [
