...
@Component({
    selector: "oe-channel-single-threshold-group",
    standalone: true,
    imports: [CommonModule, IonicModule, TranslateModule],
    providers: [{ provide: DataService, useClass: LiveDataService }],
    templateUrl: "./group.html",
})
export class ControllerChannelSingleThresholdGroupComponent implements OnInit {
    ...
    public async ngOnInit(): Promise<void> {
        ...
        this.components =
            config
                ?.getComponentIdsByFactory("Controller.IO.ChannelSingleThreshold")
