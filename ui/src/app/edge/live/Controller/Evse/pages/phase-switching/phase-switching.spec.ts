...
function expectView(
    ...
    const generatedView = OeFormlyViewTester.apply(
        EvsePhaseSwitchingComponent.generateView(testContext.translate, component, edge),
        viewContext,
        formGroup,
    );
            ...
            expectView(
                ...
                TEST_CONTEXT,
                {
                    lines: [
                        ...
                        LINE_INFO(
                            TEST_CONTEXT.translate.instant("EDGE.INDEX.WIDGETS.EVCS.PHASE_SWITCHING_INFO"),
                            "font-weight: bold; text-align: center; font-size: 1rem; padding-bottom: var(--ion-padding)",
                        ),
                        LINE_RADIO_BUTTONS_FROM_FORM_CONTROL(
                            "phase-switching",
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    description: TEST_CONTEXT.translate.instant(
                                        "EDGE.INDEX.WIDGETS.EVCS.AUTOMATIC_SWITCHING_DESCRIPTION",
                                    ),
                                    icon: [
                                        {
                                            name: "oe-phase-switching-1",
