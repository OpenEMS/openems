...
export namespace History {
    ...
    export const BAR_CHART_OPTIONS = (
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: { intersect: false, mode: "x", callbacks: {} },
            },
            scales: {
                x: {
                    stacked: true,
     ...
     *
     * {@link Day.energyPerPeriodChannelWithValues} and
     * {@link Day.dataChannelWithValues}
     */
    ...
    export const WEEK: OeTester.Types.Channels = {
        ...
        dataChannelWithValues: new QueryHistoricTimeseriesDataResponse("0", {
            data: {
                "ctrlApiModbusTcp0/Ess0SetActivePowerEquals": [
                    112, 262, 392, 240, 230, 229, 227, 317, 224, 133, 135, 133,
                    192, 209, 90, 95, 96, 164, 297, 184, 182, 183, 198, 333,
                    183, 93, 97, 98, 197, 266, 177,
                ],
            },
            timestamps: [
