...
@Component({
    selector: "oe-controller-peak-shaving-time-slot-overview",
...
export class ControllerPeakShavingSymmetricTimeSlotHistoryComponent extends AbstractHistoryChartOverview {}
