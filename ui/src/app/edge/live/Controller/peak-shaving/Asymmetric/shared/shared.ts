...
export namespace SharedControllerPeakShavingAsymmetric {
    export function getNavigationTree(
        ...
        return new NavigationTree(
            component.id,
            {
                baseString: "controller/peak-shaving-asymmetric/" + component.id,
            },
    ...
    export function generatePhasesView(component: EdgeConfig.Component, translate: TranslateService): OeFormlyField[] {
        ...
        return Phase.THREE_PHASE.map(
            (phase) =>
                <OeFormlyField>{
                    type: "channel-line",
                    name: translate.instant("GENERAL.MEASURED_VALUE") + " " + phase,
                    channel: new ChannelAddress(meterId, "ActivePower" + phase).toString(),
