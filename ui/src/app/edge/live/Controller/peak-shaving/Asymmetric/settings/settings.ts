...
export class ControllerPeakShavingAsymmetricSettingsComponent extends AbstractFormlyComponent {
    ...
    public static getFormlyGeneralView(
        ...
        return {
            ...
            lines: [
                ...SharedControllerPeakShaving.getSingleMeasuredLine(
                    translate,
                    component,
                ),
                ...SharedControllerPeakShavingAsymmetric.generatePhasesView(
                    component,
                    translate,
                ),
                { type: "horizontal-line" },
                ...SharedControllerPeakShaving.getSettingsInputLines(
                    translate,
                    edge,
                ),
            ],
    ...
    protected override generateView(): OeFormlyView {
        ...
        return ControllerPeakShavingAsymmetricSettingsComponent.getFormlyGeneralView(
            this.translate,
            this.component,
            edge,
        );
    ...
    protected override getChannelAddresses(): Promise<ChannelAddress[]> {
        return SharedControllerPeakShaving.getChannelAddresses(
            this.service,
            this.routeService,
        );
    }
