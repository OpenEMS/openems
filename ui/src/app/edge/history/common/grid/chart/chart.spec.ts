...
describe("History Grid", () => {
    ...
    const edgeConfigWithOutController14a = DUMMY_CONFIG.FROM(
        DUMMY_CONFIG.COMPONENT.SOCOMEC_GRID_METER("meter0", "Netzzähler"),
    );

    const edgeConfig = DUMMY_CONFIG.FROM(
        DUMMY_CONFIG.COMPONENT.SOCOMEC_GRID_METER("meter0", "Netzzähler"),
            ...
            expectView(edgeConfigWithOutController14a, TEST_CONTEXT, "line", HISTORY.DAY,
                {
                    datasets: {
                        ...
                        options: OE_TESTER.CHART_OPTIONS.LINE_CHART_OPTIONS("hour", "line", {
                            [CHART_AXIS.LEFT]: { scale: { beginAtZero: true } },
                        }),
                    },
                }, false);
        }
            ...
            expectView(edgeConfig, TEST_CONTEXT, "bar", HISTORY.MONTH,
                {
                    datasets: {
                        ...
                        options: OE_TESTER.CHART_OPTIONS.MULTI_BAR_OPTIONS("day", "bar", {}),
                    },
            ...
            expectView(edgeConfig, TEST_CONTEXT, "bar", HISTORY.YEAR,
                {
                    datasets: {
                        ...
                        options: OE_TESTER.CHART_OPTIONS.MULTI_BAR_OPTIONS("month", "bar", {}),
                    },
                }, false);
        }
    });
