...
describe("History EnergyMonitor", () => {
  const defaultEMS = DUMMY_CONFIG.FROM(
    ...
    DUMMY_CONFIG.COMPONENT.ESS_GENERIC_MANAGEDSYMMETRIC("ess0"),
    DUMMY_CONFIG.COMPONENT.SOLAR_EDGE_PV_INVERTER("meter1", "Pv inverter"),
  );
      ...
      expectView(defaultEMS, TEST_CONTEXT, "line", HISTORY.DAY,
        {
          datasets: {
            data: [
              ...
              DATA("Ladezustand", HISTORY.DAY.DATA_CHANNEL_WITH_VALUES.RESULT.DATA["_sum/EssSoc"]),
            ],
      ...
      expectView(defaultEMS, TEST_CONTEXT, "line", HISTORY.WEEK,
        {
          datasets: {
            data: [
              ...
              DATA("Ladezustand", HISTORY.WEEK.DATA_CHANNEL_WITH_VALUES.RESULT.DATA["_sum/EssSoc"]),
            ],
