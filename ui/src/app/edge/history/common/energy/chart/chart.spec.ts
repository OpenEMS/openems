...
import { DATA, LABELS, expectView } from "./chart.constants.spec";
      ...
      expectView(defaultEMS, TEST_CONTEXT, 'bar', History.MONTH,
        {
          datasets: {
            data: [
              ...
              DATA('Netzbezug: 773 kWh', [16, 6, 3, 3, 5, 48, 4, null, 5, 26, 17, 62, 8, 66, 13, 21, 4, 3, 18, 27, 29, null, 118, 85, 2, null, 72, 28, 84, null]),
      ...
      expectView(defaultEMS, TEST_CONTEXT, 'bar', History.YEAR,
        {
          datasets: {
            data: [
              ...
              DATA('Netzbezug: 23.209 kWh', [9829, 4812, 2915, 2036, 2712, 773, 94, null, null, null, null, null]),
