    ...
    return {
      ...
      output: (data: HistoryUtils.ChannelData) => {
        ...
        return [
          ...
          {
            name: translate.instant("Edge.Index.Widgets.CHP.activePowerTarget"),
          ...
          {
            name: translate.instant("Edge.Index.Widgets.CHP.activePower"),
          ...
          {
            name: translate.instant("Edge.Index.Widgets.CHP.currentEnergyCosts"),
          ...
          {
            name: translate.instant("Edge.Index.Widgets.CHP.currentEnergyCostsWithoutChp"),
