...
const routes: Routes = [
  ...
  { path: 'device/:edgeId/log', component: EdgeConfigLogComponent },

  { path: 'device/:edgeId/config', redirectTo: 'device/:edgeId/config/index', pathMatch: 'full' },
  { path: 'device/:edgeId/config/index', component: EdgeConfigIndexComponent },
  { path: 'device/:edgeId/config/bridge', component: EdgeConfigBridgeComponent },
  { path: 'device/:edgeId/config/scheduler', component: EdgeConfigSchedulerComponent },
  { path: 'device/:edgeId/config/all', component: EdgeConfigConfigAllComponent },
  { path: 'device/:edgeId/config/more', component: EdgeConfigMoreComponent },
  { path: 'device/:edgeId/config/more/rawconfig', component: EdgeConfigRawConfigComponent },
  { path: 'device/:edgeId/config/more/directcontrol', component: EdgeConfigDirectControlComponent },
  { path: 'device/:edgeId/config/more/systemexecute', component: EdgeConfigSystemExecuteComponent },
  { path: 'device/:edgeId/config/controller', component: EdgeControllerComponent },
  { path: 'device/:edgeId/config/persistence', component: EdgePersistenceComponent },
  { path: 'device/:edgeId/config/simulator', component: EdgeConfigSimulatorComponent },
];
