...
@interface Config {
	...
	@AttributeDefinition(name = "Input component target filter", description = "This is auto-generated by 'Input Channel'.")
	String inputComponent_target() default "";
	...
	String webconsole_configurationFactory_nameHint() default "Controller ChannelThreshold [{id}]";
}