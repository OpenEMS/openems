...
@interface Config {
	...
	@AttributeDefinition(name = "Discharge power activate value", description = "If the discharge power of storage system is higher than this value, the controller guarantees the configured minimum discharge power for the configured time.")
	int activateDischargePower() default 10000;
	...
	int minDischargePower() default 5000;
	...
	String webconsole_configurationFactory_nameHint() default "Controller Min Discharge Period [{id}]";
