...
public class MinDischargePeriodImpl extends AbstractOpenemsComponent
		implements MinDischargePeriod, Controller, OpenemsComponent {

	private final Logger log = LoggerFactory.getLogger(MinDischargePeriodImpl.class);
	...
	public MinDischargePeriodImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				MinDischargePeriod.ChannelId.values() //
		);
	}
	...
	public void run() throws OpenemsNamedException {
		...
		if (!this.stopwatch.isRunning()) {
			...
			this.channel(MinDischargePeriod.ChannelId.TIME_PASSED)
					.setNextValue(this.stopwatch.elapsed(TimeUnit.SECONDS));
			this.channel(MinDischargePeriod.ChannelId.STATE_MACHINE).setNextValue(State.NOT_ACTIVE);
			return;
		}
		...
		this.channel(MinDischargePeriod.ChannelId.TIME_PASSED).setNextValue(this.stopwatch.elapsed(TimeUnit.SECONDS));
		this.channel(MinDischargePeriod.ChannelId.STATE_MACHINE).setNextValue(State.ACTIVE);
