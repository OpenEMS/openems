...
@ObjectClassDefinition(//
		name = "Meter Fronius", //
		description = "Implements the Fronius SmartMeter (63A-3, TS 65A-3).")
@interface Config {
	...
	@AttributeDefinition(name = "Modbus Unit-ID", description = "The Unit-ID of the Modbus device 240 for Symo, and 200 for Gen24.")
