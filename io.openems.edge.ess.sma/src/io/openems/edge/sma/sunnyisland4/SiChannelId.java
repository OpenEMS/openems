...
import io.openems.edge.sma.enums.OperationHealth;
...
//			.unit(Unit.WATT)), //
	...
	// Operation Health for SI on Phase L1
	OPERATION_STATE_MASTER(Doc.of(OperationHealth.values())), //
	// Operation Health for SI on Phase L2
	OPERATION_STATE_SLAVE_1(Doc.of(OperationHealth.values())), //
	// Operation Health for SI on Phase L3
	OPERATION_STATE_SLAVE_2(Doc.of(OperationHealth.values()));
