...
public class SunnyIslandEssImpl extends AbstractOpenemsModbusComponent implements ManagedSinglePhaseEss, SinglePhaseEss,
	...
	public void applyPower(int activePower, int reactivePower) throws OpenemsNamedException {
		...
		EnumWriteChannel setControlMode = this.channel(SunnyIslandEss.ChannelId.SET_CONTROL_MODE);
		IntegerWriteChannel setActivePowerChannel = this.channel(SunnyIslandEss.ChannelId.SET_ACTIVE_POWER);
		IntegerWriteChannel setReactivePowerChannel = this.channel(SunnyIslandEss.ChannelId.SET_REACTIVE_POWER);
	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		return new ModbusProtocol(this, //
				...
				new FC16WriteRegistersTask(40705,
						m(SunnyIslandEss.ChannelId.MIN_SOC_POWER_ON, new UnsignedDoublewordElement(40705)), //
						m(SunnyIslandEss.ChannelId.MIN_SOC_POWER_OFF, new UnsignedDoublewordElement(40707))));
	}
