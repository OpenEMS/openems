...
public class PlcNextPvInverterImpl extends AbstractOpenemsComponent
    ...
    /**
     * Triggers fetching and mapping data from PLCnext REST-API including push to channels.
     */
    ...
    void processDataOnExecuteWriteEvent() {
        ...
        var valuesInChannelsToWrite = Stream
     ...
     * Fetches next value from given channel ID to prepare it to be written to* PLCnext device.
      The 'next value' needs to be taken to reflect changes of the
	 * business logic.
     *
