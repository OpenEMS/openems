...
@ObjectClassDefinition(//
		name = "Phoenix Contact PLCnext load circuit PCU", //
		description = "Provides a load circuit PCU component for Phoenix Contact PLCnext platform. Take care of corresponding PLCnext component library." //
)
@interface Config {

	@AttributeDefinition(name = "Component-ID", description = "Unique ID of this Component")
	String id() default "loadCircuit0";
	...
	String dataInstanceName() default "LoadCircuit";

	String webconsole_configurationFactory_nameHint() default "Phoenix Contact PLCnext load circuit PCU [{id}]";
