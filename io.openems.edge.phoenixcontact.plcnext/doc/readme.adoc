...
* link:scripts/plcNext_install_jre.sh[plcNext_install_jre.sh] : Installtion script for Java on the PLCnext target.
* link:scripts/PLCnext-Start-OpenEMS-Edge.sh[PLCnext-Start-OpenEMS-Edge.sh] : Start up script for openEMS on the PLCnext target.
