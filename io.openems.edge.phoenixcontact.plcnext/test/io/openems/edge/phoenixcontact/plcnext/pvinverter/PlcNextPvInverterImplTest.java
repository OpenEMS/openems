...
public class PlcNextPvInverterImplTest {
	...
	public void testRunModuleSuccessfully() throws Exception {
		...
		varNeutralCurrent.addProperty("path", this.myConfig.dataInstanceName()
                + "currentNeutral");
		...
		varEnergyImport.addProperty("path", this.myConfig.dataInstanceName()
                + "EnergyImport");
		...
		requestBodyVarSetActivePowerEquals.addProperty(PlcNextChannelToGdsDataMapper.PLC_NEXT_VARIABLE_PATH,
				"/" + this.myConfig.dataInstanceName() + PlcNextPvInverterGdsDataWriteMappingDefinition.SET_ACTIVE_POWER.getIdentifier());
