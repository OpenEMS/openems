		...
		this.test //
				...
				.next(new TestCase("Check requested data dropped in asynchronously") //
						.onAfterProcessImage(assertChannelValue(//
								this.componentUnderTest, SymmetricEss.ChannelId.SOC, expectedSocValue)) //
						.onAfterProcessImage(assertChannelValue(//
								this.componentUnderTest, SymmetricEss.ChannelId.CAPACITY, expectedCapacityValue)) //
						.onAfterProcessImage(assertChannelValue(//
								this.componentUnderTest, SymmetricEss.ChannelId.GRID_MODE, expectedGridModeValue))) //
				.deactivate();
	}
