...
import static io.openems.edge.controller.io.heatingelement.ControllerIoHeatingElementwithTemp.ChannelId.FORCE_START_AT_SECONDS_OF_DAY;
import static io.openems.edge.controller.io.heatingelement.ControllerIoHeatingElementwithTemp.ChannelId.STATUS;
import static io.openems.edge.controller.io.heatingelement.ControllerIoHeatingElementwithTemp.ChannelId.TOTAL_PHASE_TIME;
...
public class ControllerIoHeatingElementImplTest2 {
	...
	public void minimumTime_lowerLevel_test() throws Exception {
		final var clock = new TimeLeapClock(Instant.ofEpochSecond(1577836800) /* starts at 1. January 2020 00:00:00 */,
				ZoneOffset.UTC);
		new ControllerTest(new ControllerIoHeatingElementwithTempImpl()) //
