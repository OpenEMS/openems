...
import static io.openems.edge.controller.io.heatingelement.ControllerIoHeatingElementwithTemp.ChannelId.LEVEL;
...
public class ControllerHeatingElementImplTest4 {
	...
	private static ControllerTest prepareTest(Mode mode, Level level) throws OpenemsNamedException, Exception {
		return new ControllerTest(new ControllerIoHeatingElementwithTempImpl()) //
