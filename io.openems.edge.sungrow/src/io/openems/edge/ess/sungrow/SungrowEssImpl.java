...
public class SungrowEssImpl extends AbstractOpenemsModbusComponent implements SungrowEss, SymmetricEss,
	...
	private void activate(ComponentContext context, Config config) throws OpenemsException {
		...
		// power
		ChannelUtils.setValue(this, ManagedSymmetricEss.ChannelId.ALLOWED_CHARGE_POWER, -8000);
		ChannelUtils.setValue(this, ManagedSymmetricEss.ChannelId.ALLOWED_DISCHARGE_POWER, 8000);
		ChannelUtils.setValue(this, SymmetricEss.ChannelId.MAX_APPARENT_POWER, 8000);
		// NOTE: This should normally be read from the device
		ChannelUtils.setValue(this, SymmetricEss.ChannelId.GRID_MODE, GridMode.ON_GRID);
	...
	protected ModbusProtocol defineModbusProtocol() {
		return new ModbusProtocol(this, //
				new FC4ReadInputRegistersTask(4989, Priority.HIGH, //
						...
						m(SungrowEss.ChannelId.NOMINAL_OUTPUT_POWER, new UnsignedWordElement(5000), SCALE_FACTOR_2), //
						new DummyRegisterElement(5001), // Output type
						m(SungrowEss.ChannelId.DAILY_OUTPUT_ENERGY, new UnsignedWordElement(5002), SCALE_FACTOR_2), //
						m(SymmetricEss.ChannelId.ACTIVE_DISCHARGE_ENERGY, new UnsignedDoublewordElement(5003) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						...
						m(SungrowEss.ChannelId.MPPT1_VOLTAGE, new UnsignedWordElement(5010), SCALE_FACTOR_MINUS_1), //
						m(SungrowEss.ChannelId.MPPT1_CURRENT, new UnsignedWordElement(5011), SCALE_FACTOR_MINUS_1), //
						m(SungrowEss.ChannelId.MPPT2_VOLTAGE, new UnsignedWordElement(5012), SCALE_FACTOR_MINUS_1), //
						m(SungrowEss.ChannelId.MPPT2_CURRENT, new UnsignedWordElement(5013), SCALE_FACTOR_MINUS_1), //
						new DummyRegisterElement(5014, 5015), //
						m(SungrowEss.ChannelId.TOTAL_DC_POWER, new UnsignedDoublewordElement(5016) //
								.wordOrder(LSWMSW)), //
						m(SungrowEss.ChannelId.VOLTAGE_L1, new UnsignedWordElement(5018), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.VOLTAGE_L2, new UnsignedWordElement(5019), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.VOLTAGE_L3, new UnsignedWordElement(5020), SCALE_FACTOR_2), //
						new DummyRegisterElement(5021, 5031), //
						m(SymmetricEss.ChannelId.REACTIVE_POWER, new SignedDoublewordElement(5032) //
								.wordOrder(LSWMSW)), //
						m(SungrowEss.ChannelId.POWER_FACTOR, new SignedWordElement(5034)), //
						m(SungrowEss.ChannelId.GRID_FREQUENCY, new UnsignedWordElement(5035), SCALE_FACTOR_2)), //

				new FC4ReadInputRegistersTask(5621, Priority.LOW, //
						m(SungrowEss.ChannelId.EXPORT_LIMIT_MIN, new UnsignedWordElement(5621), SCALE_FACTOR_1), //
						m(SungrowEss.ChannelId.EXPORT_LIMIT_MAX, new UnsignedWordElement(5622), SCALE_FACTOR_1), //
						new DummyRegisterElement(5623, 5626), //
						m(SungrowEss.ChannelId.BDC_RATED_POWER, new UnsignedWordElement(5627), SCALE_FACTOR_2), //
				...
				new FC4ReadInputRegistersTask(12999, Priority.HIGH, //
						...
						m(SungrowEss.ChannelId.DAILY_PV_GENERATION, new UnsignedWordElement(13001), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.TOTAL_PV_GENERATION, new UnsignedDoublewordElement(13002) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.DAILY_EXPORT_POWER_FROM_PV, new UnsignedWordElement(13004),
								SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.TOTAL_EXPORT_ENERGY_FROM_PV, new UnsignedDoublewordElement(13005) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.LOAD_POWER, new SignedDoublewordElement(13007).wordOrder(LSWMSW)), //
						m(SungrowEss.ChannelId.EXPORT_POWER, new SignedDoublewordElement(13009).wordOrder(LSWMSW)), //
						m(SungrowEss.ChannelId.DAILY_BATTERY_CHARGE_ENERGY_FROM_PV, new UnsignedWordElement(13011),
								SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.TOTAL_BATTERY_CHARGE_ENERGY_FROM_PV, new UnsignedDoublewordElement(13012) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.CO2_REDUCTION, new UnsignedDoublewordElement(13014) //
								.wordOrder(LSWMSW), SCALE_FACTOR_MINUS_1), //
						m(SungrowEss.ChannelId.DAILY_DIRECT_ENERGY_CONSUMPTION, new UnsignedWordElement(13016),
								SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.TOTAL_DIRECT_ENERGY_CONSUMPTION, new UnsignedDoublewordElement(13017) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.BATTERY_VOLTAGE, new UnsignedWordElement(13019), SCALE_FACTOR_MINUS_1), //
						m(SungrowEss.ChannelId.BATTERY_CURRENT, new UnsignedWordElement(13020), SCALE_FACTOR_MINUS_1), //
						...
						m(SungrowEss.ChannelId.SOH, new UnsignedWordElement(13023), SCALE_FACTOR_MINUS_1), //
						...
						m(SungrowEss.ChannelId.DAILY_BATTERY_DISCHARGE_ENERGY, new UnsignedWordElement(13025),
								SCALE_FACTOR_2), //
						m(HybridEss.ChannelId.DC_DISCHARGE_ENERGY, new UnsignedDoublewordElement(13026) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						...
						m(SungrowEss.ChannelId.CURRENT_L1, new SignedWordElement(13030), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.CURRENT_L2, new SignedWordElement(13031), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.CURRENT_L3, new SignedWordElement(13032), SCALE_FACTOR_2), //
						m(SymmetricEss.ChannelId.ACTIVE_POWER, new SignedDoublewordElement(13033)).wordOrder(LSWMSW), //
						m(SungrowEss.ChannelId.DAILY_IMPORT_ENERGY, new UnsignedWordElement(13035), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.TOTAL_IMPORT_ENERGY, new UnsignedDoublewordElement(13036) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						m(SymmetricEss.ChannelId.CAPACITY, new UnsignedWordElement(13038), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.DAILY_CHARGE_ENERGY, new UnsignedWordElement(13039), SCALE_FACTOR_2), //
						m(SymmetricEss.ChannelId.ACTIVE_CHARGE_ENERGY, new UnsignedDoublewordElement(13040) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2), //
						new DummyRegisterElement(13042, 13043), //
						m(SungrowEss.ChannelId.DAILY_EXPORT_ENERGY, new UnsignedWordElement(13044), SCALE_FACTOR_2), //
						m(SungrowEss.ChannelId.TOTAL_EXPORT_ENERGY, new UnsignedDoublewordElement(13045) //
								.wordOrder(LSWMSW), SCALE_FACTOR_2)),
				...
				new FC3ReadRegistersTask(13049, Priority.HIGH, //
						...
						m(SungrowEss.ChannelId.MAX_SOC, new UnsignedWordElement(13057), SCALE_FACTOR_MINUS_1), //
						m(SungrowEss.ChannelId.MIN_SOC, new UnsignedWordElement(13058), SCALE_FACTOR_MINUS_1), //
	...
	public void applyPower(int activePower, int reactivePower) throws OpenemsNamedException {
		...
		setValue(this, SungrowEss.ChannelId.DEBUG_HEARTBEAT, this.heartbeat);
	...
	public String debugLog() {
		return new StringBuilder() //
				...
				.append("|DC Discharge Power:").append(this.getDcDischargePower().toString()) //
				.toString();
	}
}
