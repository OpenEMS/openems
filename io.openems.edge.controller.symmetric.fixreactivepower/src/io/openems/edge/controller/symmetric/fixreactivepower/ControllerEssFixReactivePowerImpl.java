...
public class ControllerEssFixReactivePowerImpl extends AbstractOpenemsComponent
		implements ControllerEssFixReactivePower, Controller, OpenemsComponent {
	...
	public ControllerEssFixReactivePowerImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				ControllerEssFixReactivePower.ChannelId.values() //
		);
	}
