...
import io.openems.edge.controller.api.modbus.rtu.jsonrpc.GetModbusProtocolExportXlsxRequest;
import io.openems.edge.controller.api.modbus.rtu.jsonrpc.GetModbusProtocolExportXlsxResponse;
import io.openems.edge.controller.api.modbus.rtu.jsonrpc.GetModbusProtocolRequest;
import io.openems.edge.controller.api.modbus.rtu.jsonrpc.GetModbusProtocolResponse;

public abstract class AbstractModbusRtuApi extends AbstractOpenemsComponent
		implements ModbusRtuApi, Controller, OpenemsComponent, ComponentJsonApi {
