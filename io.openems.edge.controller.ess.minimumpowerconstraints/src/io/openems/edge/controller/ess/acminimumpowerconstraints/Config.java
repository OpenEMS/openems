...
@ObjectClassDefinition( //
		name = "Controller Minimum Power Constraints AC", //
...
@interface Config {
	...
	String id() default "ctrlMinPowerConstraintsAC0";
	...
	String webconsole_configurationFactory_nameHint() default "Controller Minimum Power Constraints AC [{id}]";
}