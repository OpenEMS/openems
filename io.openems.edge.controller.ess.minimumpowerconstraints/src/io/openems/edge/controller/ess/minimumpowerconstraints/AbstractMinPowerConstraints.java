...
public abstract class AbstractMinPowerConstraints extends AbstractOpenemsComponent
	...
	protected AbstractMinPowerConstraints() {
		super(//
	...
	private void setChannels(State state, int limit) {
		EnumReadChannel stateMachineChannel = this.channel(AbstractMinPowerConstraints.ChannelId.STATE_MACHINE);
		stateMachineChannel.setNextValue(state);

		IntegerReadChannel chargePowerLimitChannel = this
				.channel(AbstractMinPowerConstraints.ChannelId.CHARGE_POWER_LIMIT);
