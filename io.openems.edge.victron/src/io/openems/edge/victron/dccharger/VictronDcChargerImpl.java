	...
	protected ModbusProtocol defineModbusProtocol() {
		return new ModbusProtocol(this, //
				new FC3ReadRegistersTask(771, Priority.LOW,
						...
						this.m(EssDcCharger.ChannelId.VOLTAGE, new UnsignedWordElement(776), SCALE_FACTOR_1),
						this.m(EssDcCharger.ChannelId.CURRENT, new UnsignedWordElement(777), SCALE_FACTOR_1)),
				new FC3ReadRegistersTask(778, Priority.LOW,
						...
						this.m(EssDcCharger.ChannelId.ACTUAL_POWER, new UnsignedWordElement(789), SCALE_FACTOR_MINUS_1),
						this.m(EssDcCharger.ChannelId.ACTUAL_ENERGY, new UnsignedWordElement(790), SCALE_FACTOR_2),
