...
@ObjectClassDefinition(//
		name = "Victron AC Out Consumption", //
		description = "Implements the Victron Meter for consumption on AC out.")
@interface Config {
	...
	String alias() default "EmergencypowerPhase";
	...
	String webconsole_configurationFactory_nameHint() default "Victron AC Out Consumption Meter [{id}]";
}