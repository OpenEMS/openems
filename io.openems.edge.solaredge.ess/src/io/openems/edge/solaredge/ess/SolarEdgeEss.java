...
import io.openems.edge.solaredge.ess.enums.BatteryStatus;
import io.openems.edge.solaredge.ess.charger.SolarEdgeCharger;

public interface SolarEdgeEss extends OpenemsComponent {
	...
	public static enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		/**
		 * DC-Current produced by the ESS. Either for grid or consumption. Always
		 * positive.
		 * <ul>
		 * <li>Interface: SolarEdgeEss
		 * <li>Type: Integer
		...
		/**
		 * Max AC-Export Power in [W]. Positive Values.
		 *
		 * <ul>
		 * <li>Interface: SolarEdgeEss
		 * <li>Type: Integer
		...
		/**
		 * Max AC-Import Power in [W]. Negative Values.
		 *
		 * <ul>
		 * <li>Interface: SolarEdgeEss
		 * <li>Type: Integer
