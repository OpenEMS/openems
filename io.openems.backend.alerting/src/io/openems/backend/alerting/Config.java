...
public @interface Config {
    ...
    @AttributeDefinition(name = "Notify On Offline", description = "Send Mail on Offline")
    boolean notifyOnOffline() default true;

    @AttributeDefinition(name = "Notify On SumStateChange", description = "Send Mail on SumStateChange")
