...
public class TimeslotPeakshavingImpl extends AbstractOpenemsComponent
		implements TimeslotPeakshaving, Controller, OpenemsComponent {

	private static final DateTimeFormatter TIME_FORMATTER = DateTimeFormatter.ofPattern("H:mm");

	private final Logger log = LoggerFactory.getLogger(TimeslotPeakshavingImpl.class);
	...
	public TimeslotPeakshavingImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				TimeslotPeakshaving.ChannelId.values() //
		);
	}
	...
	private void applyPower(ManagedSymmetricEss ess, Integer activePower) throws OpenemsNamedException {
		if (activePower != null) {
			...
			this.channel(TimeslotPeakshaving.ChannelId.CALCULATED_POWER).setNextValue(activePower);
		}
	}
	...
	private Integer getPower(ManagedSymmetricEss ess, SymmetricMeter meter)
		...
		this.channel(TimeslotPeakshaving.ChannelId.STATE_MACHINE).setNextValue(this.chargeState);
		return power;
	...
	private int calculatePeakShavePower(ManagedSymmetricEss ess, SymmetricMeter meter) throws InvalidValueException {
		...
		this.channel(TimeslotPeakshaving.ChannelId.PEAK_SHAVED_POWER).setNextValue(calculatedPower);
