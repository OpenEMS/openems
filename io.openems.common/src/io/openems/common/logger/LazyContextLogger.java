...
/**
 * A Logger implementation, that prefixes all log messages with a context
 * provided by a Supplier. This allows for dynamic contexts that can change over
 * time, such as the current session ID or user ID.
 */
