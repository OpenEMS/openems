...
public enum ErrorCode implements OptionsEnum {
	...
	TEMPERATURE_DIFFERENCE_HIGH(9, "Temperature difference high",
			VersionBChannelId.ALARM_LEVEL_2_TEMPERATURE_DIFFERENCE_HIGH), //
	POLES_TEMPERATURE_DIFFERENCE_HIGH(10, "Poles temperature difference high",
			VersionBChannelId.ALARM_LEVEL_2_POLES_TEMPERATURE_DIFFERENCE_HIGH), //
	CELL_VOLTAGE_DIFFERENCE_HIGH(11, "Cell voltage difference high",
			VersionBChannelId.ALARM_LEVEL_2_CELL_VOLTAGE_DIFFERENCE_HIGH), //
	INSULATION_LOW(12, "Insulation low", VersionBChannelId.ALARM_LEVEL_2_INSULATION_LOW), //
	TOTAL_VOLTAGE_DIFFERENCE_HIGH(13, "Total voltage difference high",
			VersionBChannelId.ALARM_LEVEL_2_TOTAL_VOLTAGE_DIFFERENCE_HIGH), //
	CELL_DISCHARGE_TEMPERATURE_HIGH(14, "Cell discharge temperature high",
			VersionBChannelId.ALARM_LEVEL_2_CELL_DISCHA_TEMP_HIGH), //
	CELL_DISCHARGE_TEMPERATURE_LOW(15, "Cell discharge temperature low",
			VersionBChannelId.ALARM_LEVEL_2_CELL_DISCHA_TEMP_LOW), //
