...
public class SingleRackImpl extends AbstractOpenemsModbusComponent
	...
	private final Logger log = LoggerFactory.getLogger(SingleRackImpl.class);
	...
	public SingleRackImpl() {
		...
		this._setChargeMaxVoltage(SingleRackImpl.CHARGE_MAX_V);
		this._setDischargeMinVoltage(SingleRackImpl.DISCHARGE_MIN_V);
	}
	...
	private void initializeCallbacks() {
		this.channel(SingleRack.ChannelId.BMS_CONTACTOR_CONTROL).onChange((oldValue, newValue) -> {
	...
	private boolean isAlarmLevel2Error() {
		return this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_CELL_VOLTAGE_HIGH)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_TOTAL_VOLTAGE_HIGH)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_CHA_CURRENT_HIGH)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_CELL_VOLTAGE_LOW)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_TOTAL_VOLTAGE_LOW)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_DISCHA_CURRENT_HIGH)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_CELL_CHA_TEMP_HIGH)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_CELL_CHA_TEMP_LOW)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_INSULATION_LOW)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_CELL_DISCHA_TEMP_HIGH)
				|| this.readValueFromBooleanChannel(SingleRack.ChannelId.ALARM_LEVEL_2_CELL_DISCHA_TEMP_LOW);
	}

	private boolean isSystemRunning() {
		EnumReadChannel contactorControlChannel = this.channel(SingleRack.ChannelId.BMS_CONTACTOR_CONTROL);
	...
	private boolean readValueFromBooleanChannel(SingleRack.ChannelId channelId) {
	...
	public void setStateMachineState(State state) {
		this.state = state;
		this.channel(SingleRack.ChannelId.STATE_MACHINE).setNextValue(this.state);
	}
	...
	private void startSystem() {
		...
		EnumWriteChannel contactorControlChannel = this.channel(SingleRack.ChannelId.BMS_CONTACTOR_CONTROL);
