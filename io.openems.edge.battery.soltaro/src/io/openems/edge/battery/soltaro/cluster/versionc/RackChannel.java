...
public enum RackChannel {
	...
	private final Supplier<Doc> docFactory;

	private RackChannel(Supplier<Doc> docFactory) {
	...
	protected ChannelId toChannelId(Rack rack) {
		return new ChannelIdImpl(this.generateChannelId(rack), this.docFactory.get());
	}
