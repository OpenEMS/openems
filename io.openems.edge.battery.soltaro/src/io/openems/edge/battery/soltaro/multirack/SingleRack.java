...
/**
 * Helper class that provides channels and channel ids for a multi rack
 * channels and ids are created dynamically depending on system configuration 
 *
 */
public class SingleRack {
	...
	private Map<String, Channel<?>> createChannelMap() {
		...
		channels.put(KEY_MAX_CELL_TEMPERATURE_ID, new IntegerReadChannel(parent, channelIds.get(KEY_MAX_CELL_TEMPERATURE_ID)));
		channels.put(KEY_MAX_CELL_TEMPERATURE, new IntegerReadChannel(parent, channelIds.get(KEY_MAX_CELL_TEMPERATURE)));
		channels.put(KEY_MIN_CELL_TEMPERATURE_ID, new IntegerReadChannel(parent, channelIds.get(KEY_MIN_CELL_TEMPERATURE_ID)));
		channels.put(KEY_MIN_CELL_TEMPERATURE, new IntegerReadChannel(parent, channelIds.get(KEY_MIN_CELL_TEMPERATURE)));
		
		channels.put(KEY_ALARM_LEVEL_2_CELL_DISCHA_TEMP_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_CELL_DISCHA_TEMP_LOW))); 
		channels.put(KEY_ALARM_LEVEL_2_CELL_DISCHA_TEMP_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_CELL_DISCHA_TEMP_HIGH))); 
		channels.put(KEY_ALARM_LEVEL_2_GR_TEMPERATURE_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_GR_TEMPERATURE_HIGH)));
		channels.put(KEY_ALARM_LEVEL_2_CELL_CHA_TEMP_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_CELL_CHA_TEMP_LOW)));
		channels.put(KEY_ALARM_LEVEL_2_CELL_CHA_TEMP_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_CELL_CHA_TEMP_HIGH)));
		channels.put(KEY_ALARM_LEVEL_2_DISCHA_CURRENT_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_DISCHA_CURRENT_HIGH)));
		channels.put(KEY_ALARM_LEVEL_2_TOTAL_VOLTAGE_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_TOTAL_VOLTAGE_LOW)));
		channels.put(KEY_ALARM_LEVEL_2_CELL_VOLTAGE_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_CELL_VOLTAGE_LOW))); 
		channels.put(KEY_ALARM_LEVEL_2_CHA_CURRENT_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_CHA_CURRENT_HIGH)));
		channels.put(KEY_ALARM_LEVEL_2_TOTAL_VOLTAGE_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_TOTAL_VOLTAGE_HIGH)));
		channels.put(KEY_ALARM_LEVEL_2_CELL_VOLTAGE_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_2_CELL_VOLTAGE_HIGH)));

		channels.put(KEY_ALARM_LEVEL_1_CELL_DISCHA_TEMP_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_DISCHA_TEMP_LOW)));
		channels.put(KEY_ALARM_LEVEL_1_CELL_DISCHA_TEMP_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_DISCHA_TEMP_HIGH))); 
		channels.put(KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_DIFF_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_DIFF_HIGH)));
		channels.put(KEY_ALARM_LEVEL_1_CELL_VOLTAGE_DIFF_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_VOLTAGE_DIFF_HIGH)));
		channels.put(KEY_ALARM_LEVEL_1_GR_TEMPERATURE_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_GR_TEMPERATURE_HIGH)));
		channels.put(KEY_ALARM_LEVEL_1_CELL_TEMP_DIFF_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_TEMP_DIFF_HIGH)));
		channels.put(KEY_ALARM_LEVEL_1_SOC_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_SOC_LOW)));
		channels.put(KEY_ALARM_LEVEL_1_CELL_CHA_TEMP_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_CHA_TEMP_LOW)));
		channels.put(KEY_ALARM_LEVEL_1_CELL_CHA_TEMP_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_CHA_TEMP_HIGH)));
		channels.put(KEY_ALARM_LEVEL_1_DISCHA_CURRENT_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_DISCHA_CURRENT_HIGH)));
		channels.put(KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_LOW)));
		channels.put(KEY_ALARM_LEVEL_1_CELL_VOLTAGE_LOW, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_VOLTAGE_LOW))); 
		channels.put(KEY_ALARM_LEVEL_1_CHA_CURRENT_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CHA_CURRENT_HIGH))); 
		channels.put(KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_HIGH))); 
		channels.put(KEY_ALARM_LEVEL_1_CELL_VOLTAGE_HIGH, new StateChannel(parent, channelIds.get(KEY_ALARM_LEVEL_1_CELL_VOLTAGE_HIGH))); 
		...
		channels.put(KEY_FAILURE_INTRANET_COMMUNICATION, new StateChannel(parent, channelIds.get(KEY_FAILURE_INTRANET_COMMUNICATION))); 
		channels.put(KEY_FAILURE_TEMPERATURE_SENSOR_CABLE, new StateChannel(parent, channelIds.get(KEY_FAILURE_TEMPERATURE_SENSOR_CABLE))); 
		channels.put(KEY_FAILURE_BALANCING_MODULE, new StateChannel(parent, channelIds.get(KEY_FAILURE_BALANCING_MODULE))); 
		channels.put(KEY_FAILURE_TEMPERATURE_PCB, new StateChannel(parent, channelIds.get(KEY_FAILURE_TEMPERATURE_PCB))); 
		...
		channels.put(KEY_FAILURE_VOLTAGE_SAMPLING, new StateChannel(parent, channelIds.get(KEY_FAILURE_VOLTAGE_SAMPLING))); 
		...
		// Cell temperatures
		for (int i = 0; i < this.numberOfSlaves; i++) {
			for (int j = i * TEMPERATURE_SENSORS_PER_MODULE; j < (i + 1)
					* TEMPERATURE_SENSORS_PER_MODULE; j++) {
	...
	private Map<String, ChannelId> createChannelIdMap() {
		...
		addEntry(map, KEY_ALARM_LEVEL_2_CELL_DISCHA_TEMP_LOW, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Cell Discharge Temperature Low Alarm Level 2")); // Bit 15
		addEntry(map, KEY_ALARM_LEVEL_2_CELL_DISCHA_TEMP_HIGH, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Cell Discharge Temperature High Alarm Level 2")); // Bit 14
		addEntry(map, KEY_ALARM_LEVEL_2_GR_TEMPERATURE_HIGH, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " GR Temperature High Alarm Level 2")); // Bit 10
		addEntry(map, KEY_ALARM_LEVEL_2_CELL_CHA_TEMP_LOW, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Cell Charge Temperature Low Alarm Level 2")); // Bit 7
		addEntry(map, KEY_ALARM_LEVEL_2_CELL_CHA_TEMP_HIGH, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Cell Charge Temperature High Alarm Level 2")); // Bit 6
		addEntry(map, KEY_ALARM_LEVEL_2_DISCHA_CURRENT_HIGH, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Discharge Current High Alarm Level 2")); // Bit 5
		addEntry(map, KEY_ALARM_LEVEL_2_TOTAL_VOLTAGE_LOW, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Total Voltage Low Alarm Level 2")); // Bit 4
		addEntry(map, KEY_ALARM_LEVEL_2_CELL_VOLTAGE_LOW, new Doc().level(Level.FAULT).text("Cluster 1 Cell Voltage Low Alarm Level 2")); // Bit 3
		addEntry(map, KEY_ALARM_LEVEL_2_CHA_CURRENT_HIGH, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Charge Current High Alarm Level 2")); // Bit 2
		addEntry(map, KEY_ALARM_LEVEL_2_TOTAL_VOLTAGE_HIGH, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Total Voltage High Alarm Level 2")); // Bit 1
		addEntry(map, KEY_ALARM_LEVEL_2_CELL_VOLTAGE_HIGH, new Doc().level(Level.FAULT).text("Rack" + this.rackNumber + " Cell Voltage High Alarm Level 2")); // Bit 0
		
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_DISCHA_TEMP_LOW, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell Discharge Temperature Low Alarm Level 1")); // Bit 15
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_DISCHA_TEMP_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell Discharge Temperature High Alarm Level 1")); // Bit 14
		addEntry(map, KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_DIFF_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Total Voltage Diff High Alarm Level 1")); // Bit 13	
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_VOLTAGE_DIFF_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell Voltage Diff High Alarm Level 1")); // Bit 11
		addEntry(map, KEY_ALARM_LEVEL_1_GR_TEMPERATURE_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " GR Temperature High Alarm Level 1")); // Bit 10
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_TEMP_DIFF_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell temperature Diff High Alarm Level 1")); // Bit 9
		addEntry(map, KEY_ALARM_LEVEL_1_SOC_LOW, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " SOC Low Alarm Level 1")); // Bit 8
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_CHA_TEMP_LOW, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell Charge Temperature Low Alarm Level 1")); // Bit 7
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_CHA_TEMP_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell Charge Temperature High Alarm Level 1")); // Bit 6
		addEntry(map, KEY_ALARM_LEVEL_1_DISCHA_CURRENT_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Discharge Current High Alarm Level 1")); // Bit 5
		addEntry(map, KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_LOW, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Total Voltage Low Alarm Level 1")); // Bit 4
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_VOLTAGE_LOW, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell Voltage Low Alarm Level 1")); // Bit 3
		addEntry(map, KEY_ALARM_LEVEL_1_CHA_CURRENT_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Charge Current High Alarm Level 1")); // Bit 2
		addEntry(map, KEY_ALARM_LEVEL_1_TOTAL_VOLTAGE_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Total Voltage High Alarm Level 1")); // Bit 1
		addEntry(map, KEY_ALARM_LEVEL_1_CELL_VOLTAGE_HIGH, new Doc().level(Level.WARNING).text("Rack" + this.rackNumber + " Cell Voltage High Alarm Level 1")); // Bit 0
		
		addEntry(map, KEY_RUN_STATE, new Doc().options(Enums.ClusterRunState.values())); //
		
		addEntry(map, KEY_FAILURE_INITIALIZATION, new Doc().level(Level.FAULT).text("Initialization failure")); // Bit 12
		addEntry(map, KEY_FAILURE_EEPROM, new Doc().level(Level.FAULT).text("EEPROM fault")); // Bit 11
		addEntry(map, KEY_FAILURE_INTRANET_COMMUNICATION, new Doc().level(Level.FAULT).text("Internal communication fault")); // Bit 10 
		addEntry(map, KEY_FAILURE_TEMPERATURE_SENSOR_CABLE, new Doc().level(Level.FAULT).text("Temperature sensor cable fault")); // Bit 9
		addEntry(map, KEY_FAILURE_BALANCING_MODULE, new Doc().level(Level.FAULT).text("Balancing module fault")); // Bit 8
		...
		addEntry(map, KEY_FAILURE_TEMP_SAMPLING, new Doc().level(Level.FAULT).text("Temperature sampling fault")); // Bit 4
		addEntry(map, KEY_FAILURE_VOLTAGE_SAMPLING, new Doc().level(Level.FAULT).text("Voltage sampling fault")); // Bit 3
		...
		for (int i = 0; i < numberOfSlaves; i++) {
			for (int j = i * TEMPERATURE_SENSORS_PER_MODULE; j < (i + 1) * TEMPERATURE_SENSORS_PER_MODULE; j++) {
				String key = getSingleCellPrefix(j) + "_"
						+ TEMPERATURE;
