...
//	private Collection<SingleRack> racks = new ArrayList<>();
	...
	public MultiRack() {
		Utils.initializeMultiRackChannels(this).forEach(channel -> this.addChannel(channel));		
	}
...
//		}
	...
	private boolean isSystemStopped() {
		...
		for (SingleRack rack : racks) {
			ret = ret && ContactorControl.CUT_OFF == this.channel(RACK_INFO.get(rack.getRackNumber()).positiveContactorChannelId).value().asEnum();
		}
	...
	private boolean isSystemRunning() {
		...
		for (SingleRack rack : racks) {
			ret = ret && ContactorControl.ON_GRID == this.channel(RACK_INFO.get(rack.getRackNumber()).positiveContactorChannelId).value().asEnum();
		}
...
//			TODO write to all racks unused!!
	...
	protected ModbusProtocol defineModbusProtocol() {
		...
		tasks.addAll(Arrays.asList(new Task[] {
				...
				new FC16WriteRegistersTask(ADDRESS_OFFSET_RACK_1 + 10, 
						m(MultiRackChannelId.RACK_1_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_1 + 10)) //
				), //
				new FC3ReadRegistersTask(ADDRESS_OFFSET_RACK_1 + 10, Priority.LOW, 
						m(MultiRackChannelId.RACK_1_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_1 + 10)) //
				), //
				
				new FC16WriteRegistersTask(ADDRESS_OFFSET_RACK_2 + 10, 
						m(MultiRackChannelId.RACK_2_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_2 + 10)) //
				), //
				new FC3ReadRegistersTask(ADDRESS_OFFSET_RACK_2 + 10, Priority.LOW, 
						m(MultiRackChannelId.RACK_2_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_2 + 10)) //
				), //
				
				new FC16WriteRegistersTask(ADDRESS_OFFSET_RACK_3 + 10, 
						m(MultiRackChannelId.RACK_2_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_3 + 10)) //
				), //
				new FC3ReadRegistersTask(ADDRESS_OFFSET_RACK_3 + 10, Priority.LOW, 
						m(MultiRackChannelId.RACK_3_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_3 + 10)) //
				), //
				
				new FC16WriteRegistersTask(ADDRESS_OFFSET_RACK_4 + 10, 
						m(MultiRackChannelId.RACK_4_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_4 + 10)) //
				), //
				new FC3ReadRegistersTask(ADDRESS_OFFSET_RACK_4 + 10, Priority.LOW, 
						m(MultiRackChannelId.RACK_4_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_4 + 10)) //
				), //
				
				new FC16WriteRegistersTask(ADDRESS_OFFSET_RACK_5 + 10, 
						m(MultiRackChannelId.RACK_5_POSITIVE_CONTACTOR, new UnsignedWordElement(ADDRESS_OFFSET_RACK_5 + 10)) //
				), //
	...
	private static Map<Integer, RackInfo> createRackInfo() {
		...
		map.put(1, new RackInfo(ADDRESS_OFFSET_RACK_1, MultiRackChannelId.RACK_1_USAGE, MultiRackChannelId.RACK_1_POSITIVE_CONTACTOR));
		map.put(2, new RackInfo(ADDRESS_OFFSET_RACK_2, MultiRackChannelId.RACK_2_USAGE, MultiRackChannelId.RACK_2_POSITIVE_CONTACTOR));
		map.put(3, new RackInfo(ADDRESS_OFFSET_RACK_3, MultiRackChannelId.RACK_3_USAGE, MultiRackChannelId.RACK_3_POSITIVE_CONTACTOR));
		map.put(4, new RackInfo(ADDRESS_OFFSET_RACK_4, MultiRackChannelId.RACK_4_USAGE, MultiRackChannelId.RACK_4_POSITIVE_CONTACTOR));
		map.put(5, new RackInfo(ADDRESS_OFFSET_RACK_5, MultiRackChannelId.RACK_5_USAGE, MultiRackChannelId.RACK_5_POSITIVE_CONTACTOR));
