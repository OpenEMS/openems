...
import io.openems.edge.batteryinverter.victron.VictronBatteryInverter;
...
//		BooleanWriteChannel setClearFailureCmd = context.getParent().channel(Victron.ChannelId.CLEAR_FAILURE_COMMAND);
