...
@interface Config {
	...
	@AttributeDefinition(name = "Floor Relay Component IDs", description = "Component-IDs of the IO components used for Floor Heating Relays")
	String[] floorRelayComponent_ids() default {};
	...
	@AttributeDefinition(name = "Infrared Relay Component IDs", description = "Component-IDs of the IO components used for Infrared Heating Relays")
	String[] infraredRelayComponent_ids() default {};
