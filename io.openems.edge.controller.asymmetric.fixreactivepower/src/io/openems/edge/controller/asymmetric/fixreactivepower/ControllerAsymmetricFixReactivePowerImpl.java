...
public class ControllerAsymmetricFixReactivePowerImpl extends AbstractOpenemsComponent
		implements ControllerAsymmetricFixReactivePower, Controller, OpenemsComponent {
	...
	public ControllerAsymmetricFixReactivePowerImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				ControllerAsymmetricFixReactivePower.ChannelId.values() //
		);
	}
