...
public class UtilityConversion {
	...
	/**
	 * Convert {@link java.util.ArrayList} of Double to Interger[].
	 * 
	 * @param data {@link java.util.ArrayList} of Double
	 * @return result converted Integer []
	 */
	...
	/**
	 * Convert 2d double array to 2d double arraylist.
	 * 
	 * @param data 2d double array
	 * @return result 2d arraylist
	 */
