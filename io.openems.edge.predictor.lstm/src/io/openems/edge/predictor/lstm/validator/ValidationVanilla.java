...
//
//public class ValidationVanilla {
...
//
//	public ValidationVanilla(ArrayList<Double> data, ArrayList<OffsetDateTime> date, HyperParameters hyperParameters) {
...
//	 * hour.
//	 *
//	 * @param values          An ArrayList aof Double values representing the time
//	 *                        series data.
...
//		maxOfTrainingData = hyperParameters.getScalingMax(); // inter.interpolated
//
//		/**
...
//		if (hyperParameters.getCount() > 0 && hyperParameters.getCount() % 7 == 0 || hyperParameters.getCount() == 26) {
//			System.out.println("Combining Models");
//
//			String path = this.pathSeasonality + Integer.toString(hyperParameters.getCount()) + "seasonality.txt";
...
//
//						ArrayList<Double> result = predictPreVanilla(validateData, val, minOfTrainingData,
//								maxOfTrainingData);
//
...
//				DataModification.scale(inter.getInterpolatedData(), minOfTrainingData, maxOfTrainingData), windowsSize);
//		PreProcessingImpl tempPreprocess = new PreProcessingImpl(inter.getInterpolatedData(), windowsSize);
//		String path = this.pathTrend + Integer.toString(hyperParameters.getCount()) + "Trend.txt";
//		ArrayList<ArrayList<ArrayList<Double>>> dataList = ReadModels.getModelForTrend(path);
//		// Checking for the global validation
//
//		if (hyperParameters.getCount() > 0 && hyperParameters.getCount() % 5 == 0) {
//			System.out.println("Combining Models");
//
//			path = this.pathSeasonality + Integer.toString(hyperParameters.getCount()) + "Trend.txt";
//			ArrayList<ArrayList<ArrayList<Double>>> allModels = ReadModels.getModelForTrend(path);
//			ArrayList<ArrayList<ArrayList<Double>>> oldModels = this.getOldModelsTrend(hyperParameters.getCount());
...
//
//		try {
//			TrainTestSplit splitIndex = new TrainTestSplit(inter.getInterpolatedData().size(), windowsSize,
//					hyperParameters.getDataSplitTrain(), hyperParameters.getDataSplitValidate());
//
//			// System.out.println(splitIndex.printTrainSplitPerc());
//
//			double[][] validateData = preprocessing.getFeatureData(splitIndex.getValidateLowerIndex(),
//					splitIndex.getValidateUpperIndex());
//
//			double[] validateTarget = tempPreprocess.getTargetData(splitIndex.getValidateLowerIndex(),
//					splitIndex.getValidateUpperIndex());
...
//				// Suffle obj2 = new Suffle(validateData, validateTarget);
//
//				ArrayList<Double> result = predictPreVanilla(validateData, val, maxOfTrainingData, minOfTrainingData);
//
//				double rms = PerformanceMatrix.rmsError(UtilityConversion.convert1DArrayTo1DArrayList(validateTarget),
//						result);
//				rmsTemp1.add(rms);
//			}
//
...
//
//		SaveModel.saveModels(bestWeight, Integer.toString(hyperParameters.getCount()) + "Trend.txt");
//
//	}
//
//	/**
...
//	 */
//
//	public static ArrayList<Double> predictPreVanilla(double[][] data, ArrayList<ArrayList<Double>> val,
...
//			ArrayList<Double> wf = val.get(8);
//			ArrayList<Double> rF = val.get(9);
//
//			result.add(predictVanilla(data[i], wi, wo, wz, rI, rO, rZ, yt, ct, wf, rF, maxOfTrainingData,
//					minOfTrainingData));
//		}
//
//		return result;
...
//	 * @param wf                Array of double representing the weight of forget
//	 *                          gate.
//	 * 
//	 * @param rF                Array of double representing the recurrent update
...
//	 */
//
//	public static double predictVanilla(double[] data, ArrayList<Double> wi, ArrayList<Double> wo, ArrayList<Double> wz,
//			ArrayList<Double> rI, ArrayList<Double> rO, ArrayList<Double> rZ, ArrayList<Double> ytl,
//			ArrayList<Double> ctl, ArrayList<Double> wf, ArrayList<Double> rF, double maxOfTrainingData,
//			double minOfTrainingData) {
//		double ct = 0;
//
//		double yt = 0;
...
//			double ft = MathUtils.sigmoid(wf.get(i) * standData.get(i) + rF.get(i) * yt);
...
//					.getModelForSeasonality(this.pathSeasonality + Integer.toString(itterNumb) + "seasonality.txt", hyperParameters)
//					.get(0);
