...
public class AsymmetricVirtualAddImpl extends AbstractVirtualAddMeter<AsymmetricMeter>
		implements AsymmetricVirtualAdd, VirtualMeter, AsymmetricMeter, SymmetricMeter, OpenemsComponent, ModbusSlave {
	...
	public AsymmetricVirtualAddImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				SymmetricMeter.ChannelId.values(), //
				AsymmetricMeter.ChannelId.values(), //
				AsymmetricVirtualAdd.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(AsymmetricVirtualAddImpl.class, accessMode, 100) //
						.build());
	}
