...
public class MeterVirtualSymmetricAddImpl extends AbstractVirtualAddMeter<SymmetricMeter>
		implements MeterVirtualSymmetricAdd, VirtualMeter, SymmetricMeter, OpenemsComponent, ModbusSlave {
	...
	public MeterVirtualSymmetricAddImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				SymmetricMeter.ChannelId.values(), //
				MeterVirtualSymmetricAdd.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(MeterVirtualSymmetricAddImpl.class, accessMode, 100) //
						.build());
	}
