...
@ObjectClassDefinition(//
		...
		description = """
			This is a virtual meter built from subtracting other meters or energy storage systems.\s\
			The logic calculates `Minuend - Subtrahend1 - Subtrahend2 - ...`.\
			Example use-case: create a virtual Grid-Meter from Production-Meter, Consumption-Meter and\s\
