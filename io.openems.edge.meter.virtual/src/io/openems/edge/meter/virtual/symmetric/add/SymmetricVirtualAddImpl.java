...
public class SymmetricVirtualAddImpl extends AbstractVirtualAddMeter<SymmetricMeter>
		implements SymmetricVirtualAdd, VirtualMeter, SymmetricMeter, OpenemsComponent, ModbusSlave {
	...
	public SymmetricVirtualAddImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				SymmetricMeter.ChannelId.values(), //
				SymmetricVirtualAdd.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(SymmetricVirtualAddImpl.class, accessMode, 100) //
						.build());
	}
