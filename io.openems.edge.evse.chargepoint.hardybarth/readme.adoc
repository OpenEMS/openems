...
* **Hardy Barth cPH1 (ECB1)** (`Evcs.HardyBarth.cPH1`) – eCharge ECB1 REST API (`/api/v1/chargecontrols/`, `/api/v1/meters/`)
...
=== <<_evcs_cph1,EVCS Hardy Barth cPH1>>

*Name*: EVCS Hardy Barth cPH1

*Factory-PID*: `Evcs.HardyBarth.cPH1`
...
*Description*: EVCS interface for the Hardy Barth eCharge cPH1 wallbox (EVCC Basic controller, ECB1 REST API).
