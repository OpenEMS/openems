...
public class EvcsFixActivePowerImpl extends AbstractOpenemsComponent
		implements EvcsFixActivePower, Controller, OpenemsComponent {
	...
	public EvcsFixActivePowerImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				EvcsFixActivePower.ChannelId.values() //
		);
	}
