package io.openems.edge.bridge.can.linuxv4;
...
@ObjectClassDefinition(//
		name = "Bridge CAN Linux V4", //
		description = "Provides a service for reading and writing single CAN frames to/from a CAN device (Linux V4, Kunbus Connect +).")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Bridge CAN Linux V4[{id}]";
