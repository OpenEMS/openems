package io.openems.edge.bridge.can.linuxv4.io.hw;
 ...
 */
public class CanSocketHardwareLinuxV4 implements CanDevice {
	private final Logger log = LoggerFactory.getLogger(CanSocketHardwareLinuxV4.class);
	...
	public CanSocketHardwareLinuxV4() {
