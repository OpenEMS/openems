...
@ObjectClassDefinition(//
		name = "IO Shelly Pro 2PM Device", //
		description = "Implements the Shelly Pro 2PM")
@interface DeviceConfig {
	...
	String webconsole_configurationFactory_nameHint() default "IO Shelly Pro 2PM Device [{id}]";
}