...
public class IoShellyOutdoorPlugSGen3Impl extends IoGen2ShellyBaseImpl
		implements IoShellyOutdoorPlugSGen3, IoGen2ShellyBase, ShellyMeteredSwitch, ShellySwitch, DigitalOutput,
		SinglePhaseMeter, ElectricityMeter, OpenemsComponent, EventHandler {

	private final Logger log = LoggerFactory.getLogger(IoShellyOutdoorPlugSGen3Impl.class);
	...
	public String[] getSupportedShellyDeviceTypes() {
		return new String[] { "OutdoorPlugSG3" };
	}
