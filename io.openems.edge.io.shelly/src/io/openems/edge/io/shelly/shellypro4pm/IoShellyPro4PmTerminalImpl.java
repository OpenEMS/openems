...
public class IoShellyPro4PmTerminalImpl extends AbstractOpenemsComponent
		implements IoShellyPro4PmTerminal, ShellyMeteredSwitch, ShellySwitch, SinglePhaseMeter, ElectricityMeter,
		DigitalOutput, TimedataProvider, OpenemsComponent, EventHandler {

	private final Logger log = LoggerFactory.getLogger(IoShellyPro4PmTerminalImpl.class);
	...
	private final AtomicReference<IoShellyPro4PmDevice> device = new AtomicReference<>(null);
	...
	public IoShellyPro4PmTerminalImpl() {
		super(//
	...
	protected void setDevice(IoShellyPro4PmDevice device) {
