...
public interface IoShellyPlus1PM
	 ...
	 * @return the Channel
	 */
	public default Channel<Float> getTemperatureChannel() {
	    return this.channel(ChannelId.TEMPERATURE);
	}

	/**
	 * Gets the Temperature. See {@link ChannelId#TEMPERATURE}.
	 *
	 * @return the Channel {@link Value}
	 */
	public default Value<Float> getTemperature() {
	    return this.getTemperatureChannel().value();
	}

	/**
	 * Internal method to set the 'nextValue' on {@link ChannelId#TEMPERATURE} Channel.
	 *
	 * @param value the next value
	 */
	public default void _setTemperature(Float value) {
