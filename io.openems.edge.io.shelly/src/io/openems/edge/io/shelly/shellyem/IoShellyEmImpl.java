...
public class IoShellyEmImpl extends AbstractOpenemsComponent  
		implements IoShellyEm, DigitalOutput, ElectricityMeter, OpenemsComponent, TimedataProvider, EventHandler, SinglePhaseMeter {  
	...
	private Boolean sumEmeter1AndEmeter2 = true; 
		...
		if (error != null) {  
			...
			try {  
				...
				if (validEmeterCount > 0) {  
					...
					// calculate current from totalPower and mean voltage
					if (voltage > 0) {  
