...
public enum ProChannelId implements io.openems.edge.common.channel.ChannelId {
	// EnumReadChannels
	...
	STATE_113(Doc.of(Level.FAULT) //
			.text("TransformerOvertempL2")), //
	STATE_114(Doc.of(Level.FAULT) //
			.text("CombinationCommErrorL2")), //
	STATE_115(Doc.of(Level.FAULT) //
			.text("EEPROMErrorL2")), //
	STATE_116(Doc.of(Level.FAULT) //
			.text("LoadCurrentZeroDriftErrorL2")), //
	STATE_117(Doc.of(Level.FAULT) //
			.text("CurrentLimitRErrorL2")), //
	STATE_118(Doc.of(Level.FAULT) //
			.text("PhaseSyncErrorL2")), //
	STATE_119(Doc.of(Level.FAULT) //
			.text("ExternalPVCurrentZeroDriftErrorL2")), //
	STATE_120(Doc.of(Level.FAULT) //
	...
	STATE_130(Doc.of(Level.WARNING) //
			.text("CommWithInverterErrorL3")), //
	STATE_131(Doc.of(Level.WARNING) //
			.text("TmeErrorL3")), //
	STATE_132(Doc.of(Level.WARNING) //
			.text("PcsAlarm2L3")), //
	STATE_133(Doc.of(Level.FAULT) //
			.text("ControlCurrentOverload100PercentL3")), //
	STATE_134(Doc.of(Level.FAULT) //
			.text("ControlCurrentOverload110PercentL3")), //
	STATE_135(Doc.of(Level.FAULT) //
			.text("ControlCurrentOverload150PercentL3")), //
	STATE_136(Doc.of(Level.FAULT) //
			.text("ControlCurrentOverload200PercentL3")), //
	STATE_137(Doc.of(Level.FAULT) //
			.text("ControlCurrentOverload210PercentL3")), //
	STATE_138(Doc.of(Level.FAULT) //
			.text("ControlCurrentOverload300PercentL3")), //
	STATE_139(Doc.of(Level.FAULT) //
			.text("ControlTransientLoad300PercentL3")), //
	STATE_140(Doc.of(Level.FAULT) //
			.text("GridOverCurrentL3")), //
	STATE_141(Doc.of(Level.FAULT) //
			.text("LockingWaveformTooManyTimesL3")), //
	STATE_142(Doc.of(Level.FAULT) //
			.text("InverterVoltageZeroDriftErrorL3")), //
	STATE_143(Doc.of(Level.FAULT) //
			.text("GridVoltageZeroDriftErrorL3")), //
	STATE_144(Doc.of(Level.FAULT) //
			.text("ControlCurrentZeroDriftErrorL3")), //
	STATE_145(Doc.of(Level.FAULT) //
			.text("InverterCurrentZeroDriftErrorL3")), //
	STATE_146(Doc.of(Level.FAULT) //
			.text("GridCurrentZeroDriftErrorL3")), //
	STATE_147(Doc.of(Level.FAULT) //
			.text("PDPProtectionL3")), //
	STATE_148(Doc.of(Level.FAULT) //
			.text("HardwareControlCurrentProtectionL3")), //
	STATE_149(Doc.of(Level.FAULT) //
			.text("HardwareACVoltageProtectionL3")), //
	STATE_150(Doc.of(Level.FAULT) //
			.text("HardwareDCCurrentProtectionL3")), //
	STATE_151(Doc.of(Level.FAULT) //
			.text("HardwareTemperatureProtectionL3")), //
	STATE_152(Doc.of(Level.FAULT) //
			.text("NoCapturingSignalL3")), //
	STATE_153(Doc.of(Level.FAULT) //
			.text("DCOvervoltageL3")), //
	STATE_154(Doc.of(Level.FAULT) //
			.text("DCDisconnectedL3")), //
	STATE_155(Doc.of(Level.FAULT) //
			.text("InverterUndervoltageL3")), //
	STATE_156(Doc.of(Level.FAULT) //
			.text("InverterOvervoltageL3")), //
	STATE_157(Doc.of(Level.FAULT) //
			.text("CurrentSensorFailL3")), //
	STATE_158(Doc.of(Level.FAULT) //
			.text("VoltageSensorFailL3")), //
	STATE_159(Doc.of(Level.FAULT) //
			.text("PowerUncontrollableL3")), //
	STATE_160(Doc.of(Level.FAULT) //
			.text("CurrentUncontrollableL3")), //
	STATE_161(Doc.of(Level.FAULT) //
			.text("FanErrorL3")), //
	STATE_162(Doc.of(Level.FAULT) //
			.text("PhaseLackL3")), //
	STATE_163(Doc.of(Level.FAULT) //
			.text("InverterRelayFaultL3")), //
	STATE_164(Doc.of(Level.FAULT) //
			.text("GridRelayFaultL3")), //
	STATE_165(Doc.of(Level.FAULT) //
			.text("ControlPanelOvertempL3")), //
	STATE_166(Doc.of(Level.FAULT) //
			.text("PowerPanelOvertempL3")), //
	STATE_167(Doc.of(Level.FAULT) //
			.text("DCInputOvercurrentL3")), //
	STATE_168(Doc.of(Level.FAULT) //
			.text("CapacitorOvertempL3")), //
	STATE_169(Doc.of(Level.FAULT) //
			.text("RadiatorOvertempL3")), //
	STATE_170(Doc.of(Level.FAULT) //
			.text("TransformerOvertempL3")), //
	STATE_171(Doc.of(Level.FAULT) //
			.text("CombinationCommErrorL3")), //
	STATE_172(Doc.of(Level.FAULT) //
			.text("EEPROMErrorL3")), //
	STATE_173(Doc.of(Level.FAULT) //
			.text("LoadCurrentZeroDriftErrorL3")), //
	STATE_174(Doc.of(Level.FAULT) //
			.text("CurrentLimitRErrorL3")), //
	STATE_175(Doc.of(Level.FAULT) //
			.text("PhaseSyncErrorL3")), //
	STATE_176(Doc.of(Level.FAULT) //
			.text("ExternalPVCurrentZeroDriftErrorL3")), //
	STATE_177(Doc.of(Level.FAULT) //
			.text("ExternalGridCurrentZeroDriftErrorL3"));

	private final Doc doc;

	private ProChannelId(Doc doc) {
		this.doc = doc;
	}
