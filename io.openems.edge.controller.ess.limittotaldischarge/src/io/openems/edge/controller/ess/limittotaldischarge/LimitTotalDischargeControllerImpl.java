...
public class LimitTotalDischargeControllerImpl extends AbstractOpenemsComponent
		implements LimitTotalDischargeController, Controller, OpenemsComponent {

	private final Logger log = LoggerFactory.getLogger(LimitTotalDischargeControllerImpl.class);
	...
	public LimitTotalDischargeControllerImpl() {
		super(//
				...
				LimitTotalDischargeController.ChannelId.values() //
		);
	}
	...
	public void run() throws OpenemsNamedException {
		...
		this.channel(LimitTotalDischargeController.ChannelId.STATE_MACHINE).setNextValue(this.state);
	}
