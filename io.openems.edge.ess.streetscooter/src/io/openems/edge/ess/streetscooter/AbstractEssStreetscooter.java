...
public abstract class AbstractEssStreetscooter extends AbstractOpenemsModbusComponent
	...
	protected void initializePower() {
		this.power = new SymmetricPower(this, AbstractEssStreetscooter.MAX_APPARENT_POWER,
				AbstractEssStreetscooter.POWER_PRECISION, new PowerHandler(this, log));
		// Allowed Charge
	...
	public enum ChannelId implements io.openems.edge.common.channel.doc.ChannelId {
		...
		INVERTER_DC1_FAULT_VALUE(new Doc()
				.unit(Unit.NONE)), INVERTER_DC2_FAULT_VALUE(new Doc().unit(Unit.NONE)), 
