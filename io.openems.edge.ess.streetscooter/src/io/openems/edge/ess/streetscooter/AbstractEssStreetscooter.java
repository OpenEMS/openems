...
public abstract class AbstractEssStreetscooter extends AbstractOpenemsModbusComponent
	...
	protected ModbusProtocol defineModbusProtocol(int unitId) {
		...
		return new ModbusProtocol(unitId, //
				...
				new FC4ReadInputRegistersTask(batteryInfoStartAddress, Priority.HIGH,
						/* Float gets the right result */ m(ChannelId.BATTERY_BMS_ERR,
								new FloatDoublewordElement(batteryInfoStartAddress).wordOrder(WordOrder.LSWMSW)),
						/* double word seems to be wrong? */ // m(ChannelId.BATTERY_BMS_ERR, new
																// UnsignedDoublewordElement(getBatteryBmsErrAddress()).wordOrder(WordOrder.LSWMSW))
	...
	public enum ChannelId implements io.openems.edge.common.channel.doc.ChannelId {
		...
		BATTERY_BMS_ERR(new Doc().unit(Unit.NONE)), BATTERY_BMS_I_ACT(new Doc().unit(Unit.AMPERE)),
		BATTERY_BMS_PWR_CHRG_MAX(new Doc().unit(Unit.WATT)), BATTERY_BMS_PWR_D_CHA_MAX(new Doc().unit(Unit.WATT)),
		BATTERY_BMS_PWR_RGN_MAX(new Doc().unit(Unit.WATT)), BATTERY_BMS_SOH(new Doc().unit(Unit.PERCENT)),
		BATTERY_BMS_ST_BAT(new Doc().unit(Unit.NONE)), BATTERY_BMS_T_MAX_PACK(new Doc().unit(Unit.DEGREE_CELSIUS)),
		BATTERY_BMS_T_MIN_PACK(new Doc().unit(Unit.DEGREE_CELSIUS)), BATTERY_BMS_U_PACK(new Doc().unit(Unit.VOLT)),
		BATTERY_BMS_WRN(new Doc().unit(Unit.NONE)), BATTERY_CONNECTED(new Doc().unit(Unit.ON_OFF)),
		...
		INVERTER_ACTIVE_POWER(new Doc().unit(Unit.WATT)), INVERTER_DC1_FAULT_VALUE(new Doc().unit(Unit.NONE)),
		INVERTER_DC2_FAULT_VALUE(new Doc().unit(Unit.NONE)), INVERTER_ERROR_MESSAGE_1H(new Doc().unit(Unit.NONE)),
		INVERTER_ERROR_MESSAGE_1L(new Doc().unit(Unit.NONE)), INVERTER_ERROR_MESSAGE_2H(new Doc().unit(Unit.NONE)),
		INVERTER_ERROR_MESSAGE_2L(new Doc().unit(Unit.NONE)), INVERTER_F_AC_1(new Doc().unit(Unit.NONE)),
		INVERTER_F_AC_2(new Doc().unit(Unit.NONE)), INVERTER_F_AC_3(new Doc().unit(Unit.NONE)),
		INVERTER_GF1_FAULT_VALUE(new Doc().unit(Unit.NONE)), INVERTER_GF2_FAULT_VALUE(new Doc().unit(Unit.NONE)),
		INVERTER_GF3_FAULT_VALUE(new Doc().unit(Unit.NONE)), INVERTER_GFCI_FAULT_VALUE(new Doc().unit(Unit.NONE)),
		INVERTER_GV1_FAULT_VALUE(new Doc().unit(Unit.NONE)), INVERTER_GV2_FAULT_VALUE(new Doc().unit(Unit.NONE)),
		INVERTER_GV3_FAULT_VALUE(new Doc().unit(Unit.NONE)), INVERTER_P_AC(new Doc().unit(Unit.WATT)),
		INVERTER_P_AC_1(new Doc().unit(Unit.WATT)), INVERTER_P_AC_2(new Doc().unit(Unit.WATT)),
		INVERTER_P_AC_3(new Doc().unit(Unit.WATT)), INVERTER_TEMPERATURE(new Doc().unit(Unit.DEGREE_CELSIUS)),
		INVERTER_TEMPERATURE_FAULT_VALUE(new Doc().unit(Unit.DEGREE_CELSIUS)),
		INVERTER_V_AC_1(new Doc().unit(Unit.VOLT)), INVERTER_V_AC_2(new Doc().unit(Unit.VOLT)),
		INVERTER_V_AC_3(new Doc().unit(Unit.VOLT)), INVERTER_V_DC_1(new Doc().unit(Unit.VOLT)),
		INVERTER_V_DC_2(new Doc().unit(Unit.VOLT)), INVERTER_CONNECTED(new Doc().unit(Unit.ON_OFF)),;
