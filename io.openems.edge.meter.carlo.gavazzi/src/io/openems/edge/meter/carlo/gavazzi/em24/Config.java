...
@ObjectClassDefinition(//
		name = "Meter Carlo Gavazzi EM24", //
		description = "Implements the Carlo Gavazzi EM24.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Carlo Gavazzi EM24 [{id}]";
}