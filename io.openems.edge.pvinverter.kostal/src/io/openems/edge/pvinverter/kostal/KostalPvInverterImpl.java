...
public class KostalPvInverterImpl extends AbstractSunSpecPvInverter
		implements KostalPvInverter, SunSpecPvInverter, ManagedSymmetricPvInverter, AsymmetricMeter, SymmetricMeter,
	...
	public KostalPvInverterImpl() throws OpenemsException {
		super(//
				ACTIVE_MODELS, //
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(KostalPvInverterImpl.class, accessMode, 100) //
						.build());
	}
}
