...
public class WebsocketApiSessionManager extends SessionManager<WebsocketApiSession, WebsocketApiSessionData> {
	...
	private Optional<WebsocketApiSession> createSessionForUser(Optional<User> userOpt) {
	...
	public Optional<WebsocketApiSession> authByUserPassword(String username, String password) {
		Optional<User> user = User.authenticate(username, password);
		return createSessionForUser(user);
	}

	public Optional<WebsocketApiSession> authByPassword(String password) {
