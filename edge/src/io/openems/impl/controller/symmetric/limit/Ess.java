...
public class Ess extends ThingMap {
	...
	public final PSmallerEqualLimitation pSmallerEqualLimit;
	public final PGreaterEqualLimitation pGreaterEqualLimit;
	...
	public Ess(SymmetricEssNature ess) {
		...
		id = ess.id();
		power = ess.getPower();
		pSmallerEqualLimit = new PSmallerEqualLimitation(power);
		pGreaterEqualLimit = new PGreaterEqualLimitation(power);
	}
