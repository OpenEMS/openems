...
/*
 * Inverter used in project DE0504-Wien
 */
@ThingInfo(title = "BYD BEM 125 KTLA01")
public class Bem125ktla01 extends ModbusDevice {
	 ...
	 * Config
	 */
	@ConfigInfo(title = "Ess", description = "Sets the Ess nature.", type = Bem125ktla01Ess.class)
	...
	public String toString() {
		return "Bem125ktla01Ess [ess=" + ess + ", getThingId()=" + id() + "]";
	}
