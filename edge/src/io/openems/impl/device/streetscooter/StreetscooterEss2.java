...
public class StreetscooterEss2 extends ModbusDeviceNature implements SymmetricEssNature {
	...
	protected ModbusProtocol defineModbusProtocol() throws ConfigException {
		ModbusProtocol protocol = new ModbusProtocol( //
				new ModbusInputRegisterRange(1000, //
						new FloatElement(1000,
								batteryError = new ModbusReadLongChannel("BatteryError", this)),
						new FloatElement(1002, batteryCurrent = new ModbusReadLongChannel("BatteryCurrent", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1004, allowedCharge = new ModbusReadLongChannel("AllowedCharge", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1006, allowedDischarge = new ModbusReadLongChannel("AllowedDischarge", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1008, pwrRgnMax = new ModbusReadLongChannel("PwrRgnMax", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1010, soc = new ModbusReadLongChannel("Soc", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1012, soh = new ModbusReadLongChannel("Soh", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1014, stBat = new ModbusReadLongChannel("StBat", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1016, tMaxPack = new ModbusReadLongChannel("TMaxPack", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1018, tMinPack = new ModbusReadLongChannel("TMinPack", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1020, batteryVoltage = new ModbusReadLongChannel("BatteryVoltage", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(1022, warning = new ModbusReadLongChannel("Warning", this)).wordOrder(WordOrder.LSWMSW)),
				new ModbusInputRegisterRange(3000, //
						new FloatElement(3000, activePower = new ModbusReadLongChannel("ActivePower", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3002, dc1FaultValue = new ModbusReadLongChannel("DC1FaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3004, dc2FaultValue = new ModbusReadLongChannel("DC2FaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3006, errorMessage1H = new ModbusReadLongChannel("ErrorMessage1H", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3008, errorMessage1L = new ModbusReadLongChannel("ErrorMessage1L", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3010, errorMessage2H = new ModbusReadLongChannel("ErrorMessage2H", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3012, errorMessage2L = new ModbusReadLongChannel("ErrorMessage2L", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3014, frequencyActive1 = new ModbusReadLongChannel("FrequencyActive1", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3016, frequencyActive2 = new ModbusReadLongChannel("FrequencyActive2", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3018, frequencyActive3 = new ModbusReadLongChannel("FrequencyActive3", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3020,
								gridFrequency1FaultValue = new ModbusReadLongChannel("GridFrequency1FaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3022,
								gridFrequency2FaultValue = new ModbusReadLongChannel("GridFrequencyf2FaultValue",
										this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3024,
								gridFrequency3FaultValue = new ModbusReadLongChannel("GridFrequency3FaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3026, gfciFaultValue = new ModbusReadLongChannel("GFCIFaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3028,
								gridVoltage1FaultValue = new ModbusReadLongChannel("GridVoltage1FaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3030,
								gridVoltage2FaultValue = new ModbusReadLongChannel("GridVoltage2FaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3032,
								gridVoltage3FaultValue = new ModbusReadLongChannel("GridVoltage3FaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3034, powerActive = new ModbusReadLongChannel("PowerActive", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3036, powerActive1 = new ModbusReadLongChannel("PowerActive1", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3038, powerActive2 = new ModbusReadLongChannel("PowerActive2", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3040, powerActive3 = new ModbusReadLongChannel("PowerActive3", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3042, temperature = new ModbusReadLongChannel("Temperature", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3044,
								temperaturFaultValue = new ModbusReadLongChannel("TemperaturFaultValue", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3046, voltageActive1 = new ModbusReadLongChannel("VoltageActive1", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3048, voltageActive2 = new ModbusReadLongChannel("VoltageActive2", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3050, voltageActive3 = new ModbusReadLongChannel("VoltageActive3", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3052, voltagedc1 = new ModbusReadLongChannel("Voltagedc1", this)).wordOrder(WordOrder.LSWMSW),
						new FloatElement(3054, voltagedc2 = new ModbusReadLongChannel("Voltagedc2", this)).wordOrder(WordOrder.LSWMSW))
