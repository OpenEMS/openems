...
public class KMTronicRelayRev1 extends ModbusDevice {
	...
	public final ConfigChannel<KMTronicRelayOutputRev1> output = new ConfigChannel<KMTronicRelayOutputRev1>("output", this).addChangeListener(this);
