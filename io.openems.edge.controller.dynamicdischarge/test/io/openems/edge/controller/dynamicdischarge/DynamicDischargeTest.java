...
public class DynamicDischargeTest {
	...
	// Ids
	private static final String CTRL_ID = "ctrlDynamicDischarge0";
...
//	private static final ChannelAddress REMAINING_CONSUMPTION = new ChannelAddress(CTRL_ID, "RemainingConsumption");
	...
	private static final ChannelAddress HOURLY_PRICES_TAKEN = new ChannelAddress(CTRL_ID, "HourlyPricesTaken");
//	private static final ChannelAddress TARGET_HOURS_CALCULATED = new ChannelAddress(CTRL_ID, "HourlyHoursCalculated");
	...
	public void test() throws Exception {
		...
		final TimeLeapClock clock = new TimeLeapClock(Instant.parse("2020-01-01T15:00:00.00Z"), ZoneId.systemDefault());
		...
		new ControllerTest(new DynamicDischargeImpl()) //
				...
				.next(new TestCase() //
						...
						.output(HOURLY_PRICES_TAKEN, true) //
						.output(NUMBER_OF_TARGET_HOURS, 6));
	}
}
