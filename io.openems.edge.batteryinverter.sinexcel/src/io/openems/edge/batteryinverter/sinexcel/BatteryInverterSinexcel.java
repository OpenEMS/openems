...
public interface BatteryInverterSinexcel extends OffGridBatteryInverter, ManagedSymmetricBatteryInverter,
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		BATTERY_INVERTER_STATE(new BooleanDoc() //
				...
				.<BatteryInverterSinexcel>onChannelChange((self, value) -> self._setInverterState(value.get()))),

		INVERTER_GRID_MODE(new BooleanDoc() //
				.debounce(5, Debounce.FALSE_VALUES_IN_A_ROW_TO_SET_FALSE) //
				.text("On Grid") //
				.<BatteryInverterSinexcel>onChannelChange((self, value) -> {
