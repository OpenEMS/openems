...
public class EvccForecastService {
    ...
    public EvccForecastService(String apiUrl, BridgeHttp httpBridge, Clock clock) {
        this.apiUrl = apiUrl;
        this.httpBridge = httpBridge;
        this.clock = clock;

        this.httpBridge.subscribeTime(new EvccDelayTimeProvider(this.clock),
                this::createEndpoint,
                this::handleResponse,
                this::handleError);
    }
    ...
    private WeatherSnapshot createSnapshot(int ghi) {
     ...
     *
     * @return the latest {@link WeatherData}, or {@link WeatherData#EMPTY_WEATHER_DATA}
