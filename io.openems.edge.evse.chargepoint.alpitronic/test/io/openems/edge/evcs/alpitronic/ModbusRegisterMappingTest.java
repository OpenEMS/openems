...
public class ModbusRegisterMappingTest {
	...
	public void testStationLevelRegisters() throws Exception {
		...
		System.out.println("  UNIX_TIME: " + (component.channel(EvcsAlpitronic.ChannelId.UNIX_TIME) != null ? "OK" : "MISSING"));
		System.out.println("  NUM_CONNECTORS: " + (component.channel(EvcsAlpitronic.ChannelId.NUM_CONNECTORS) != null ? "OK" : "MISSING"));
		System.out.println("  STATION_STATE: " + (component.channel(EvcsAlpitronic.ChannelId.STATION_STATE) != null ? "OK" : "MISSING"));
		System.out.println("  TOTAL_STATION_POWER: " + (component.channel(EvcsAlpitronic.ChannelId.TOTAL_STATION_POWER) != null ? "OK" : "MISSING"));
		System.out.println("  LOAD_MANAGEMENT_ENABLED: " + (component.channel(EvcsAlpitronic.ChannelId.LOAD_MANAGEMENT_ENABLED) != null ? "OK" : "MISSING"));
	...
	public void testVersionDetectionChannels() throws Exception {
		...
		System.out.println("  SOFTWARE_VERSION_MAJOR: " + (component.channel(EvcsAlpitronic.ChannelId.SOFTWARE_VERSION_MAJOR) != null ? "OK" : "MISSING"));
		System.out.println("  SOFTWARE_VERSION_MINOR: " + (component.channel(EvcsAlpitronic.ChannelId.SOFTWARE_VERSION_MINOR) != null ? "OK" : "MISSING"));
		System.out.println("  SOFTWARE_VERSION_PATCH: " + (component.channel(EvcsAlpitronic.ChannelId.SOFTWARE_VERSION_PATCH) != null ? "OK" : "MISSING"));
	...
	private void testConnectorOffset(Connector connector, int expectedOffset) throws Exception {
		...
		System.out.println("  RAW_STATUS: " + (component.channel(EvcsAlpitronic.ChannelId.RAW_STATUS) != null ? "OK" : "MISSING"));
		System.out.println("  CHARGING_VOLTAGE: " + (component.channel(EvcsAlpitronic.ChannelId.CHARGING_VOLTAGE) != null ? "OK" : "MISSING"));
		System.out.println("  CHARGING_CURRENT: " + (component.channel(EvcsAlpitronic.ChannelId.CHARGING_CURRENT) != null ? "OK" : "MISSING"));
		System.out.println("  RAW_CHARGE_POWER: " + (component.channel(EvcsAlpitronic.ChannelId.RAW_CHARGE_POWER) != null ? "OK" : "MISSING"));
		System.out.println("  CHARGED_TIME: " + (component.channel(EvcsAlpitronic.ChannelId.CHARGED_TIME) != null ? "OK" : "MISSING"));
		System.out.println("  CHARGED_ENERGY: " + (component.channel(EvcsAlpitronic.ChannelId.CHARGED_ENERGY) != null ? "OK" : "MISSING"));
		System.out.println("  EV_SOC: " + (component.channel(EvcsAlpitronic.ChannelId.EV_SOC) != null ? "OK" : "MISSING"));
		System.out.println("  CONNECTOR_TYPE: " + (component.channel(EvcsAlpitronic.ChannelId.CONNECTOR_TYPE) != null ? "OK" : "MISSING"));
		System.out.println("  EV_MAX_CHARGING_POWER: " + (component.channel(EvcsAlpitronic.ChannelId.EV_MAX_CHARGING_POWER) != null ? "OK" : "MISSING"));
		System.out.println("  EV_MIN_CHARGING_POWER: " + (component.channel(EvcsAlpitronic.ChannelId.EV_MIN_CHARGING_POWER) != null ? "OK" : "MISSING"));
		System.out.println("  VAR_REACTIVE_MAX: " + (component.channel(EvcsAlpitronic.ChannelId.VAR_REACTIVE_MAX) != null ? "OK" : "MISSING"));
		System.out.println("  VAR_REACTIVE_MIN: " + (component.channel(EvcsAlpitronic.ChannelId.VAR_REACTIVE_MIN) != null ? "OK" : "MISSING"));
	...
	public void testNewRegistersForVersion25() throws Exception {
		...
		System.out.println("  TOTAL_CHARGED_ENERGY: " + (component.channel(EvcsAlpitronic.ChannelId.TOTAL_CHARGED_ENERGY) != null ? "OK" : "MISSING"));
		System.out.println("  MAX_CHARGING_POWER_AC: " + (component.channel(EvcsAlpitronic.ChannelId.MAX_CHARGING_POWER_AC) != null ? "OK" : "MISSING"));
