...
public class AlpitronicCommonNaturesTest {
	...
	public static void testElectricityMeterChannels(TestCase tc) throws Exception {
		tc //
				.output(ElectricityMeter.ChannelId.ACTIVE_POWER, 50000) // 50 kW DC charging
				.output(ElectricityMeter.ChannelId.ACTIVE_POWER_L1, 16667) // Symmetric 3-phase
				.output(ElectricityMeter.ChannelId.ACTIVE_POWER_L2, 16667) //
				.output(ElectricityMeter.ChannelId.ACTIVE_POWER_L3, 16666) //
				...
				.output(ElectricityMeter.ChannelId.VOLTAGE, 400_000) // DC charging voltage (mV)
				.output(ElectricityMeter.ChannelId.VOLTAGE_L1, 400_000) //
				.output(ElectricityMeter.ChannelId.VOLTAGE_L2, 400_000) //
				.output(ElectricityMeter.ChannelId.VOLTAGE_L3, 400_000) //
				.output(ElectricityMeter.ChannelId.CURRENT, 375_000) // ~125A DC (mA)
				.output(ElectricityMeter.ChannelId.CURRENT_L1, 125_000) //
				.output(ElectricityMeter.ChannelId.CURRENT_L2, 125_000) //
				.output(ElectricityMeter.ChannelId.CURRENT_L3, 125_000) //
				.output(ElectricityMeter.ChannelId.FREQUENCY, null) // Not relevant for DC
				.output(ElectricityMeter.ChannelId.ACTIVE_PRODUCTION_ENERGY, 1500000L) // 1500 kWh charged
	...
	public static void testManagedEvcsChannels(TestCase tc) throws Exception {
		tc //
				.output(ManagedEvcs.ChannelId.POWER_PRECISION, 1) //
	...
	public static void testEvcsChannels(TestCase tc) throws Exception {
		tc //
				...
				.output(Evcs.ChannelId.CHARGING_TYPE, ChargingType.CCS) //
				.output(Evcs.ChannelId.PHASES, Phases.THREE_PHASE) // DC chargers are always 3-phase
				.output(Evcs.ChannelId.FIXED_MINIMUM_HARDWARE_POWER, 5000) //
				.output(Evcs.ChannelId.FIXED_MAXIMUM_HARDWARE_POWER, 75000) //
				.output(Evcs.ChannelId.MINIMUM_HARDWARE_POWER, 5000) //
				.output(Evcs.ChannelId.MAXIMUM_HARDWARE_POWER, 75000) //
				.output(Evcs.ChannelId.MAXIMUM_POWER, null) //
				.output(Evcs.ChannelId.MINIMUM_POWER, null) //
				.output(Evcs.ChannelId.ENERGY_SESSION, 250000) // 25 kWh session
	...
	public static void testDeprecatedEvcsChannels(TestCase tc) throws Exception {
		tc //
				.output(DeprecatedEvcs.ChannelId.CHARGE_POWER, 50000) //
				.output(ElectricityMeter.ChannelId.ACTIVE_CONSUMPTION_ENERGY, 1500000L) //
		;
	}
}
