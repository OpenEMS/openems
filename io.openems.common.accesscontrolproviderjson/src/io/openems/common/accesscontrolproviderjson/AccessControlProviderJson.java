...
import io.openems.common.accesscontrol.ApplicationType;
import io.openems.common.accesscontrol.ConfigurationException;
import io.openems.common.accesscontrol.ExecutePermission;
import io.openems.common.accesscontrol.Machine;
...
/**
 * This implementation of a {@link AccessControlProvider} can be configured via a File in which the roles, users and machines are configured
 * TODO structure of the file
 * <p>
 * All elements must be present in the JSON structure but they do not need to be urgently filled
 * <p>
 * The file must be stored on the same machine on which the {Edge, Backend} is running.
 *
...
public class AccessControlProviderJson implements AccessControlProvider {
	...
	public boolean equals(Object o) {
		...
		AccessControlProviderJson that = (AccessControlProviderJson) o;
