...
A Threshold Thermometer getting a "real" Thermometer and set the Temperature by
...
state is falling and TemperatureCheck 550dc > fictional Temperature -> return false.
