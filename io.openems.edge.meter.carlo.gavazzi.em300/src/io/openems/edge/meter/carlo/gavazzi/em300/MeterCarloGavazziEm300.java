		...
		return new ModbusProtocol(unitId, //
				new FC4ReadInputRegistersTask(300001 - OFFSET, Priority.LOW, //
						m(AsymmetricMeter.ChannelId.VOLTAGE_L1,
								new SignedIntDoubleWordElement(300001 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_2),
						m(AsymmetricMeter.ChannelId.VOLTAGE_L2,
								new SignedIntDoubleWordElement(300003 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_2),
						m(AsymmetricMeter.ChannelId.VOLTAGE_L3,
								new SignedIntDoubleWordElement(300005 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_2)),
				new FC4ReadInputRegistersTask(300013 - OFFSET, Priority.HIGH, //
						m(AsymmetricMeter.ChannelId.CURRENT_L1,
								new SignedIntDoubleWordElement(300013 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_2),
						m(AsymmetricMeter.ChannelId.CURRENT_L2,
								new SignedIntDoubleWordElement(300015 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_2),
						m(AsymmetricMeter.ChannelId.CURRENT_L3,
								new SignedIntDoubleWordElement(300017 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_2),
						m(AsymmetricMeter.ChannelId.ACTIVE_POWER_L1,
								new SignedIntDoubleWordElement(300019 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(AsymmetricMeter.ChannelId.ACTIVE_POWER_L2,
								new SignedIntDoubleWordElement(300021 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(AsymmetricMeter.ChannelId.ACTIVE_POWER_L3,
								new SignedIntDoubleWordElement(300023 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(MeterCarloGavazziEm300.ChannelId.APPARENT_POWER_L1,
								new SignedIntDoubleWordElement(300025 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(MeterCarloGavazziEm300.ChannelId.APPARENT_POWER_L2,
								new SignedIntDoubleWordElement(300027 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(MeterCarloGavazziEm300.ChannelId.APPARENT_POWER_L3,
								new SignedIntDoubleWordElement(300028 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(AsymmetricMeter.ChannelId.REACTIVE_POWER_L1,
								new SignedIntDoubleWordElement(300031 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(AsymmetricMeter.ChannelId.REACTIVE_POWER_L2,
								new SignedIntDoubleWordElement(300033 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(AsymmetricMeter.ChannelId.REACTIVE_POWER_L3,
								new SignedIntDoubleWordElement(300035 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						new DummyRegisterElement(300037 - OFFSET, 300040 - OFFSET), //
						m(SymmetricMeter.ChannelId.ACTIVE_POWER,
								new SignedIntDoubleWordElement(300041 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(MeterCarloGavazziEm300.ChannelId.APPARENT_POWER,
								new SignedIntDoubleWordElement(300043 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1),
						m(SymmetricMeter.ChannelId.REACTIVE_POWER,
								new SignedIntDoubleWordElement(300045 - OFFSET).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter.SCALE_FACTOR_MINUS_1)),
