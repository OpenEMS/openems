...
public class PvInverterFroniusImpl extends AbstractSunSpecPvInverter
		implements PvInverterFronius, SunSpecPvInverter, ManagedSymmetricPvInverter, AsymmetricMeter, SymmetricMeter,
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(PvInverterFroniusImpl.class, accessMode, 100) //
						.build());
	}
}
