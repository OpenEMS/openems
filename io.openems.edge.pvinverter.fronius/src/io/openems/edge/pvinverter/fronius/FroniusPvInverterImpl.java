...
public class FroniusPvInverterImpl extends AbstractSunSpecPvInverter
		implements FroniusPvInverter, SunSpecPvInverter, ManagedSymmetricPvInverter, AsymmetricMeter, SymmetricMeter,
	...
	public FroniusPvInverterImpl() throws OpenemsException {
		super(//
				ACTIVE_MODELS, //
				...
				FroniusPvInverter.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(FroniusPvInverterImpl.class, accessMode, 100) //
						.build());
	}
}
