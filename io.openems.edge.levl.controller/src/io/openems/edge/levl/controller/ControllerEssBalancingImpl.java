...
@Component(//
		name = "Levl.Controller.Symmetric.Balancing", // This name has to be kept for compatibility reasons
		immediate = true, //
		configurationPolicy = ConfigurationPolicy.REQUIRE //
)
public class ControllerEssBalancingImpl extends AbstractOpenemsComponent implements Controller, OpenemsComponent, ComponentJsonApi {
	...
	public void buildJsonApiRoutes(JsonApiBuilder builder) {
		builder.handleRequest(METHOD, call -> {
			return this.requestHandler.addRequest(call.getRequest());
		});
	}
