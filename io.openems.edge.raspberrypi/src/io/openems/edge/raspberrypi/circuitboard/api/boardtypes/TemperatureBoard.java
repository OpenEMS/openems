package io.openems.edge.raspberrypi.circuitboard.api.boardtypes;



import io.openems.edge.raspberrypi.circuitboard.api.adc.Adc;
import io.openems.edge.raspberrypi.circuitboard.api.adc.mcpModels.type8.Mcp3208;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public enum TemperatureBoard {
    ...
    TemperatureBoard(double regressionValueA, double regressionValueB, double regression_value_c, short maxSize, Adc... mcpCollection) {
