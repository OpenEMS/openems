...
public class EssLinearPowerBandImpl extends AbstractOpenemsComponent
		implements EssLinearPowerBand, Controller, OpenemsComponent {
	...
	public EssLinearPowerBandImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				EssLinearPowerBand.ChannelId.values() //
		);
	}
	...
	public void run() throws OpenemsNamedException {
		...
		this.channel(EssLinearPowerBand.ChannelId.STATE_MACHINE).setNextValue(this.state);
