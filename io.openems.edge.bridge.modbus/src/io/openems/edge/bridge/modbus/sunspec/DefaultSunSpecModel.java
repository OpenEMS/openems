...
public enum DefaultSunSpecModel implements SunSpecModel {
	...
	public static enum S160 implements SunSpecPoint {
        ...
        // Following lines are manually added because SunSpecCodeGenerator cannot handle modules yet
		
		MODULE_1_ID(new ValuePoint("S160_MODULE_1_ID", "Module 1 Input ID", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_1_ID_STR(new ValuePoint("S160_MODULE_1_ID_STR", "Module 1 Input ID Sting", "", //
				ValuePoint.Type.STRING8, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_1_DCA(new ScaledValuePoint("S160_MODULE_1_DCA", "Module 1 DC Current", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE, "DCA_SF")), //
		MODULE_1_DCV(new ScaledValuePoint("S160_MODULE_1_DCV", "Module 1 DC Voltage", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT, "DCV_SF")), //
		MODULE_1_DCW(new ScaledValuePoint("S160_MODULE_1_DCW", "Module 1 DC Power", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT, "DCW_SF")), //
		MODULE_1_DCWH(new ScaledValuePoint("S160_MODULE_1_DCWH", "Module 1 Lifetime Energy", "", //
				ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS, "DCWH_SF")), //
		MODULE_1_TMS(new ValuePoint("S160_MODULE_1_TMS", "Module 1 Timestamp", "", //
				ValuePoint.Type.UINT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.SECONDS)), //
		MODULE_1_TMP(new ValuePoint("S160_MODULE_1_TMP", "Module 1 Temperature", "", //
				ValuePoint.Type.INT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.DEGREE_CELSIUS)), //
		MODULE_1_DCST(new EnumPoint("S160_MODULE_1_DCST", "Module 1 Operating State", "", //
				EnumPoint.Type.ENUM16, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCSt.values())), //
		MODULE_1_DCEVT(new BitFieldPoint("S160_MODULE_1_DCEVT", "Module 1 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCEvt.values())), //
		
		MODULE_2_ID(new ValuePoint("S160_MODULE_2_ID", "Module 2 Input ID", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_2_ID_STR(new ValuePoint("S160_MODULE_2_ID_STR", "Module 2 Input ID Sting", "", //
				ValuePoint.Type.STRING8, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_2_DCA(new ScaledValuePoint("S160_MODULE_2_DCA", "Module 2 DC Current", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE, "DCA_SF")), //
		MODULE_2_DCV(new ScaledValuePoint("S160_MODULE_2_DCV", "Module 2 DC Voltage", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT, "DCV_SF")), //
		MODULE_2_DCW(new ScaledValuePoint("S160_MODULE_2_DCW", "Module 2 DC Power", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT, "DCW_SF")), //
		MODULE_2_DCWH(new ScaledValuePoint("S160_MODULE_2_DCWH", "Module 2 Lifetime Energy", "", //
				ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS, "DCWH_SF")), //
		MODULE_2_TMS(new ValuePoint("S160_MODULE_2_TMS", "Module 2 Timestamp", "", //
				ValuePoint.Type.UINT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.SECONDS)), //
		MODULE_2_TMP(new ValuePoint("S160_MODULE_2_TMP", "Module 2 Temperature", "", //
				ValuePoint.Type.INT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.DEGREE_CELSIUS)), //
		MODULE_2_DCST(new EnumPoint("S160_MODULE_2_DCST", "Module 2 Operating State", "", //
				EnumPoint.Type.ENUM16, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCSt.values())), //
		MODULE_2_DCEVT(new BitFieldPoint("S160_MODULE_2_DCEVT", "Module 2 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCEvt.values())), //
		
		MODULE_3_ID(new ValuePoint("S160_MODULE_3_ID", "Module 3 Input ID", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_3_ID_STR(new ValuePoint("S160_MODULE_3_ID_STR", "Module 3 Input ID Sting", "", //
				ValuePoint.Type.STRING8, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_3_DCA(new ScaledValuePoint("S160_MODULE_3_DCA", "Module 3 DC Current", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE, "DCA_SF")), //
		MODULE_3_DCV(new ScaledValuePoint("S160_MODULE_3_DCV", "Module 3 DC Voltage", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT, "DCV_SF")), //
		MODULE_3_DCW(new ScaledValuePoint("S160_MODULE_3_DCW", "Module 3 DC Power", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT, "DCW_SF")), //
		MODULE_3_DCWH(new ScaledValuePoint("S160_MODULE_3_DCWH", "Module 3 Lifetime Energy", "", //
				ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS, "DCWH_SF")), //
		MODULE_3_TMS(new ValuePoint("S160_MODULE_3_TMS", "Module 3 Timestamp", "", //
				ValuePoint.Type.UINT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.SECONDS)), //
		MODULE_3_TMP(new ValuePoint("S160_MODULE_3_TMP", "Module 3 Temperature", "", //
				ValuePoint.Type.INT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.DEGREE_CELSIUS)), //
		MODULE_3_DCST(new EnumPoint("S160_MODULE_3_DCST", "Module 3 Operating State", "", //
				EnumPoint.Type.ENUM16, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCSt.values())), //
		MODULE_3_DCEVT(new BitFieldPoint("S160_MODULE_3_DCEVT", "Module 3 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCEvt.values())), //
		
		MODULE_4_ID(new ValuePoint("S160_MODULE_4_ID", "Module 4 Input ID", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_4_ID_STR(new ValuePoint("S160_MODULE_4_ID_STR", "Module 4 Input ID Sting", "", //
				ValuePoint.Type.STRING8, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		MODULE_4_DCA(new ScaledValuePoint("S160_MODULE_4_DCA", "Module 4 DC Current", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE, "DCA_SF")), //
		MODULE_4_DCV(new ScaledValuePoint("S160_MODULE_4_DCV", "Module 4 DC Voltage", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT, "DCV_SF")), //
		MODULE_4_DCW(new ScaledValuePoint("S160_MODULE_4_DCW", "Module 4 DC Power", "", //
				ValuePoint.Type.UINT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT, "DCW_SF")), //
		MODULE_4_DCWH(new ScaledValuePoint("S160_MODULE_4_DCWH", "Module 4 Lifetime Energy", "", //
				ValuePoint.Type.ACC32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS, "DCWH_SF")), //
		MODULE_4_TMS(new ValuePoint("S160_MODULE_4_TMS", "Module 4 Timestamp", "", //
				ValuePoint.Type.UINT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.SECONDS)), //
		MODULE_4_TMP(new ValuePoint("S160_MODULE_4_TMP", "Module 4 Temperature", "", //
				ValuePoint.Type.INT16, false /* mandatory? */, AccessMode.READ_ONLY, Unit.DEGREE_CELSIUS)), //
		MODULE_4_DCST(new EnumPoint("S160_MODULE_4_DCST", "Module 4 Operating State", "", //
				EnumPoint.Type.ENUM16, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCSt.values())), //
		MODULE_4_DCEVT(new BitFieldPoint("S160_MODULE_4_DCEVT", "Module 4 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module_DCEvt.values()));
	...
	public static enum S160_Module_DCSt implements OptionsEnum {
		UNDEFINED(-1, "Undefined"), //
		OFF(1, "OFF"), //
		SLEEPING(2, "SLEEPING"), //
		STARTING(3, "STARTING"), //
		...
		private S160_Module_DCSt(int value, String name) {
			this.value = value;
			this.name = name;
		}
	...
	public static enum S160_Module_DCEvt implements SunSpecBitPoint {
		GROUND_FAULT(new BitPoint(0, "S160_MODULE_DC_EVT_GROUND_FAULT", "Ground Fault")), //
		INPUT_OVER_VOLTAGE(new BitPoint(1, "S160_MODULE_DC_EVT_INPUT_OVER_VOLTAGE", "Input Over Voltage")), //
		RESERVED_2(new BitPoint(2, "S160_MODULE_DC_EVT_RESERVED_2", "Reserved 2")), //
		DC_DISCONNECT(new BitPoint(3, "S160_MODULE_DC_EVT_DC_DISCONNECT", "DC Disconnect")), //
		RESERVED_4(new BitPoint(4, "S160_MODULE_DC_EVT_RESERVED_4", "Reserved 4")), //
		CABINET_OPEN(new BitPoint(5, "S160_MODULE_DC_EVT_CABINET_OPEN", "Cabinet Open")), //
		MANUAL_SHUTDOWN(new BitPoint(6, "S160_MODULE_DC_EVT_MANUAL_SHUTDOWN", "Manual Shutdown")), //
		OVER_TEMP(new BitPoint(7, "S160_MODULE_DC_EVT_OVER_TEMP", "Over Temp")), //
		RESERVED_8(new BitPoint(8, "S160_MODULE_DC_EVT_RESERVED_8", "Reserved 8")), //
		RESERVED_9(new BitPoint(9, "S160_MODULE_DC_EVT_RESERVED_9", "Reserved 9")), //
		RESERVED_10(new BitPoint(10, "S160_MODULE_DC_EVT_RESERVED_10", "Reserved 10")), //
		RESERVED_11(new BitPoint(11, "S160_MODULE_DC_EVT_RESERVED_11", "Reserved 11")), //
		BLOWN_FUSE(new BitPoint(12, "S160_MODULE_DC_EVT_BLOWN_FUSE", "Blown Fuse")), //
		UNDER_TEMP(new BitPoint(13, "S160_MODULE_DC_EVT_UNDER_TEMP", "Under Temp")), //
		MEMORY_LOSS(new BitPoint(14, "S160_MODULE_DC_EVT_MEMORY_LOSS", "Memory Loss")), //
		ARC_DETECTION(new BitPoint(15, "S160_MODULE_DC_EVT_ARC_DETECTION", "Arc Detection")), //
		RESERVED_16(new BitPoint(16, "S160_MODULE_DC_EVT_RESERVED_16", "Reserved 16")), //
		RESERVED_17(new BitPoint(17, "S160_MODULE_DC_EVT_RESERVED_17", "Reserved 17")), //
		RESERVED_18(new BitPoint(18, "S160_MODULE_DC_EVT_RESERVED_18", "Reserved 18")), //
		RESERVED_19(new BitPoint(19, "S160_MODULE_DC_EVT_RESERVED_19", "Reserved 19")), //
		TEST_FAILED(new BitPoint(20, "S160_MODULE_DC_EVT_TEST_FAILED", "Test Failed")), //
		INPUT_UNDER_VOLTAGE(new BitPoint(21, "S160_MODULE_DC_EVT_INPUT_UNDER_VOLTAGE", "Input Under Voltage")), //
		INPUT_OVER_CURRENT(new BitPoint(22, "S160_MODULE_DC_EVT_INPUT_OVER_CURRENT", "Input Over Current"));

		private final BitPoint point;

		private S160_Module_DCEvt(BitPoint point) {
			this.point = point;
		}
