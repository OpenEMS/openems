...
public enum SunSpecModel {
	...
	S_15(//
			...
			ModelType.NETWORK_CONFIGURATION //
	), //
	S_18(//
			"Cellular Link", //
	...
	private SunSpecModel(String label, String description, String notes, int length, Point[] points, ModelType modelType) {
		this.label = label;
