...
public class ElementToChannelConverter {
	...
	/**
	 * Applies a scale factor of -1. Converts value [10] to [1].
	 * 
	...
	/**
	 * Applies a scale factor of -2. Converts value [100] to [1].
	 * 
	 * @see ElementToChannelScaleFactorConverter
	 */
	...
	/**
	 * Applies a scale factor of -3. Converts value [1000] to [1].
	 * 
	 * @see ElementToChannelScaleFactorConverter
	 */
	...
	/**
	 * Applies a scale factor of 1. Converts value [0.1] to [1].
	 * 
	 * @see ElementToChannelScaleFactorConverter
	 */
	...
	/**
	 * Applies a scale factor of 2. Converts value [0.01] to [1].
	 * 
	 * @see ElementToChannelScaleFactorConverter
	 */
	...
	/**
	 * Applies a scale factor of 3. Converts value [0.001] to [1].
	 * 
	 * @see ElementToChannelScaleFactorConverter
	 */
