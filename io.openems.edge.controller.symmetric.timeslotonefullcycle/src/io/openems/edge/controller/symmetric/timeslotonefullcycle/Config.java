...
@ObjectClassDefinition(//
        name = "Controller Symmetric Timeslot One Full Cycle", //
...
@interface Config {
    ...
    boolean isAnyDateTimeEnabled() default false;
    ...
    String webconsole_configurationFactory_nameHint() default "Controller Symmetric Timeslot One Full Cycle [{id}]";
}