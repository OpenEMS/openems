...
public class DynamicChannelsAndSerialNumbersTest {
	...
	public void testSerialNum() throws Exception {
		...
		assertEquals("011910MB06", FeneconCommercialBatteryImpl.VERSION_CONVERTER.elementToChannel("109101BM60"));
		...
		assertEquals("012010SM05", FeneconCommercialBatteryImpl.VERSION_CONVERTER.elementToChannel("100201MS50"));
	}
