...
public enum OcppInformations {
	 ...
	 */
	CORE_METER_VALUES_ENERGY_ACTIVE_EXPORT_REGISTER("Energy.Active.Export.Register", MeasuringEvcs.ChannelId.ENERGY_ACTIVE_TO_GRID_REGISTER),  
	 ...
	 */
	CORE_METER_VALUES_ENERGY_REACTIVE_EXPORT_REGISTER("Energy.Reactive.Export.Register", MeasuringEvcs.ChannelId.ENERGY_REACTIVE_TO_GRID_REGISTER), 
	 ...
	 */
	CORE_METER_VALUES_ENERGY_REACTIVE_IMPORT_REGISTER("Energy.Reactive.Import.Register", MeasuringEvcs.ChannelId.ENERGY_REACTIVE_TO_EV_REGISTER), 
	 ...
	 */
	CORE_METER_VALUES_ENERGY_ACTIVE_EXPORT_INTERVAL("Energy.Active.Export.Interval", MeasuringEvcs.ChannelId.ENERGY_ACTIVE_TO_GRID_INTERVAL), 
	
	/**
	 * Absolute amount of "active electrical energy" (Wh or kWh) imported (from the grid supply) during an associated time "interval", 
	 * specified by a Metervalues ReadingContext, and applicable interval duration configuration values (in seconds) for "ClockAlignedDataInterval" and "MeterValueSampleInterval".
	 */
	CORE_METER_VALUES_ENERGY_ACTIVE_IMPORT_INTERVAL("Energy.Active.Import.Interval", MeasuringEvcs.ChannelId.ENERGY_ACTIVE_TO_EV_INTERVAL),
	
	/**
	 * Absolute amount of "reactive electrical energy" (VARh or kVARh) exported (to the grid) during an associated time "interval", 
	 * specified by a Metervalues ReadingContext, and applicable interval duration configuration values (in seconds) for "ClockAlignedDataInterval" and "MeterValueSampleInterval".
	 */
	CORE_METER_VALUES_ENERGY_REACTIVE_EXPORT_INTERVAL("Energy.Reactive.Export.Interval", MeasuringEvcs.ChannelId.ENERGY_REACTIVE_TO_GRID_INTERVAL),
	 ...
	 * specified by a Metervalues ReadingContext, and applicable interval duration configuration values (in seconds) for "ClockAlignedDataInterval" and "MeterValueSampleInterval".
	 */
	CORE_METER_VALUES_ENERGY_REACTIVE_IMPORT_INTERVAL("Energy.Reactive.Import.Interval", MeasuringEvcs.ChannelId.ENERGY_REACTIVE_TO_EV_INTERVAL),
