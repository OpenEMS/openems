...
//
	MyNamespace(OpcUaServer server) {
...
//		getLifecycleManager().addLifecycle(dictionaryManager);
	...
	private void createAndAddNodes() {
		// Create a "Channels" folder and add it to the node manager
		NodeId folderNodeId = newNodeId("HelloWorld");

		UaFolderNode folderNode = new UaFolderNode(getNodeContext(), folderNodeId, newQualifiedName("Channels"),
