...
public interface HagerEcr380dMeter extends ElectricityMeter, OpenemsComponent {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		VENDOR_URL(Doc.of(OpenemsType.STRING)//
				.persistencePriority(PersistencePriority.VERY_LOW).text("Product Name")),
		...
		V_L3_L1(Doc.of(OpenemsType.INTEGER)//
				...
				.persistencePriority(PersistencePriority.HIGH)//
				.text("Power L3 to L1")),
		// FREQUENCY(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_ONLY).unit(Unit.HERTZ).persistencePriority(PersistencePriority.HIGH).text("Frequency"),
		// new UnsignedWordElement(INSTANTANEOUS_MEASURES_START_ADDRESS | 0x0006),
		// ElementToChannelScaleFactorConverter.DIVIDE(100.0d)),
