...
public class Utils {
	public static Stream<? extends AbstractReadChannel<?>> initializeChannels(FeneconDessGridMeter c) {
		return Stream.of( //
				Arrays.stream(OpenemsComponent.ChannelId.values()).map(channelId -> {
					...
					return null;
//				}), Arrays.stream(FeneconDessGridMeter.ChannelId.values()).map(channelId -> {
//					switch (channelId) {
//					}
//					return null;
				}) //
