...
public class PeakShavingImpl extends AbstractOpenemsComponent implements PeakShaving, Controller, OpenemsComponent {

	private final Logger log = LoggerFactory.getLogger(PeakShavingImpl.class);
	...
	public PeakShavingImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				PeakShaving.ChannelId.values() //
		);
	}
