...
public final class Settings implements DataSet {
     ...
     *
     * @param pac new set point for inverter AC Power '+' feed in, '-'
     * consumption 0.0f - compensator normal operation (if enabled)
     */
     ...
     *
     * @param start start time as Date format (HH:mm). Start time shall always be before end time.
     */
     ...
     *
     * @param end end time as Date format (HH:mm). End time shall always be after start time.
     */
    ...
    /**
     * Set SOC value at which further battery discharging shall be disabled.
     * This value only takes effect when Battery discharge disable option is on.
     * 
    ...
    /**
     * Set SOC value at which battery discharging shall be enabled.
     * This value only takes effect when Battery discharge enable option is on.
     * 
     * @param socLim the SOC Limit [%]
     */
