...
public final class Status implements DataSet {
     ...
     * Get Battery status
     *
     * @return battery status : 0 - Error, 1 - Off/Standby, 2..16 - Tests, 17 -
     * On / Active, 18 - Power down, 19 - Software Update.
     */
     ...
     *
     * @deprecated
     * @return status : -1 - Unknown (Main grid not connected), 0 - On-Grid
     * mode, 1 - Off-Grid mode.
     */
    @Deprecated
     ...
     *
     * @return status : 0 - Unknown (Grid measurement not connected) /
     * Switching, 1 - On-Grid mode, 2 - Off-Grid mode.
     */
     ...
     *
     * @deprecated
     * @return 0 - Main grid disabled, 1 - enabled with Internal current
    ...
    public String toString() {
        String rs = String.format("STATUS:\nInverter \t %d \t (Off-Grid : %b) \nBattery \t %d \t (Enable : %b)\nPower Grid Status \t\t %d \t (Sensors config: %d)\nEnergy mode \t %d \n",
                getInverterStatus(), offGridConfig(), getBatteryStatus(), getBatteryConfig(), getPowerGridStatus(), getPowerGridConfig(), getPowerConfig());
