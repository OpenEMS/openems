...
public final class History implements DataSet {
     ...
     *
     * @return All recorded energy valuesper year sorted by year in ascending
     * order
     *
     ...
     *
     * @return All recorded energy values per day sorted by day in ascending
     * order.
     *
     * @throws java.lang.InterruptedException
     */
     ...
     * @return
     * <p>
     * All recorded performance values in per hour of the requested day sorted
     * by hour in ascending order. The values are stored in arrays of lenght 30
     * and 12. Arrays of length 30 represent 2 minute average values, arrays of
     * 12 represent 5 minute average values.</p>
     * <p>
     * For example: Date -> 06:00:00</p><p>
     * p_pv[0] = 06:00:00, p_pv[1] = 06:02:00 ... p_pv[length - 1] =
     * 06:58:00</p>
     * <p>
     * soc[0] = 06:00:00, soc[1] = 06:05:00 ... soc[length - 1] = 06:55:00</p>
     *
     * @throws java.lang.InterruptedException
     *
     *
     */
    public synchronized SortedMap<Date, SortedMap<String, float[]>> getHistoryHour(Date reqDate) throws InterruptedException {
