...
public class CosPhiImpl extends AbstractOpenemsComponent implements CosPhi, Controller, OpenemsComponent {

	private final Logger log = LoggerFactory.getLogger(CosPhiImpl.class);
