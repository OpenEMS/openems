...
/**
 * The Interface of the Write Tasks. It allows the Bridge to get the PostMessage and check if the task is allowed to execute
 * (write it's value to remote device).
 */
