...
* Modbus TCP connection to the inverter with known IP address
* Proprietary `identkey` from Katek Memmingen GmbH
* Inverter serial number and user password/key
* The `io.openems.edge.katek.edcom` LGPL library (provides EDCOM protocol implementation)
* Network connectivity between OpenEMS and the KACO inverter
...
* External sensor configuration on VECTIS requires hardware modification
