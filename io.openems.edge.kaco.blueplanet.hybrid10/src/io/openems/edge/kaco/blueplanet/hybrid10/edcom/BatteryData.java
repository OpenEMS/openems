...
public final class BatteryData implements DataSet {
    ...
    public String toString() {
        return String.format("Battery :\nPower %.1f W \n U BMS %.1f V \n SOE "
                ...
                + "Cell min Temp %.1f °C \n Cell max Temp %.1f °C \n "
                + "Cycles %d \n",
                pBat.getFloat(0), uBms.getFloat(0), soe.getFloat(0),
                I_lim_charge.getFloat(), I_lim_discharge.getFloat(),
                bms_energy_nom.getFloat(), bms_power_nom.getFloat(),
                bms_u_cell_min_total.getFloat(),
                bms_u_cell_max_total.getFloat(), bms_Tmin_total.getFloat(),
