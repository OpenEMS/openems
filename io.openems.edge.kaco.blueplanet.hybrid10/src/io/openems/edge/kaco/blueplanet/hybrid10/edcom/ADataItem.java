...
public abstract class ADataItem {
     ...
     * @return 0 - same time period, -1 - parameter is older than current data
     * block 1 - parameter is younger than current data block
     */
    ...
    public static int getS32Value(byte[] ba, int ix) throws Exception {
        ...
        return (int) ((ba[ix] & 0xFF) | ((ba[ix + 1] & 0xFF) << 8) | ((ba[ix + 2] & 0xFF) << 16) | ((ba[ix + 3] & 0xFF) << 24));
    }
    ...
    public static long getU32Value(byte[] ba, int ix) throws Exception {
        ...
        return (long) ((ba[ix] & 0xFF) | ((ba[ix + 1] & 0xFF) << 8) | ((ba[ix + 2] & 0xFF) << 16) | (((long) (ba[ix + 3] & 0xFF)) << 24));
    }
