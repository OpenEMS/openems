...
public final class Settings implements DataSet {
	...
	public boolean dataReady() {
		return ((pacSetPoint.refreshTime() > 0) && (powerLimitEp.refreshTime() > 0) && (powerLimit.refreshTime() > 0)
				&& (bcumng_opt_reg.refreshTime() > 0) && (bcumng_level_ds.refreshTime() > 0)
				&& (bcumng_level_ba.refreshTime() > 0) && (bcu_soc_prefch.refreshTime() > 0)
				&& (bcu_t1_prefch.refreshTime() > 0) && (bcu_t2_prefch.refreshTime() > 0));
	}
