...
public class BpPvInverter extends AbstractOpenemsComponent
		implements ManagedSymmetricPvInverter, SymmetricMeter, OpenemsComponent, EventHandler {

	private final Logger log = LoggerFactory.getLogger(BpPvInverter.class);
	...
	public void handleEvent(Event event) {
		...
		case EdgeEventConstants.TOPIC_CYCLE_EXECUTE_WRITE:
			try {
				...
				this.channel(ThisChannelId.PV_LIMIT_FAILED).setNextValue(false);
			} catch (OpenemsNamedException e) {
				this.channel(ThisChannelId.PV_LIMIT_FAILED).setNextValue(true);
			}
			break;
		}
	}
