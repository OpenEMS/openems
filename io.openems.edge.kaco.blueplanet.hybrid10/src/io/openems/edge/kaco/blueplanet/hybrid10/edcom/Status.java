...
public final class Status implements DataSet {
	...
	public boolean dataReady() {
		if (Util.communication_ver8x) {
			return ((errors0.refreshTime() > 0) && (errors1.refreshTime() > 0) && (warn.refreshTime() > 0)
					&& (externStatus.refreshTime() > 0) && (gridComStatus.refreshTime() > 0)
					&& (bmsStatus.refreshTime() > 0) && (inverterMode.refreshTime() > 0)
					&& (gridConMode.refreshTime() > 0));
		} else {
			return ((errors0.refreshTime() > 0) && (errors1.refreshTime() > 0) && (warn.refreshTime() > 0)
					&& (externStatus.refreshTime() > 0) && (gridStatus.refreshTime() > 0)
					&& (gridComStatus.refreshTime() > 0) && (bmsStatus.refreshTime() > 0)
