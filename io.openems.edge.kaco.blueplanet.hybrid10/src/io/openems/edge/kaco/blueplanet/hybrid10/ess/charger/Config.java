...
@ObjectClassDefinition(//
		...
		description = "Implements the DC Charger for KACO blueplanet hybrid 10.0 TL3.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "KACO blueplanet hybrid 10.0 TL3 DC Charger [{id}]";
}
