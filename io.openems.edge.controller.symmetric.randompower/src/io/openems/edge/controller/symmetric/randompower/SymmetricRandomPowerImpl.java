...
public class SymmetricRandomPowerImpl extends AbstractOpenemsComponent
		implements SymmetricRandomPower, Controller, OpenemsComponent {
	...
	public SymmetricRandomPowerImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				SymmetricRandomPower.ChannelId.values() //
		);
	}
