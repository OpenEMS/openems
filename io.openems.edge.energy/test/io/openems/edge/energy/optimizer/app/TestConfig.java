...
public class TestConfig {
	...
	public static class Ess {
		...
		protected static final JsonObject FENECON_HOME_10 = buildJsonObject() //
				.addProperty("currentEnergy", 11000) //
				.addProperty("totalEnergy", 22000) //
				.addProperty("maxChargePower", 10000) //
				.addProperty("maxDischargePower", 10000) //
				.build();
	}

	public static class Controller {

		protected static final JsonObject ESS_FIX_ACTIVE_POWER = buildJsonObject() //
		...
		protected static final JsonObject ESS_LIMIT_TOTAL_DISCHARGE = buildJsonObject() //
				.addProperty("factoryPid", EnergySchedulerTestUtils.Controller.ESS_LIMIT_TOTAL_DISCHARGE.factoryPid)
		...
		protected static final JsonObject ESS_EMERGENCY_CAPACITY_RESERVE = buildJsonObject() //
				.addProperty("factoryPid",
						EnergySchedulerTestUtils.Controller.ESS_EMERGENCY_CAPACITY_RESERVE.factoryPid) //
		...
		protected static final JsonObject EVSE_CLUSTER_TWO = buildJsonObject() //
				.addProperty("factoryPid", EnergySchedulerTestUtils.Controller.EVSE_CLUSTER.factoryPid) //
