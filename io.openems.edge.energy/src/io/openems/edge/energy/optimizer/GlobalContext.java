...
public record GlobalContext(//
		Clock clock, //
		EnergyScheduleHandler<StateMachine, TimeOfUseTariffControllerImpl.Context> energyScheduleHandler, //
		Sum sum, //
	...
	public static class Builder {
		private Clock clock;
		private EnergyScheduleHandler<StateMachine, TimeOfUseTariffControllerImpl.Context> energyScheduleHandler;
		private Sum sum;
		 ...
		 * @return myself
		 */
		public Builder setEnergyScheduleHandler(
				EnergyScheduleHandler<StateMachine, TimeOfUseTariffControllerImpl.Context> energyScheduleHandler) {
