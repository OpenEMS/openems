...
public abstract class AbstractSolaredgeGridmeter extends AbstractOpenemsSunSpecComponent
		implements AsymmetricMeter, SymmetricMeter, OpenemsComponent {

	private final Logger log = LoggerFactory.getLogger(AbstractSolaredgeGridmeter.class);

	public AbstractSolaredgeGridmeter(Map<SunSpecModel, Priority> activeModels,
