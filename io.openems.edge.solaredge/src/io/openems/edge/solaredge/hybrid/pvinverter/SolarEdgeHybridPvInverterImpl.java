package io.openems.edge.solaredge.hybrid.pvinverter;
...
public class SolarEdgeHybridPvInverterImpl extends AbstractSunSpecPvInverter implements SunSpecPvInverter, ManagedSymmetricPvInverter,
		AsymmetricMeter, SymmetricMeter, ModbusComponent, OpenemsComponent, EventHandler, ModbusSlave, SolarEdgeHybridPvinverter {
	...
	public SolarEdgeHybridPvInverterImpl() throws OpenemsException {
		super(//
				ACTIVE_MODELS, //
				...
				SolarEdgeHybridPvinverter.ChannelId.values()
		);
	...
	private void addStaticModbusTasksDcPower(ModbusProtocol protocol) throws OpenemsException {
		...
		protocol.addTask(//
				new FC3ReadRegistersTask(0xE174, Priority.LOW, //
						m(SolarEdgeHybridPvinverter.ChannelId.DC_DISCHARGE_POWER, new FloatDoublewordElement(0xE174).wordOrder(WordOrder.LSWMSW),
	...
	private void addStaticModbusTasksGridPower(ModbusProtocol protocol) throws OpenemsException {
		...
		protocol.addTask(//
				new FC3ReadRegistersTask(0x9d0e, Priority.LOW, //
						m(SolarEdgeHybridPvinverter.ChannelId.GRID_POWER,new SignedWordElement(0x9d0e)),
						new DummyRegisterElement(0x9d0f, 0x9d11),						
						m(SolarEdgeHybridPvinverter.ChannelId.GRID_POWER_SCALE,new SignedWordElement(0x9d12)))
				);
	...
	public void _setMyActivePower() {
		...
		int grid_power 			= this.getGridPowerChannel().value().get() * (int) Math.pow(10, grid_power_scale);
		...
		int value				= 0;
		if (grid_power < 0 && battery_power  == 0)  value  = consumption_power ;
		else  value				= consumption_power + battery_power + grid_power;
	...
	protected void onSunSpecInitializationCompleted() {
		...
		this.mapFirstPointToChannel(//
		SolarEdgeHybridPvinverter.ChannelId.CONSUMPTION_POWER, //
		ElementToChannelConverter.DIRECT_1_TO_1, //
		DefaultSunSpecModel.S103.W);	
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(SolarEdgeHybridPvInverterImpl.class, accessMode, 100) //
						.build());
	}
