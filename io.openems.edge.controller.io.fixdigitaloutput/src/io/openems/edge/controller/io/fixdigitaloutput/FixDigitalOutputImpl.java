...
public class FixDigitalOutputImpl extends AbstractOpenemsComponent
		implements FixDigitalOutput, Controller, OpenemsComponent {
	...
	public FixDigitalOutputImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				FixDigitalOutput.ChannelId.values() //
		);
	}
