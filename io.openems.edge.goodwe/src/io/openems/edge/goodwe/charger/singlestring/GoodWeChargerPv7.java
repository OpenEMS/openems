...
@Designate(ocd = ConfigPV7.class, factory = true)
@Component(//
...
public class GoodWeChargerPv7 extends AbstractGoodWeEtCharger
	...
	public GoodWeChargerPv7() {
	}

	@Activate
	private void activate(ComponentContext context, ConfigPV7 config) throws OpenemsException {
