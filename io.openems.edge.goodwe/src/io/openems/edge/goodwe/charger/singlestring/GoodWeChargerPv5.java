...
@Designate(ocd = ConfigPV5.class, factory = true)
@Component(//
...
public class GoodWeChargerPv5 extends AbstractGoodWeEtCharger
	...
	public GoodWeChargerPv5() {
	}

	@Activate
	private void activate(ComponentContext context, ConfigPV5 config) throws OpenemsException {
