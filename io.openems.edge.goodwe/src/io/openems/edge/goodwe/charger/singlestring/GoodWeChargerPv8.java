...
@Designate(ocd = ConfigPV8.class, factory = true)
@Component(//
...
public class GoodWeChargerPv8 extends AbstractGoodWeEtCharger
	...
	public GoodWeChargerPv8() {
	}

	@Activate
	private void activate(ComponentContext context, ConfigPV8 config) throws OpenemsException {
