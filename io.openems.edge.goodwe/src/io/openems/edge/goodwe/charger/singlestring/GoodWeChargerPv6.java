...
@Designate(ocd = ConfigPV6.class, factory = true)
@Component(//
...
public class GoodWeChargerPv6 extends AbstractGoodWeEtCharger
	...
	public GoodWeChargerPv6() {
	}

	@Activate
	private void activate(ComponentContext context, ConfigPV6 config) throws OpenemsException {
