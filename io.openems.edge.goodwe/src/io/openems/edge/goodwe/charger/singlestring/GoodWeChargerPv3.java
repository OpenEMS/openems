...
@Designate(ocd = ConfigPV3.class, factory = true)
@Component(//
...
@GenerateTargetsFromReferences({ "Modbus", "essOrBatteryInverter" })
public class GoodWeChargerPv3 extends AbstractGoodWeEtCharger
	...
	@Activate
	private void activate(ComponentContext context, ConfigPV3 config) {
