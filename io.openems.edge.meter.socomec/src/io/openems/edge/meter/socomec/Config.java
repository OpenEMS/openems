...
@ObjectClassDefinition(//
		name = "Meter Socomec", //
		description = "Implements a Socomec meter. Actual type is identified automatically.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Socomec [{id}]";
}