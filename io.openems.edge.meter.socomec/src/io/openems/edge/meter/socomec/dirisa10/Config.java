...
@ObjectClassDefinition( //
		name = "Meter SOCOMEC Diris A10", //
		description = "Implements the SOCOMEC Diris A10 meter.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter SOCOMEC Diris A10 [{id}]";
}