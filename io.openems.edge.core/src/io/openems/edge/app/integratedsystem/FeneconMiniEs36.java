...
/**
 * Describes a FENECON Mini ES 3-6 system.
 *
 * <pre>
 {
 "appId":"App.FENECON.Mini.ES.3.6",
 "alias":"FENECON Mini ES 3-6",
 "instanceId": UUID,
 "image": base64,
 "properties":{
 "ESS_PHASE": "l1"
 ...
 * </pre>
 */
@Component(name = "App.FENECON.Mini.ES.3.6")
public class FeneconMiniEs36
		extends AbstractOpenemsAppWithProps<FeneconMiniEs36, FeneconMiniEs36.Property, Parameter.BundleParameter>
		implements OpenemsApp, AppManagerUtilSupplier {

	public enum Property implements Type<Property, FeneconMiniEs36, Parameter.BundleParameter> {
		ALIAS(alias()), //
		ESS_PHASE(essPhase()), //
		ESS_READ_ONLY(essReadOnly());

		private final AppDef<? super FeneconMiniEs36, ? super Property, ? super Parameter.BundleParameter> def;

		Property(AppDef<? super FeneconMiniEs36, ? super Property, ? super Parameter.BundleParameter> def) {
			this.def = def;
		}

		@Override
		public AppDef<? super FeneconMiniEs36, ? super Property, ? super Parameter.BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<FeneconMiniEs36>, Parameter.BundleParameter> getParamter() {
			return Parameter.functionOf(AbstractOpenemsApp::getTranslationBundle);
		}

		@Override
		public Type<Property, FeneconMiniEs36, Parameter.BundleParameter> self() {
			return this;
		}
	}
	...
	@Activate
	public FeneconMiniEs36(@Reference final ComponentManager componentManager, //
	...
	@Override
	protected FeneconMiniEs36 getApp() {
		return this;
	}
