...
import static io.openems.edge.app.integratedsystem.fenecon.industrial.s.FeneconIndustrialSComponents.essCluster;
...
import io.openems.edge.app.integratedsystem.fenecon.industrial.s.Isk110.Property;
...
@Component(name = "App.FENECON.Industrial.S.ISK110")
public class Isk110 extends AbstractOpenemsAppWithProps<Isk110, Property, BundleParameter> implements OpenemsApp {

	public enum Property implements Type<Property, Isk110, BundleParameter> {
		ALIAS(alias()), //
		HAS_GRID_METER(hasGridMeter()), //
		HAS_SELF_CONSUMPTION_OPTIMIZATION(hasSelfConsumptionOptimization(HAS_GRID_METER)), //
		;

		private final AppDef<? super Isk110, ? super Property, ? super BundleParameter> def;

		private Property(AppDef<? super Isk110, ? super Property, ? super BundleParameter> def) {
			this.def = def;
		}

		@Override
		public Type<Property, Isk110, BundleParameter> self() {
			return this;
		}

		@Override
		public AppDef<? super Isk110, ? super Property, ? super BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<Isk110>, BundleParameter> getParamter() {
	...
	protected ThrowingTriFunction<ConfigurationTarget, Map<Property, JsonElement>, Language, AppConfiguration, OpenemsNamedException> appPropertyConfigurationFactory() {
		return (t, p, l) -> {
			...
			final var modbusIdToGridMeter = "modbus3";
			final var batteryInverter1Id = "batteryInverter1";
			final var batteryInverter2Id = "batteryInverter2";
			...
			final var ess1Id = "ess1";
			final var ess2Id = "ess2";
			...
			final var components = Lists.newArrayList(//
					...
					batteryInverter(bundle, 2), //
					// ESS
					essCluster(bundle, essId, of(ess1Id, ess2Id)), //
					essGenericManagedSymmetric(bundle, ess1Id, "1", batterySeriallId1, batteryInverter1Id), //
					essGenericManagedSymmetric(bundle, ess2Id, "2", batterySeriallId2, batteryInverter2Id), //
					// Bridge
					modbusInternal(bundle, t, modbusIdInternal), //
					modbusToBatteryInverter(bundle, t, 1), //
					modbusToBatteryInverter(bundle, t, 2), //
					// IO
					io(bundle), //
					// Misc.
					system(t, "System Industrial S (ISK110)", of(battery11Id, battery12Id, battery21Id, battery22Id)) //
			);
