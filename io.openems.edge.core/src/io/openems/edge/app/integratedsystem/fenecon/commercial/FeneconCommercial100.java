...
@Component(name = "App.FENECON.Commercial.100")
public class FeneconCommercial100
	...
	public enum Property implements PropertyParent {
		...
		private final AppDef<? super FeneconCommercial100, ? super PropertyParent, ? super BundleParameter> def;

		private Property(AppDef<? super FeneconCommercial100, ? super PropertyParent, ? super BundleParameter> def) {
			this.def = def;
		}

		@Override
		public Type<PropertyParent, FeneconCommercial100, BundleParameter> self() {
			return this;
		}

		@Override
		public AppDef<? super FeneconCommercial100, ? super PropertyParent, ? super BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<FeneconCommercial100>, BundleParameter> getParamter() {
			return Parameter.functionOf(AbstractOpenemsApp::getTranslationBundle);
		}

	}

	private static final int MAX_NUMBER_OF_MPPT = 8;
	...
	@Override
	protected FeneconCommercial100 getApp() {
		return this;
	}
	...
	private static final class ParentPropertyImpl
			extends Type.AbstractType<PropertyParent, FeneconCommercial100, BundleParameter> implements PropertyParent {
