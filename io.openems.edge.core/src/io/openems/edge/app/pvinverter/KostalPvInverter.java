 ...
 * </pre>
 */
@Component(name = "App.PvInverter.Kostal")
public class KostalPvInverter extends AbstractOpenemsAppWithProps<KostalPvInverter, Property, Parameter.BundleParameter>
		implements OpenemsApp {

	public static enum Property implements Type<Property, KostalPvInverter, Parameter.BundleParameter> {
		// Component-IDs
		...
		private final AppDef<? super KostalPvInverter, ? super Property, ? super BundleParameter> def;

		private Property(AppDef<? super KostalPvInverter, ? super Property, ? super BundleParameter> def) {
			this.def = def;
		}

		@Override
		public Type<Property, KostalPvInverter, BundleParameter> self() {
			return this;
		}

		@Override
		public AppDef<? super KostalPvInverter, ? super Property, ? super BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<KostalPvInverter>, BundleParameter> getParamter() {
	...
	protected ThrowingTriFunction<ConfigurationTarget, Map<Property, JsonElement>, Language, AppConfiguration, OpenemsNamedException> appPropertyConfigurationFactory() {
		return (t, p, l) -> {
			...
			final var components = List.of(//
					new EdgeConfig.Component(pvInverterId, alias, "PV-Inverter.Kostal", //
	...
	@Override
	protected KostalPvInverter getApp() {
		return this;
	}
