 ...
 * <pre>
  {
    "appId":"App.Evcs.Webasto.Next",
    "alias":"Webasto Next Ladestation",
    "instanceId": UUID,
    "image": base64,
    "properties":{
      "EVCS_ID": "evcs0",
...
public class WebastoNextEvcs extends AbstractOpenemsAppWithProps<WebastoNextEvcs, Property, Parameter.BundleParameter>
	...
	public enum Property implements Type<Property, WebastoNextEvcs, Parameter.BundleParameter>, Nameable {
		...
		private final AppDef<? super WebastoNextEvcs, ? super Property, ? super BundleParameter> def;

		private Property(AppDef<? super WebastoNextEvcs, ? super Property, ? super BundleParameter> def) {
			this.def = def;
		}

		@Override
		public Type<Property, WebastoNextEvcs, BundleParameter> self() {
			return this;
		}

		@Override
		public AppDef<? super WebastoNextEvcs, ? super Property, ? super BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<WebastoNextEvcs>, BundleParameter> getParamter() {
	...
	protected ThrowingTriFunction<ConfigurationTarget, Map<Property, JsonElement>, Language, AppConfiguration, OpenemsNamedException> appPropertyConfigurationFactory() {
		return (t, p, l) -> {
			...
			final var components = Lists.newArrayList(//
					new EdgeConfig.Component(evcsId, alias, "Evcs.Webasto.Next", JsonUtils.buildJsonObject() //
					...
					new EdgeConfig.Component(modbusId,
							TranslationUtil.getTranslation(bundle, "App.Evcs.Webasto.Next.modbus.alias"),
	...
	@Override
	protected WebastoNextEvcs getApp() {
		return this;
	}
