...
import io.openems.edge.app.meter.SiemensMeter.Property;
...
/**
 * Describes a App for a Siemens meter.
 *
 * <pre>
  {
	"appId": "App.Meter.Siemens",
	"alias": "Siemens Zähler",
	"instanceId": UUID,
	"image": base64,
	"properties": {
		"METER_ID": "meter1",
...
@Component(name = "App.Meter.Siemens")
public class SiemensMeter extends AbstractOpenemsAppWithProps<SiemensMeter, Property, Parameter.BundleParameter>
		implements OpenemsApp, AppManagerUtilSupplier {

	public enum Property implements Type<Property, SiemensMeter, Parameter.BundleParameter> {
		// Component-IDs
		...
		private final AppDef<? super SiemensMeter, ? super Property, ? super BundleParameter> def;

		private Property(AppDef<? super SiemensMeter, ? super Property, ? super BundleParameter> def) {
			this.def = def;
		}

		@Override
		public Type<Property, SiemensMeter, BundleParameter> self() {
			return this;
		}

		@Override
		public AppDef<? super SiemensMeter, ? super Property, ? super BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<SiemensMeter>, BundleParameter> getParamter() {
	...
	protected ThrowingTriFunction<ConfigurationTarget, Map<Property, JsonElement>, Language, AppConfiguration, OpenemsNamedException> appPropertyConfigurationFactory() {
		return (t, p, l) -> {
			...
			var components = Lists.newArrayList(//
					new EdgeConfig.Component(meterId, alias, "Meter.Siemens", //
