...
public class TechbaseCm4sGen2 extends AbstractOpenemsAppWithProps<TechbaseCm4sGen2, Property, Parameter.BundleParameter>
	...
	public static enum Property implements Type<Property, TechbaseCm4sGen2, Parameter.BundleParameter> {
		...
		private final AppDef<? super TechbaseCm4sGen2, ? super Property, ? super BundleParameter> def;

		private Property(AppDef<? super TechbaseCm4sGen2, ? super Property, ? super BundleParameter> def) {
			this.def = def;
		}

		@Override
		public Type<Property, TechbaseCm4sGen2, BundleParameter> self() {
			return this;
		}

		@Override
		public AppDef<? super TechbaseCm4sGen2, ? super Property, ? super BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<TechbaseCm4sGen2>, BundleParameter> getParamter() {
			return Parameter.functionOf(AbstractOpenemsApp::getTranslationBundle);
		}
	}

	@Activate
	public TechbaseCm4sGen2(//
	...
	@Override
	protected TechbaseCm4sGen2 getApp() {
		return this;
	}
