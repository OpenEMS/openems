...
import io.openems.edge.app.openemshardware.TechbaseCm4s.Property;
...
public class TechbaseCm4s extends AbstractOpenemsAppWithProps<TechbaseCm4s, Property, Parameter.BundleParameter>
	...
	public static enum Property implements Type<Property, TechbaseCm4s, Parameter.BundleParameter> {
		// Properties
		ALIAS(alias()), //
		;

		private final AppDef<? super TechbaseCm4s, ? super Property, ? super BundleParameter> def;

		private Property(AppDef<? super TechbaseCm4s, ? super Property, ? super BundleParameter> def) {
			this.def = def;
		}

		@Override
		public Type<Property, TechbaseCm4s, BundleParameter> self() {
			return this;
		}

		@Override
		public AppDef<? super TechbaseCm4s, ? super Property, ? super BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<TechbaseCm4s>, BundleParameter> getParamter() {
