...
import io.openems.edge.app.timeofusetariff.Ews.Property;
...
/**
 * Describes a App for Ews.
 *
 * <pre>
  {
    "appId":"App.TimeOfUseTariff.Ews",
    "alias":"Ews",
    "instanceId": UUID,
    "image": base64,
    "properties":{
...
public class Ews extends AbstractOpenemsAppWithProps<Ews, Property, Type.Parameter.BundleParameter>
	...
	public static enum Property implements Type<Property, Ews, Type.Parameter.BundleParameter>, Nameable {
		...
		@Override
		public AppDef<? super Ews, ? super Property, ? super Type.Parameter.BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<Ews>, Type.Parameter.BundleParameter> getParamter() {
