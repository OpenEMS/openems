...
import io.openems.edge.app.timeofusetariff.StadtwerkHassfurt.Property;
...
/**
 * Describes a App for StadtwerkHassfurt.
 *
 * <pre>
  {
 ...
 * </pre>
 */
@Component(name = "App.TimeOfUseTariff.Hassfurt")
public class StadtwerkHassfurt extends
		AbstractOpenemsAppWithProps<StadtwerkHassfurt, Property, Type.Parameter.BundleParameter> implements OpenemsApp {

	public static enum Property implements Type<Property, StadtwerkHassfurt, Type.Parameter.BundleParameter>, Nameable {
		// Component-IDs
		...
		TARIFF_TYPE(AppDef.copyOfGeneric(defaultDef(), def -> def //
				.setTranslatedLabelWithAppPrefix(".tariffType.label") //
				.setTranslatedDescriptionWithAppPrefix(".tariffType.description") //
				.setRequired(true)//
		...
		private Property(
				AppDef<? super StadtwerkHassfurt, ? super Property, ? super Type.Parameter.BundleParameter> def) {
			this.def = def;
		}
		...
		@Override
		public AppDef<? super StadtwerkHassfurt, ? super Property, ? super Type.Parameter.BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<StadtwerkHassfurt>, Type.Parameter.BundleParameter> getParamter() {
			return Type.Parameter.functionOf(AbstractOpenemsApp::getTranslationBundle);
		}
	}

	@Activate
	public StadtwerkHassfurt(@Reference ComponentManager componentManager, ComponentContext context,
	...
	@Override
	protected StadtwerkHassfurt getApp() {
		return this;
	}

	public enum TariffType implements TranslatableEnum {
		STROM_FLEX("haStrom Flex"), //
		STROM_FLEX_PRO("haStrom Flex Pro"), //
		;
