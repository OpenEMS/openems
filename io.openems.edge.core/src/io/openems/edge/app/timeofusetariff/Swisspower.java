...
import io.openems.edge.app.timeofusetariff.Swisspower.Property;
...
/**
 * Describes a App for Swisspower.
 *
 * <pre>
  {
...
public class Swisspower extends AbstractOpenemsAppWithProps<Swisspower, Property, Type.Parameter.BundleParameter>
		implements OpenemsApp {

	public static enum Property implements Type<Property, Swisspower, Type.Parameter.BundleParameter>, Nameable {
		// Component-IDs
		...
		private Property(AppDef<? super Swisspower, ? super Property, ? super Type.Parameter.BundleParameter> def) {
			this.def = def;
		}
		...
		@Override
		public AppDef<? super Swisspower, ? super Property, ? super Type.Parameter.BundleParameter> def() {
			return this.def;
		}

		@Override
		public Function<GetParameterValues<Swisspower>, Type.Parameter.BundleParameter> getParamter() {
			return Type.Parameter.functionOf(AbstractOpenemsApp::getTranslationBundle);
		}
	}

	@Activate
	public Swisspower(@Reference ComponentManager componentManager, ComponentContext context,
		...
		return (t, p, l) -> {
			...
			var components = Lists.newArrayList(//
					...
					new EdgeConfig.Component(timeOfUseTariffProviderId, this.getName(l), "TimeOfUseTariff.Swisspower",
							JsonUtils.buildJsonObject() //
									.addPropertyIfNotNull("meteringCode", meteringCode) //
