...
class AppEnerixControlTest {
	...
	private AppEnerixControl enerixControl;

	@BeforeEach
	void beforeEach() throws Exception {
		this.appManagerTestBundle = new AppManagerTestBundle(null, null, t -> List.of(//
				this.enerixControl = Apps.enerixControl(t) //
	...
	void testHasOnlyExpectedProperties() {
		this.appManagerTestBundle //
				.withApp(this.enerixControl) //
				.hasOnlyProperties(//
						AppEnerixControl.Property.CONTROLLER_ID, //
						AppEnerixControl.Property.ALIAS, //
						AppEnerixControl.Property.URL, //
						AppEnerixControl.Property.PRIVACY_POLICY);
	}
	...
	void testRejectIncompleteUrl() throws Exception {
		...
		assertTrue(exception.getMessage().contains("enerixControl Push-API-URL ist unvollständig oder ungültig"));
	...
	void testUpdateUrl() throws Exception {
		...
		this.updateUrl(instance.instanceId, CleverPvUrl.MASKED_URL);
		this.assertUrl(URL);
	...
	private OpenemsAppInstance installWithUrl(String url) throws OpenemsNamedException {
		return this.appManagerTestBundle.sut
				.handleAddAppInstanceRequest(DUMMY_ADMIN,
						new AddAppInstance.Request(this.enerixControl.getAppId(), "key", "alias", properties(url)))
				.instance();
	}
	...
	private void assertUrl(String url) throws OpenemsNamedException {
		this.appManagerTestBundle.assertComponentExist(//
				new EdgeConfig.Component("ctrlEnerixControl0", "alias", "Controller.Clever-PV",
