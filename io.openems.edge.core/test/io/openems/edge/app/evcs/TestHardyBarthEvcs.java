...
public class TestHardyBarthEvcs {
	...
	public void testInstallationAndUpdate() throws Exception {
		final var installResponse = this.appManagerTestBundle.sut.handleAddAppInstanceRequest(this.user,
		...
		final var updateToDoubleResponse = this.appManagerTestBundle.sut.handleUpdateAppInstanceRequest(this.user,
		...
		final var updateBackToSingleResponse = this.appManagerTestBundle.sut.handleUpdateAppInstanceRequest(this.user,
