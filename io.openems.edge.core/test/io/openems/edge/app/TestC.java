 ...
 */
@Component(name = "App.Test.TestC")
public class TestC extends AbstractEnumOpenemsApp<Property> implements OpenemsApp {
	...
	@Activate
	public TestC(@Reference ComponentManager componentManager, ComponentContext componentContext,
