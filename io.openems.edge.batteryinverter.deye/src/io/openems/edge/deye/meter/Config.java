...
@ObjectClassDefinition(name = "Deye Meter Internal", //
		description = "Implements the internal Deye Meter connected via CTs")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Deye [{id}]";
