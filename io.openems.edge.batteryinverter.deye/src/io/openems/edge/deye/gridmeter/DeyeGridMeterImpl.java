	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		return new ModbusProtocol(this,
				new FC3ReadRegistersTask(633, Priority.HIGH,
						...
						m(BatteryInverterDeye.ChannelId.ACTIVE_POWER_L2, new SignedWordElement(634)),
						m(BatteryInverterDeye.ChannelId.ACTIVE_POWER_L3, new SignedWordElement(635))));
	}

	@Override
	public String debugLog() {
		return "GRID OUIDA L:" + this.getActivePower().asString();
	}
