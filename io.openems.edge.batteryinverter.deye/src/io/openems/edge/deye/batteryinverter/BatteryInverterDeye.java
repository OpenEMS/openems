...
import io.openems.edge.deye.batteryinverter.enums.ActivePowerControlMode;
import io.openems.edge.deye.batteryinverter.enums.Baudrate;
import io.openems.edge.deye.batteryinverter.enums.BlackStartMode;
import io.openems.edge.deye.batteryinverter.enums.CpuType;
import io.openems.edge.deye.batteryinverter.enums.DcVoltageLevel;
import io.openems.edge.deye.batteryinverter.enums.Epo;
import io.openems.edge.deye.batteryinverter.enums.FrequencyVariationRate;
import io.openems.edge.deye.batteryinverter.enums.InterfaceType;
import io.openems.edge.deye.batteryinverter.enums.ModulePowerLevel;
import io.openems.edge.deye.batteryinverter.enums.PhaseAngleAbrupt;
import io.openems.edge.deye.batteryinverter.enums.PowerRisingMode;
import io.openems.edge.deye.batteryinverter.enums.ProtocolSelection;
import io.openems.edge.deye.batteryinverter.enums.ReactivePowerControlMode;
import io.openems.edge.deye.batteryinverter.enums.SinexcelGridMode;
import io.openems.edge.deye.batteryinverter.enums.SinglePhaseMode;
import io.openems.edge.deye.batteryinverter.enums.StartMode;
import io.openems.edge.deye.batteryinverter.enums.Switch;
import io.openems.edge.deye.batteryinverter.statemachine.StateMachine.State;

public interface BatteryInverterDeye extends OffGridBatteryInverter, ManagedSymmetricBatteryInverter, SymmetricBatteryInverter, OpenemsComponent, StartStoppable, ModbusSlave {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		BATTERY_INVERTER_STATE(new BooleanDoc() //
				...
				.<BatteryInverterDeye>onChannelChange((self, value) -> self._setInverterState(value.get()))),

		INVERTER_GRID_MODE(new BooleanDoc() //
				.debounce(5, Debounce.FALSE_VALUES_IN_A_ROW_TO_SET_FALSE) //
				.text("On Grid") //
				.<BatteryInverterDeye>onChannelChange((self, value) -> {
		...
		PASSWORD(Doc.of(OpenemsType.INTEGER) //
				.accessMode(AccessMode.WRITE_ONLY)), //
		ACTIVE_POWER_1(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_ONLY)),
		ACTIVE_POWER_2(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_ONLY) //
		),;
	...
	/**
	 * Gets the Channel for {@link SymmetricBatteryInverter.ChannelId#ACTIVE_POWER}.
	 *
	 * @return the Channel
	 */
	public default IntegerReadChannel getActive1PowerChannel() {
		return this.channel(ChannelId.ACTIVE_POWER_1);
	}
	 ...
	 * @return the Channel
	 */
	public default IntegerReadChannel getActive2PowerChannel() {
		return this.channel(ChannelId.ACTIVE_POWER_2);
	}
