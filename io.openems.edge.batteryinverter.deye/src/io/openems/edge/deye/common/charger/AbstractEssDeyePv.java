...
public abstract class AbstractEssDeyePv extends AbstractOpenemsModbusComponent
		implements DeyeSunPv, EssDcCharger, ModbusComponent, OpenemsComponent, TimedataProvider,
	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		var protocol = new ModbusProtocol(this, //
				new FC16WriteRegistersTask(0x0503, //
						m(DeyeSunPv.ChannelId.SET_PV_POWER_LIMIT, new UnsignedWordElement(0x0503),
								SCALE_FACTOR_2))); //
			...
			protocol.addTasks(//
					new FC3ReadRegistersTask(0xA130, Priority.LOW, //
							...
							m(DeyeSunPv.ChannelId.BMS_DCDC_OUTPUT_CURRENT, new SignedWordElement(0xA131),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_OUTPUT_POWER, new SignedWordElement(0xA132),
									SCALE_FACTOR_2), //
							...
							m(DeyeSunPv.ChannelId.BMS_DCDC_INPUT_CURRENT, new SignedWordElement(0xA134),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_INPUT_POWER, new SignedWordElement(0xA135),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_INPUT_ENERGY, new SignedWordElement(0xA136),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_OUTPUT_ENERGY, new SignedWordElement(0xA137),
									SCALE_FACTOR_2), //
							new DummyRegisterElement(0xA138, 0xA13F), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_REACTOR_TEMPERATURE,
									new SignedWordElement(0xA140)), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_IGBT_TEMPERATURE,
					...
					new FC3ReadRegistersTask(0xA730, Priority.LOW, //
							...
							m(DeyeSunPv.ChannelId.PV_DCDC_OUTPUT_CURRENT, new SignedWordElement(0xA731),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_OUTPUT_POWER, new SignedWordElement(0xA732),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_INPUT_VOLTAGE, new SignedWordElement(0xA733),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_INPUT_CURRENT, new SignedWordElement(0xA734),
									SCALE_FACTOR_2), //
							m(EssDcCharger.ChannelId.ACTUAL_POWER, new SignedWordElement(0xA735), SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_INPUT_ENERGY, new SignedWordElement(0xA736),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_OUTPUT_ENERGY, new SignedWordElement(0xA737),
									SCALE_FACTOR_2), //
							new DummyRegisterElement(0xA738, 0xA73F), //
							m(DeyeSunPv.ChannelId.PV_DCDC_REACTOR_TEMPERATURE,
									new SignedWordElement(0xA740)), //
							m(DeyeSunPv.ChannelId.PV_DCDC_IGBT_TEMPERATURE,
			...
			protocol.addTasks(//
					new FC3ReadRegistersTask(0xAA30, Priority.LOW, //
							...
							m(DeyeSunPv.ChannelId.PV_DCDC_OUTPUT_CURRENT, new SignedWordElement(0xAA31),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_OUTPUT_POWER, new SignedWordElement(0xAA32),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_INPUT_VOLTAGE, new SignedWordElement(0xAA33),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_INPUT_CURRENT, new SignedWordElement(0xAA34),
									SCALE_FACTOR_2), //
							m(EssDcCharger.ChannelId.ACTUAL_POWER, new SignedWordElement(0xAA35), SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_INPUT_ENERGY, new SignedWordElement(0xAA36),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.PV_DCDC_OUTPUT_ENERGY, new SignedWordElement(0xAA37),
									SCALE_FACTOR_2), //
					...
					new FC3ReadRegistersTask(0xA430, Priority.LOW, //
							...
							m(DeyeSunPv.ChannelId.BMS_DCDC_OUTPUT_CURRENT, new SignedWordElement(0xA431),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_OUTPUT_POWER, new SignedWordElement(0xA432),
									SCALE_FACTOR_2), //
							...
							m(DeyeSunPv.ChannelId.BMS_DCDC_INPUT_CURRENT, new SignedWordElement(0xA434),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_INPUT_POWER, new SignedWordElement(0xA435),
									SCALE_FACTOR_2), //
							m(DeyeSunPv.ChannelId.BMS_DCDC_INPUT_ENERGY, new SignedWordElement(0xA436),
									SCALE_FACTOR_2), //
