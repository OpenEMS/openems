...
public interface DeyeSunHybrid
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		// Battery Channels
		// AC 1/31/2024
		BATTERY_CAPACITY(Doc.of(OpenemsType.INTEGER).unit(Unit.AMPERE_HOURS).accessMode(AccessMode.READ_WRITE)),
		BATTERY_CAPACITY_SHUTDOWN(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT)),
		BATTERY_CAPACITY_RESTART(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT)),
		BATTERY_CAPACITY_LOW_BATTERY(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT)),
		MAX_A_BATTERY_CHARGE_CURRENT(Doc.of(OpenemsType.INTEGER).unit(Unit.AMPERE)),
		MAX_A_BATTERY_DISCHARGE_CURRENT(Doc.of(OpenemsType.INTEGER).unit(Unit.AMPERE)),
		PARALLEL_BAT_1_AND_BAT_2(Doc.of(OpenemsType.INTEGER)), BAT_1_SOC(Doc.of(OpenemsType.INTEGER)),

		// Battery Time of Use settings
		// AC 2/16/2024
		TIME_OF_USE_SELLING_FLAG(Doc.of(OpenemsType.BOOLEAN).accessMode(AccessMode.READ_WRITE)),
		...
		// AC 1/31/2024
		GEN_MAX_RUN_TIME(Doc.of(OpenemsType.INTEGER).unit(Unit.HOUR)),
		GEN_COOLING_TIME(Doc.of(OpenemsType.INTEGER).unit(Unit.HOUR)),
		GEN_CHARGING_STARTING_CAPACITY_POINT(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT)),
		GEN_CHARGING_CURRENT_TO_BATTERY(Doc.of(OpenemsType.INTEGER).unit(Unit.AMPERE)),
		GEN_CHARGE_ENABLED(Doc.of(OpenemsType.INTEGER)),
		GRID_CHARGING_STARTING_CAPACITY_POINT(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT)),
		GRID_CHARGING_CURRENT_TO_BATTERY(Doc.of(OpenemsType.INTEGER).unit(Unit.AMPERE)),
		GRID_CHARGE_ENABLED(Doc.of(OpenemsType.INTEGER)), AC_COUPLE_FREQUENCY_CAP(Doc.of(OpenemsType.INTEGER)),
		GEN_LOAD_OFF_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT)),
		GEN_LOAD_ON_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT)), GEN_GRID_SIGNAL(Doc.of(OpenemsType.INTEGER)),
		GEN_CONNECTED_TO_GRID_INPUT(Doc.of(OpenemsType.INTEGER)),
		GEN_PEAK_SHAVING_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT)),
		GRID_PEAK_SHAVING_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT)),

		// Solar Channels
		// AC 1/31/2024
		SOLAR_SELL(Doc.of(OpenemsType.INTEGER)),

		TIME_POINT_1_GRID_GEN_CHARGE_ENABLE(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		TIME_POINT_2_GRID_GEN_CHARGE_ENABLE(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		TIME_POINT_3_GRID_GEN_CHARGE_ENABLE(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		TIME_POINT_4_GRID_GEN_CHARGE_ENABLE(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		TIME_POINT_5_GRID_GEN_CHARGE_ENABLE(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		TIME_POINT_6_GRID_GEN_CHARGE_ENABLE(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),

		SELL_MODE_TIME_POINT_1(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_2(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_3(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_4(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_5(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_6(Doc.of(OpenemsType.INTEGER).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_1_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_2_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_3_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_4_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_5_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_TIME_POINT_6_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_CAPACITY_1(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_CAPACITY_2(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_CAPACITY_3(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_CAPACITY_4(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_CAPACITY_5(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SELL_MODE_CAPACITY_6(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		MICROINVERTER_EXPORT_TO_GRID_CUTOFF(Doc.of(OpenemsType.INTEGER)),
		SOLAR_ARC_FAULT_ON(Doc.of(OpenemsType.INTEGER)),
		MAX_SOLAR_SELL_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.WATT)),

		// Other Channels
		// AC 1/31/2024
		ZERO_EXPORT_POWER(Doc.of(OpenemsType.INTEGER) //
				.unit(Unit.WATT).accessMode(AccessMode.READ_WRITE)),
		UPS_BACKUP_DELAY_TIME(Doc.of(OpenemsType.INTEGER).unit(Unit.SECONDS)),
