...
@ObjectClassDefinition(//
		name = "Battery FENECON F2B Serial Cluster", //
		description = "Combines several in series connected battery devices to one.") //
...
public @interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Battery FENECON F2B Serial Cluster [{id}]";
