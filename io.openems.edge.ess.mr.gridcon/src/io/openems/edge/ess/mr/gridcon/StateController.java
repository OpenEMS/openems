...
public class StateController {
	...
	public static void initOnOffGrid(ComponentManager manager, String gridconPCS, String b1, String b2,
		...
		stateObjects.put(io.openems.edge.ess.mr.gridcon.state.onoffgrid.OnOffGridState.WAIT_FOR_DEVICES, new io.openems.edge.ess.mr.gridcon.state.onoffgrid.WaitForDevices(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId));
		
		OnGrid onGrid = new io.openems.edge.ess.mr.gridcon.state.onoffgrid.OnGrid(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId, targetFrequencyOnGrid);
		...
		stateObjects.put(io.openems.edge.ess.mr.gridcon.state.onoffgrid.OnOffGridState.OFF_GRID_MODE, new io.openems.edge.ess.mr.gridcon.state.onoffgrid.OffGrid(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId, targetFrequencyOffGrid));
		stateObjects.put(io.openems.edge.ess.mr.gridcon.state.onoffgrid.OnOffGridState.OFF_GRID_MODE_GRID_BACK, new io.openems.edge.ess.mr.gridcon.state.onoffgrid.OffGridGridBack(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId, targetFrequencyOffGrid));
		stateObjects.put(io.openems.edge.ess.mr.gridcon.state.onoffgrid.OnOffGridState.OFF_GRID_MODE_WAIT_FOR_GRID_AVAILABLE, new io.openems.edge.ess.mr.gridcon.state.onoffgrid.WaitForGridAvailable(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId, targetFrequencyOffGrid));
		stateObjects.put(io.openems.edge.ess.mr.gridcon.state.onoffgrid.OnOffGridState.OFF_GRID_MODE_ADJUST_PARMETER, new io.openems.edge.ess.mr.gridcon.state.onoffgrid.AdjustParameter(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId, deltaFrequency, deltaVoltage));
