...
public class StateController {
	...
	public static void initOnGrid(//
		...
		stateObjects.put(io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.GridconState.STOPPED, new io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.Stopped(manager, gridconPCS, b1, b2, b3, enableIPU1, enableIPU2, enableIPU3, parameterSet));
		stateObjects.put(io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.GridconState.RUN, new io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.Run(manager, gridconPCS, b1, b2, b3, enableIPU1, enableIPU2, enableIPU3, parameterSet));
		StateObject gridconUndefined = new io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.Undefined(manager, gridconPCS, b1, b2, b3);
		stateObjects.put(io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.GridconState.UNDEFINED, gridconUndefined );
		stateObjects.put(io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.GridconState.ERROR, new io.openems.edge.ess.mr.gridcon.ongrid.state.gridconstate.Error(manager, gridconPCS, b1, b2, b3, enableIPU1, enableIPU2, enableIPU3, parameterSet));
		
		stateObjects.put(io.openems.edge.ess.mr.gridcon.ongrid.OnGridState.UNDEFINED, new io.openems.edge.ess.mr.gridcon.ongrid.state.Undefined());
		stateObjects.put(io.openems.edge.ess.mr.gridcon.ongrid.OnGridState.ERROR, new io.openems.edge.ess.mr.gridcon.ongrid.state.Error());
		StateObject onGridStateObject = new io.openems.edge.ess.mr.gridcon.ongrid.state.OnGrid();
		onGridStateObject.setSubStateObject(gridconUndefined);
		stateObjects.put(io.openems.edge.ess.mr.gridcon.ongrid.OnGridState.ONGRID, onGridStateObject );		
	}
	...
	public static void initOnOffGrid(ComponentManager manager, String gridconPCS, String b1, String b2,
		...
		stateObjects.put(io.openems.edge.ess.mr.gridcon.onoffgrid.OnOffGridState.UNDEFINED, new io.openems.edge.ess.mr.gridcon.onoffgrid.state.Undefined(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId));
		stateObjects.put(io.openems.edge.ess.mr.gridcon.onoffgrid.OnOffGridState.START_SYSTEM, new io.openems.edge.ess.mr.gridcon.onoffgrid.state. StartSystem(manager, condition, gridconPCS, b1, b2, b3, inputNAProtection1, inputNAProtection2, inputSyncDeviceBridge, outputSyncDeviceBridge, meterId));
