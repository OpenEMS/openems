...
public enum CCUState implements OptionsEnum {
	...
	PRECHARGE_CURRENTLY_NOT_WORKING(3, "PRECHARGE"), // = 3, // IPU State
	GO_IDLE_CURRENTLY_NOT_WORKING(4, "GO_IDLE"), // = 4, // System changes STATE_IDLE
	CHARGED_CURRENTLY_NOT_WORKING(5, "CHARGED"), // = 5, // IPU State
	READY_CURRENTLY_NOT_WORKING(6, "READY"), // = 6, // IPU State
	RUN_CURRENTLY_NOT_WORKING(7, "RUN"), // = 7, // IPU State
