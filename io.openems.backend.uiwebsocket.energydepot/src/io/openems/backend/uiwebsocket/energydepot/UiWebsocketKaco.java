...
@Component(name = "UiWebsocketKaco", configurationPolicy = ConfigurationPolicy.REQUIRE, immediate = true)
public class UiWebsocketKaco extends AbstractOpenemsBackendComponent implements UiWebsocket {
	...
	public UiWebsocketKaco() {
		super("UiWebsocketKaco");
	}
