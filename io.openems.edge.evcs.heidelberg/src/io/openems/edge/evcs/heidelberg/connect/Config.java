...
@ObjectClassDefinition(//
		...
		description = "Implements the connect series of the Heidelberg electric vehicle charging station.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "EVCS Heidelberg Connect [{id}]";
