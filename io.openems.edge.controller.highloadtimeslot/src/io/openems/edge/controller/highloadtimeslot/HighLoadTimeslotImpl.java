...
public class HighLoadTimeslotImpl extends AbstractOpenemsComponent
		implements HighLoadTimeslot, Controller, OpenemsComponent {
	...
	private final Logger log = LoggerFactory.getLogger(HighLoadTimeslotImpl.class);
	...
	public HighLoadTimeslotImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				HighLoadTimeslot.ChannelId.values() //
		);
	}
