...
@interface Config {
	...
	@AttributeDefinition(name = "Modbus address offset", description = "address offset in Logo!. This is where the virtual addresses start, e.g. 808 for virtual address 101.0 in Logo!")
	int modbusOffsetAdress() default 800;
