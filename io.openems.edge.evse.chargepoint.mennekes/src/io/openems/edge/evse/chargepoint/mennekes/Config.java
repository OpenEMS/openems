...
@ObjectClassDefinition(name = "EVSE Charge-Point MENNEKES", //
		description = "The MENNEKES electric vehicle charging station")
public @interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "EVSE Charge-Point MENNEKES [{id}]";
}