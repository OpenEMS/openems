...
import static io.openems.edge.timeofusetariff.entsoe.EntsoeApi.FORMATTER_MINUTES;
...
public class EntsoeApiTest {
	...
	public void testQuery() throws IOException {
		var token = "";
		var areaCode = "10Y1001A1001A82H";
		var fromDate = ZonedDateTime.of(2023, 6, 1, 0, 0, 0, 0, ZoneId.of("Europe/Berlin"));
	...
	private static record QueryResult(ZonedDateTime start, List<Double> prices) {
	 ...
	 * @throws IOException
	 */
	private QueryResult parse(String xml, String resolution)
		...
		stream(root) //
				...
				.forEach(period -> {
					result.start(ZonedDateTime.parse(//
							stream(period) //
									// <timeInterval>
