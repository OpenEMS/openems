...
public interface MeterPlexlogDatalogger extends SymmetricMeter, ModbusComponent, OpenemsComponent {
	...
	/**
	 * Gets the Total Consumption in [Wh_Σ]. See
	 * {@link ChannelId#TOTAL_CONSUMPTION}.
	 *
	 * @return the Channel {@link Value}
	 */
