...
public enum BMWChannelId implements io.openems.edge.common.channel.ChannelId {
	...
	BMS_STATE_COMMAND_CLOSE_PRECHARGE(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onInit( new BooleanWriteChannel.MirrorToDebugChannel(BMWChannelId.BMS_STATE_COMMAND_CLOSE_PRECHARGE_DEBUG)) //
	),
	...
	BMS_STATE_COMMAND_CLOSE_CONTACTOR(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onInit( new BooleanWriteChannel.MirrorToDebugChannel(BMWChannelId.BMS_STATE_COMMAND_CLOSE_CONTACTOR_DEBUG)) //
	),
	...
	BMS_STATE_COMMAND_WAKE_UP_FROM_STOP(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onInit( new BooleanWriteChannel.MirrorToDebugChannel(BMWChannelId.BMS_STATE_COMMAND_WAKE_UP_FROM_STOP_DEBUG)) //
	),
	
	BMS_STATE_COMMAND_ENABLE_BATTERY_DEBUG(Doc.of(OpenemsType.BOOLEAN)), //
	BMS_STATE_COMMAND_ENABLE_BATTERY(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onInit( new BooleanWriteChannel.MirrorToDebugChannel(BMWChannelId.BMS_STATE_COMMAND_ENABLE_BATTERY_DEBUG)) //
	),
	...
	OPERATION_MODE_REQUEST_CANCELED(new IntegerDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onInit( new IntegerWriteChannel.MirrorToDebugChannel(BMWChannelId.OPERATION_MODE_REQUEST_CANCELED_DEBUG)) //
	),
	
	CONNECTION_STRATEGY_HIGH_SOC_FIRST_DEBUG(Doc.of(OpenemsType.BOOLEAN)), //
	CONNECTION_STRATEGY_HIGH_SOC_FIRST(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onInit( new BooleanWriteChannel.MirrorToDebugChannel(BMWChannelId.CONNECTION_STRATEGY_HIGH_SOC_FIRST_DEBUG)) //
	),

	CONNECTION_STRATEGY_LOW_SOC_FIRST_DEBUG(Doc.of(OpenemsType.BOOLEAN)), //
	CONNECTION_STRATEGY_LOW_SOC_FIRST(new BooleanDoc() //
			.accessMode(AccessMode.READ_WRITE) //
			.onInit( new BooleanWriteChannel.MirrorToDebugChannel(BMWChannelId.CONNECTION_STRATEGY_LOW_SOC_FIRST_DEBUG)) //
	),
