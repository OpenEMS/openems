...
public class Context extends AbstractContext<RefuStore88k> {
	...
	public Context(RefuStore88k parent, Battery battery, Config config, int setActivePower, int setReactivePower) {
		super(parent);
