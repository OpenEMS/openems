...
public class DelayChargeControllerImpl extends AbstractOpenemsComponent
		implements DelayChargeController, Controller, OpenemsComponent {
	...
	public DelayChargeControllerImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				Controller.ChannelId.values(), //
				DelayChargeController.ChannelId.values() //
		);
	}
	...
	private void setChannels(State state, int limit) {
		EnumReadChannel stateMachineChannel = this.channel(DelayChargeController.ChannelId.STATE_MACHINE);
		stateMachineChannel.setNextValue(state);

		IntegerReadChannel chargePowerLimitChannel = this.channel(DelayChargeController.ChannelId.CHARGE_POWER_LIMIT);
