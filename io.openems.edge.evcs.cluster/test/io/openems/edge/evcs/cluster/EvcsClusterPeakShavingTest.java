...
public class EvcsClusterPeakShavingTest {
	...
	private static final String EVCS0_ID = "evcs0";
	private static final ChannelAddress EVCS0_CHARGE_POWER = new ChannelAddress(EVCS0_ID, "ChargePower");
	private static final ChannelAddress EVCS0_SET_CHARGE_POWER_LIMIT = new ChannelAddress(EVCS0_ID,
			"SetChargePowerLimit");

	private static final String EVCS1_ID = "evcs1";
	private static final ChannelAddress EVCS1_CHARGE_POWER = new ChannelAddress(EVCS1_ID, "ChargePower");
	private static final ChannelAddress EVCS1_SET_CHARGE_POWER_LIMIT = new ChannelAddress(EVCS1_ID,
			"SetChargePowerLimit");
	...
	private static final ChannelAddress METER_ACTIVE_POWER_L1 = new ChannelAddress(METER_ID, "ActivePowerL1");
	private static final ChannelAddress METER_ACTIVE_POWER_L2 = new ChannelAddress(METER_ID, "ActivePowerL2");
	private static final ChannelAddress METER_ACTIVE_POWER_L3 = new ChannelAddress(METER_ID, "ActivePowerL3");

	// private class EvcsClusterComponentTest
	// extends AbstractComponentTest<EvcsClusterComponentTest, AbstractEvcsCluster>
	// {
	//
	// public EvcsClusterComponentTest(AbstractEvcsCluster cluster,
	...
	// @Test
	protected void peakShavingClusterTest1() throws Exception {
