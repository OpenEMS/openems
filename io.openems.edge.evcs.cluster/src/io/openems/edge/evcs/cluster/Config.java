...
@interface Config {
	...
	@AttributeDefinition(name = "Minimum guarantee charge power", description = "Minimum charge power that will be used by every EV that is able to charge with that minimum.", required = true)
	int minimumGuaranteeChargePower() default 4500;
	...
	@AttributeDefinition(name = "Ess-ID", description = "ID of Ess device.", required = false)
