...
@ObjectClassDefinition(//
		name = "EVCS Cluster", //
		description = "Limits the maximum charging power of all electric vehicle charging stations, depending on the maximum hardware power and user inputs.")
@interface Config {
	...
	@AttributeDefinition(name = "Manual current limit", description = "The maximum current in Ampere that will be used for all charging Stations.")
	int manualCurrentLimit() default 20;
