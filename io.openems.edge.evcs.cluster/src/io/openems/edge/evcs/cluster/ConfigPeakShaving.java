...
@ObjectClassDefinition(//
		...
		description = "Limits the maximum charging power of all electric vehicle charging stations, "
				+ "depending on the ecxess power and the maximal allowed discharge of the storage.")
@interface ConfigPeakShaving {
	...
	@AttributeDefinition(name = "Evcs-IDs", description = "IDs of EVCS devices ordered by the priority. "
			+ "(Only Managed Evcss will be considered because their charging power can be corrected)")
