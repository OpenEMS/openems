...
@ObjectClassDefinition( //
		name = "BMS BYD Commercial Battery Box C130", //
		description = "Implements the BYD Commerical Battery Box C130 system.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "BMS BYD Commercial Battery Box C130 [{id}]";
}