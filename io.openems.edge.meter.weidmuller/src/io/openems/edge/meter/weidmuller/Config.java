...
@ObjectClassDefinition( //
		name = "Meter Weidmuller 525", //
		description = "Implements the Weidmuller 525 Energy Meter.")
@interface Config {
	String service_pid();
	...
	String webconsole_configurationFactory_nameHint() default "Meter Weidmuller 525  [{id}]";
}