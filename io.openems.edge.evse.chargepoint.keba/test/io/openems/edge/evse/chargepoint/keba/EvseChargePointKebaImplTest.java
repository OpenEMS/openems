	...
	public void test() throws Exception {
		new ComponentTest(new EvseChargePointKebaImpl()) //
				...
				.next(new TestCase() //
						...
						.output(EvseChargePointKeba.ChannelId.PTAF_CABLE_OR_SOCKET,
								ProductTypeAndFeatures.CableOrSocket.CABLE) //
						.output(EvseChargePointKeba.ChannelId.PTAF_SUPPORTED_CURRENT,
								ProductTypeAndFeatures.SupportedCurrent.A32) //
						.output(EvseChargePointKeba.ChannelId.PTAF_DEVICE_SERIES,
