...
public class AbstractModbusRecordChannel extends AbstractModbusRecord implements ModbusRecordChannel {

	private final Logger log = LoggerFactory.getLogger(AbstractModbusRecordChannel.class);
	...
	public AbstractModbusRecordChannel(int offset, ModbusType type, ChannelId channelId,
			AccessMode modbusApiAccessMode) {
		super(offset, type);
	...
	public byte[] getValue() {
		throw new IllegalArgumentException("ModbusRecordChannel requires a OpenemsComponent.");
	}
	...
	public String getName() {
		return new ChannelAddress(this.componentId, this.getChannelId().id()).toString();
	}
