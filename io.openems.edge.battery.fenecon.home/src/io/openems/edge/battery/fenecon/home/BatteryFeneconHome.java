...
public interface BatteryFeneconHome extends Battery, ModbusComponent, OpenemsComponent, StartStoppable, ModbusHelper {
	...
	public static enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		RUNNING_FIRMWARE_UPDATE(Doc.of(Level.WARNING)//
				.text("Firmware update is in process. This can take a while.")),
	...
	public default BooleanReadChannel getRunningFirmwareUpdateChannel() {
		return this.channel(ChannelId.RUNNING_FIRMWARE_UPDATE);
	}

	@Override
	public default boolean isFirmwareUpdateRunning() {
		return this.getRunningFirmwareUpdateChannel().value().orElse(false);
	}
}
