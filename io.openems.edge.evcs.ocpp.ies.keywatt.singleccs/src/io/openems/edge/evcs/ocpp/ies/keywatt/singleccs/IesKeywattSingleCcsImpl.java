...
public class IesKeywattSingleCcsImpl extends AbstractManagedOcppEvcsComponent
		implements IesKeywattSingleCcs, Evcs, ManagedEvcs, MeasuringEvcs, OpenemsComponent, EventHandler, SocEvcs {
	...
	public IesKeywattSingleCcsImpl() {
		super(//
				PROFILE_TYPES, //
				...
				IesKeywattSingleCcs.ChannelId.values() //
		);
	}
