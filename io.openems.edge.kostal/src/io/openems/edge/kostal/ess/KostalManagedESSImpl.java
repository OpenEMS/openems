...
public class KostalManagedESSImpl
  ...
  public void applyPower(int activePower, int reactivePower)
    ...
    IntegerWriteChannel setActivePowerChannel =
      this.channel(KostalManagedESS.ChannelId.SET_ACTIVE_POWER);
  ...
  protected ModbusProtocol defineModbusProtocol() {
    return new ModbusProtocol(
      ...
      new FC3ReadRegistersTask(
        ...
        Priority.LOW, //
        m(
          KostalManagedESS.ChannelId.SERIAL_NUMBER,
      ...
      new FC3ReadRegistersTask(
        ...
        Priority.LOW, //
        m(
          KostalManagedESS.ChannelId.INVERTER_STATE,
      ...
      new FC3ReadRegistersTask(
        ...
        Priority.LOW, //
        m(
          KostalManagedESS.ChannelId.ENERGY_MANAGER_MODE,
      ...
      new FC3ReadRegistersTask(
        ...
        m(
          ...
          new FloatDoublewordElement(1046).wordOrder(LSWMSW)
        ), //
        m(
          SymmetricEss.ChannelId.ACTIVE_DISCHARGE_ENERGY,
          new FloatDoublewordElement(1048).wordOrder(LSWMSW)
        )
      ), //
      new FC3ReadRegistersTask(
        172,
        ...
        m(
          ...
          new FloatDoublewordElement(172).wordOrder(LSWMSW)
        )
      ),
      ...
      new FC3ReadRegistersTask(
        ...
        m(
          ...
          new FloatDoublewordElement(174).wordOrder(LSWMSW)
        )
      ), //
      new FC3ReadRegistersTask(
        152,
        Priority.HIGH, //
        m(
          KostalManagedESS.ChannelId.FREQUENCY,
          new FloatDoublewordElement(152).wordOrder(LSWMSW)
        )
      ), //
      new FC3ReadRegistersTask(
        158,
        Priority.HIGH, //
        m(
          KostalManagedESS.ChannelId.GRID_VOLTAGE_L1,
      ...
      new FC3ReadRegistersTask(
        ...
        Priority.HIGH, //
        m(
          KostalManagedESS.ChannelId.GRID_VOLTAGE_L2,
      ...
      new FC3ReadRegistersTask(
        ...
        Priority.HIGH, //
        m(
          KostalManagedESS.ChannelId.GRID_VOLTAGE_L3,
      ...
      new FC3ReadRegistersTask(
        ...
        Priority.HIGH, //
        m(
          KostalManagedESS.ChannelId.BATTERY_CURRENT,
      ...
      new FC3ReadRegistersTask(
        ...
        m(
          ...
          new FloatDoublewordElement(210).wordOrder(LSWMSW)
        )
      ), //
      new FC3ReadRegistersTask(
        214,
        Priority.HIGH, //
        m(
          KostalManagedESS.ChannelId.BATTERY_TEMPERATURE,
          new FloatDoublewordElement(214).wordOrder(LSWMSW)
        ), //
        m(
          KostalManagedESS.ChannelId.BATTERY_VOLTAGE,
          new FloatDoublewordElement(216).wordOrder(LSWMSW)
        )
      ), //
      ...
      new FC16WriteRegistersTask(
        ...
        m(
          ...
          new FloatDoublewordElement(1026).wordOrder(LSWMSW)
        )
      )
    ); //
  }
