...
public interface KostalDcCharger extends EssDcCharger, OpenemsComponent {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		SET_PV_POWER_LIMIT(new IntegerDoc() //
				...
				.onChannelSetNextWriteMirrorToDebugChannel(
						ChannelId.DEBUG_SET_PV_POWER_LIMIT)),
	...
	/**
	 * Gets the Production Power in [W]. This is the power delivered by the
	 * inverter Discharge. See {@link ChannelId#PRODUCTION_POWER}.
	 *
	 * @return the Channel {@link Value}
	 */
	 ...
	 * for Discharge. See {@link ChannelId#DC_DISCHARGE_POWER}.
	 *
	 * @return the Channel {@link Value}
	 */
