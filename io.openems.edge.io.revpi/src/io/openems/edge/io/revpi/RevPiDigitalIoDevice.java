...
public interface RevPiDigitalIoDevice extends DigitalOutput, DigitalInput, OpenemsComponent, EventHandler {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		OUT_1(new BooleanDoc() //
				...
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT1)),
		/**
		...
		OUT_2(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT2)),
		/**
		...
		OUT_3(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT3)),
		/**
		...
		OUT_4(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT4)),
		/**
		...
		OUT_5(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT5)),
		/**
		...
		OUT_6(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT6)),
		/**
		...
		OUT_7(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT7)),
		/**
		...
		OUT_8(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT8)),
		/**
		...
		OUT_9(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT9)),
		/**
		...
		OUT_10(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT10)),
		/**
		...
		OUT_11(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT11)),
		/**
		...
		OUT_12(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT12)),
		/**
		...
		OUT_13(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT13)),
		/**
		...
		OUT_14(new BooleanDoc() //
				.accessMode(AccessMode.READ_WRITE) //
				.onChannelSetNextWriteMirrorToDebugChannel(RevPiDigitalIoDevice.ChannelId.DEBUG_OUT14)),
