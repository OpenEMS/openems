...
public class RevPiCompactTestConfig extends AbstractComponentConfig implements RevPiCompactConfig {

	protected static class Builder {
		private String id = null;
		private boolean initOutputFromHardware = false;
		private String prefixDigitalIn = "DInBit_";
		private String prefixDigitalOut = "DOutBit_";
		private int firstInputIndex = 1;
		private int firstOutputIndex = 1;
		private String inputUsed = "1|1|1|1|1|1|1|1";
		private String outputUsed = "1|1|1|1|1|1|1|1";

		public RevPiCompactTestConfig build() {
			return new RevPiCompactTestConfig(this);
		}
	...
	private RevPiCompactTestConfig(Builder builder) {
		super(RevPiCompactConfig.class, builder.id);
