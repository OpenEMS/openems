...
public class KebaKeContact extends AbstractOpenemsComponent implements Evcs, OpenemsComponent, EventHandler {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		 ...
		 * Report 2
		 */
		STATUS(Doc.of(OpenemsType.INTEGER).text("Current state of the charging station")
		...
		ERROR_2(Doc.of(OpenemsType.INTEGER)
				.text("Detail code for state ERROR; exceptions see FAQ on www.kecontact.com")), //
		PLUG(Doc.of(OpenemsType.INTEGER).options(Plug.values())),
		...
		MAX_CURR(Doc.of(OpenemsType.INTEGER).unit(Unit.MILLIAMPERE)
		...
		CURR_FAILSAFE(Doc.of(OpenemsType.INTEGER).unit(Unit.MILLIAMPERE)
		...
		CURR_TIMER(Doc.of(OpenemsType.INTEGER).unit(Unit.MILLIAMPERE)
		 ...
		 * Write Channels
		 */
		SET_ENABLED(Doc.of(OpenemsType.BOOLEAN).unit(Unit.ON_OFF)
