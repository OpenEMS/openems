...
* https://www.janitza.com/[Janitza UMG 96-PQ-L icon:external-link[]]
* https://www.janitza.com/[Janitza UMG 96-RM-E icon:external-link[]]
...
*Factory-PID*: `Meter.Janitza.UMG96PQL`

.Implemented Natures/Interfaces
* MeterJanitzaUmg96pql
* ElectricityMeter
* ModbusComponent
* OpenemsComponent
* ModbusSlave
