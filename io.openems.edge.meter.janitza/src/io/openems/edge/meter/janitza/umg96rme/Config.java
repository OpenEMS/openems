...
@ObjectClassDefinition(//
		name = "Meter Janitza UMG 96-RM-E", //
		description = "Implements the Janitza UMG 96-RM-E power analyser.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Janitza UMG 96-RM-E [{id}]";
}