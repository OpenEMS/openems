...
<<<<<<< HEAD
	@AttributeDefinition(name = "Invert Power", description = "Swaps production and consumptioon energy")
	...
	String webconsole_configurationFactory_nameHint() default "Meter Janitza UMG104 [{id}]";
}
=======
	@AttributeDefinition(name = "Modbus Unit-ID", description = "The Unit-ID of the Modbus device. Defaults to '1' for Modbus/TCP.")
	int modbusUnitId() default 1;
