...
@ObjectClassDefinition(//
		...
		description = "Implements the Janitza UMG 806 power analyser.")
@interface Config {
	...
	@AttributeDefinition(name = "Module Measurement Number", description = "The number of the measurement (basic device 1-3, module groups 4-X.")
	int measurementNumberId() default 1;
	...
	String webconsole_configurationFactory_nameHint() default "Meter Janitza UMG 801 [{id}]";
}