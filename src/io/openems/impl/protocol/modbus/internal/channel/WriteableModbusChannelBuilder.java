...
import io.openems.api.channel.numeric.WriteableNumericChannelBuilder;
...
public class WriteableModbusChannelBuilder extends WriteableNumericChannelBuilder<WriteableModbusChannelBuilder> {
	...
	public WriteableModbusChannel build() {
		return new WriteableModbusChannel(channelId, nature, unit, minValue, maxValue, multiplier, delta, labels,
				minWriteValue, minWriteValueChannel, maxWriteValue, maxWriteValueChannel);
	}
}
