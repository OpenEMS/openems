...
import io.openems.api.device.nature.AsymmetricEssNature;
...
public class FeneconProEss extends ModbusDeviceNature implements AsymmetricEssNature {
	...
	// public final ModbusChannel _totalBatteryChargeEnergy = new
	// ModbusChannelBuilder().nature(this).unit("Wh").build();
