...
public class DemoSimulator extends Demo {
	...
	@Override public JsonObject getConfig() {
		...
		things.add(bridge0);
		bridge0.add("class", new JsonPrimitive("io.openems.impl.protocol.simulator.SimulatorBridge"));
		JsonArray devices = new JsonArray();
		bridge0.add("devices", devices);

		JsonObject device0 = new JsonObject();
		devices.add(device0);
		device0.add("class", new JsonPrimitive("io.openems.impl.device.simulator.Simulator"));
		...
		// controller1.add("class", new JsonPrimitive("io.openems.impl.controller.testwrite.TestWriteController"));
