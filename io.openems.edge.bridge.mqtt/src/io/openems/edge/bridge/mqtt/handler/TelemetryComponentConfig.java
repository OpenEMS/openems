...
@ObjectClassDefinition(
        name = "MqttTelemetryComponent",
        description = "MqttComponent for Telemetry Data"
)
@interface TelemetryComponentConfig  {

    String service_pid();

    @AttributeDefinition(name = "Component Id", description = "Unique Id of the Component.")
    String id() default "TelemetryMqttComponent0";
    ...
    String webconsole_configurationFactory_nameHint() default "MqttTelemetryComponent [{id}]";
