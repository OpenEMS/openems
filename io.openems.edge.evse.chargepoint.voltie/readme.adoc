...
* On build 360 the lifetime energy register `0x2016` stayed flat for a whole session, which is why the driver requires build 370, where the register includes the running session.
