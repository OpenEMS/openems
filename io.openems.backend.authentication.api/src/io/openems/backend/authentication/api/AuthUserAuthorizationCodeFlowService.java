...
public interface AuthUserAuthorizationCodeFlowService {
	...
	/**
	 * Logs out the user by revoking the refresh token at the OAuth provider.
	 *
	 * <p>
	 * This method will:
	 * <ul>
	 * <li>End the user's session at the OAuth provider</li>
	 * <li>Invalidate the refresh token so it cannot be reused</li>
	 * </ul>
	 * </p>
	 *
	 * @param oem          the OEM of the UI
	 ...
	 */
	CompletableFuture<Void> logout(String oem, String refreshToken);
