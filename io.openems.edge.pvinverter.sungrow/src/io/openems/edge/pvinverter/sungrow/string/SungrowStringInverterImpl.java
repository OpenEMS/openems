...
public class SungrowStringInverterImpl extends AbstractOpenemsModbusComponent implements
        SungrowStringInverter, ElectricityMeter, ModbusComponent, OpenemsComponent, EventHandler, TimedataProvider {
    ...
    protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
        ...
        return new ModbusProtocol(this, new FC4ReadInputRegistersTask(4989, Priority.HIGH,
        		...
        		//	m(ElectricityMeter.ChannelId.ACTIVE_CONSUMPTION, new SignedDoublewordElement(5091)) // 
