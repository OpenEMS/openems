...
public class MyConfigSerialAscii extends AbstractComponentConfig implements ConfigSerialAscii {
	...
	private MyConfigSerialAscii(Builder builder) {
		super(ConfigSerialAscii.class, builder.id);
