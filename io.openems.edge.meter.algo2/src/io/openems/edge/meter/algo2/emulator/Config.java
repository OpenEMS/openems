...
@ObjectClassDefinition(//
		name = "Meter Algo2 Emulated", //
		description = "Implements an Emulator of the Algo2 meters.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Algo2 Emulated [{id}]";
