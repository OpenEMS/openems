...
@ObjectClassDefinition(//
		name = "Meter Algo2 UEM1P5-4DS E", //
		description = "Implements the Algo2 UEM1P5-4DS E meter.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Algo2 UEM1P5-4DS E [{id}]";
