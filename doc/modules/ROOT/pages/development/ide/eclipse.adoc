...
.. Configure Eclipse IDE to use JDK 25.
+
...
- Press the btn:[Directory...] button and select the folder of the installed JDK (e.g. `C:\Program Files\Eclipse Adoptium\jdk-25.0.1.8-hotspot`)
- Press the btn:[Finish] button
- Back in the Preferences window, tick the newly added JDK 25 and press btn:[Apply and Close]
+
.Creating a workspace in Eclipse IDE
