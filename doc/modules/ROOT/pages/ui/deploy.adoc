...
**2. For WSL2 - use the helper script to start the docker UI:**
[source,bash]
----
./start-dev-ui-wsl.sh
----
...
==== further Docker related issues

For more docker related issues, like
* Port 4200 already in use
* Container won't start

see xref:edge/deploy/docker.adoc#_troubleshooting_docker[Edge Docker Troubleshooting] or xref:https://docs.docker.com/compose/gettingstarted/[Docker's documentation]
