...
OpenEMS requires Java 21 to run. If it is not pre-installed on your system, we recommend using https://adoptium.net/?variant=openjdk11&jvmVariant=hotspot[Eclipse Temurin by Adoptium].
