...
There are three ways to get started with OpenEMS. You can either setup your develpement environment and compile OpenEMS Edge from source, or you can use the pre-build packages, or you can use the docker images at https://github.com/OpenEMS/openems/tree/main/tools/docker/[OpenEMS' GitHub].
