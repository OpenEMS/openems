...
OpenEMS requires Java 25 to run. If it is not pre-installed on your system, we recommend using https://adoptium.net/de/temurin/releases?version=25[Eclipse Temurin by Adoptium].
...
```
openjdk version "25.0.1" 2025-10-23 LTS
...
. Set up a web server serving this directory on port 4200 and start it. Any web server can be used. You can find information on how to set up the nginx webserver xref:ui/deploy/nginx.adoc[here].
