...
NOTE: If you plan to actively develop on OpenEMS UI, you can now also setup a development environment for it using xref:ui/setup-ide.adoc[this guide]. Otherwise you can use the prebuilt UI or xref:ui/deploy-ui.adoc[deploy the OpenEMS UI as docker image].
