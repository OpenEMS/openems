...
public class EvcsControllerImpl extends AbstractOpenemsComponent
		implements EvcsController, Controller, OpenemsComponent, ModbusSlave {
	...
	void activate(ComponentContext context, Config config) throws OpenemsNamedException {
		...
		this.channel(EvcsController.ChannelId.CHARGE_MODE).setNextValue(config.chargeMode());
		this.channel(EvcsController.ChannelId.PRIORITY).setNextValue(config.priority());
		this.channel(EvcsController.ChannelId.ENABLED_CHARGING).setNextValue(config.enabledCharging());
		this.channel(EvcsController.ChannelId.DEFAULT_CHARGE_MINPOWER).setNextValue(config.defaultChargeMinPower());
		this.channel(EvcsController.ChannelId.FORCE_CHARGE_MINPOWER).setNextValue(config.forceChargeMinPower());
