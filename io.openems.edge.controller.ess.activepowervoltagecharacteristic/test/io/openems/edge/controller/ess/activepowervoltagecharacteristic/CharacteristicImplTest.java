	...
	public void test() throws Exception {
		...
		new ControllerTest(new ActivePowerVoltageCharacteristicImpl())//
				...
				.next(new TestCase("Second Input, \"Power: -1500 \"") //
						.timeleap(clock, 5, ChronoUnit.SECONDS).input(METER_VOLTAGE, 248_000) // [mV]
				...
				.next(new TestCase("Third Input, \"Power: 0 \"") //
						.timeleap(clock, 5, ChronoUnit.SECONDS).input(METER_VOLTAGE, 238_100)// [mV]
				...
				.next(new TestCase("Fourth Input, \"Power: 0 \"") //
						.timeleap(clock, 5, ChronoUnit.SECONDS).input(METER_VOLTAGE, 235_200)// [mV]
						.output(ESS_ACTIVE_POWER, 1000))//
				.next(new TestCase() //
						.timeleap(clock, 2, ChronoUnit.SECONDS).input(METER_VOLTAGE, 235_600)// [mV]
						.output(ESS_ACTIVE_POWER, 1000))//
				.next(new TestCase() //
						.timeleap(clock, 2, ChronoUnit.SECONDS).input(METER_VOLTAGE, 234_000)// [mV]
						.output(ESS_ACTIVE_POWER, 1000))//
				.next(new TestCase("Fifth Input, \"Power: 1625 \"") //
						.timeleap(clock, 1, ChronoUnit.SECONDS).input(METER_VOLTAGE, 233_700)// [mV]
