...
public class EvcsUtils {
    ...
    /**
     * Converts a given power to current in Milliampere (assuming the voltage is 230 V).
     * 
     * @param power  in Watt
    ...
    /**
     * Converts a given current in Milliampere to power (assuming the voltage is 230V).
     * 
