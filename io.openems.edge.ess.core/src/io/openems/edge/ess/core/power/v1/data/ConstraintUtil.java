package io.openems.edge.ess.core.power.v1.data;
...
import static io.openems.edge.ess.core.power.v1.data.ApparentPowerConstraintUtil.generateConstraints;
...
public final class ConstraintUtil {
	...
	/**
	 * Creates a {@link Constraint.Simple} with only one Coefficient.
	 *
	 ...
	 * @return the {@link Constraint.Simple}
	 * @throws OpenemsException on error
	 */
	public static Constraint.Simple createSimpleConstraint(Coefficients coefficients, String description, String essId,
			SingleOrAllPhase phase, Pwr pwr, Relationship relationship, int value) throws OpenemsException {
		return new Constraint.Simple(description, //
				coefficients.of(essId, phase, pwr), //
				relationship, //
				value);
	}

	/**
	 * Creates a {@link Constraint} with only one Coefficient.
	 *
	 * @param coefficients the {@link Coefficients}
	 * @param description  a description for the Constraint
	 * @param essId        the component Id of a {@link ManagedSymmetricEss}
	 ...
	 * @throws OpenemsException on error
	 */
	public static Constraint createConstraint(Coefficients coefficients, String description, String essId,
