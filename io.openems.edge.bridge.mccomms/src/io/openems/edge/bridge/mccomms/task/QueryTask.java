...
/**
 * Class that allows {@link io.openems.edge.bridge.mccomms.api.AbstractMCCommsComponent}s to be queried for packets
 */
public class QueryTask {
	...
	/**
	 *
	 * @param bridge {@link io.openems.edge.bridge.mccomms.MCCommsBridge} instance used to execute this QueryTask
	 * @param writeTask the {@link WriteTask} used to send the querying packets
	 * @param replyTimeOut The period of time to wait for reply packets before timing out
	 * @param replyTimeOutUnit The time unit to use for {@code replyTimeOut}
	 * @param listenTasks The {@link ListenTask}s to use to receive reply packets
	 */
	...
	/**
	 * Static constructor used to send queries that only consist of an empty-payload packet with a specific command value
	 * @param bridge {@link io.openems.edge.bridge.mccomms.MCCommsBridge} instance used to execute this QueryTask
	 * @param thisAddress the address to use as the querying party in the transaction
	 ...
	 * @param replyTimeOut The period of time to wait for reply packets before timing out
	 * @param replyTimeOutUnit The time unit to use for {@code replyTimeOut}
	 * @param replyListenTasks The {@link ListenTask}s to use to receive reply packets
	 * @return a new QueryTask instance
	 * @throws OpenemsException If the {@link WriteTask} used to send the command packets cannot be instantiated {@link WriteTask#newCommandOnlyWriteTask(int, int, int)}
	 */
	...
	/**
	 * Method used to write do a serial bus, then do asynchronous blocking of the bus while waiting for a reply
