...
/**
 * Abstract class extended by components wanting to interface with a
 * {@link io.openems.edge.bridge.mccomms.MCCommsBridge} for device communication
 */
public abstract class AbstractMCCommsComponent extends AbstractOpenemsComponent {
	/**
	 * the MCComms address of the device being communicated with TODO remove this
	 * field
	 */
	private int mcCommsAddress;
	/**
	 * Atomic reference to the {@link io.openems.edge.bridge.mccomms.MCCommsBridge}
	 * being used for device communication
	 */
	...
	/**
	 * @see AbstractOpenemsComponent#AbstractOpenemsComponent(io.openems.edge.common.channel.ChannelId[],
	 *      io.openems.edge.common.channel.ChannelId[]...)
	 */
	protected AbstractMCCommsComponent(io.openems.edge.common.channel.ChannelId[] firstInitialChannelIds,
	 ...
	 * @param mcCommsAddress  the MCComms address of the device being communicated
	 *                        with TODO remove this field
	 * @param cm              {@link ConfigurationAdmin} of this component; passed
	 *                        by OSGi
	 *                        {@link org.osgi.service.component.annotations.Reference}
	 * @param mcCommsBridgeID the OSGi component ID of the
	 *                        {@link io.openems.edge.bridge.mccomms.MCCommsBridge
	 *                        used for device communication by this component
	 *                        instance}
	 */
	...
	/**
	 * @return the MCComms address of the device being communicated with TODO remove
	 *         this getter
	 */
	...
	/**
	 * @return the {@link io.openems.edge.bridge.mccomms.MCCommsBridge} being used
	 *         to communicate with the device this component instance controls
	 */
