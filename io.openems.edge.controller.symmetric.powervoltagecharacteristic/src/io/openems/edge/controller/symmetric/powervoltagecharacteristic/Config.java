...
@ObjectClassDefinition( //
		name = "Controller Power Voltage Characteristic", //
		description = "Defines a power voltage characteristic for storage system.")
@interface Config {

	@AttributeDefinition(name = "Component-ID", description = "Unique ID of this Component")
	String id() default "ctrlPwrVoltageCharacteristic0";
	...
	String webconsole_configurationFactory_nameHint() default "Controller Power Voltage Characteristic  [{id}]";
}