...
public class Rrd4jTimedataImpl extends AbstractOpenemsComponent
	...
	private ChannelDef getDsDefForChannel(Unit channelUnit) {
		...
		case AMPERE, AMPERE_HOURS, DEGREE_CELSIUS, DEZIDEGREE_CELSIUS, EUROS_PER_MEGAWATT_HOUR, HERTZ,HOUR,KILOAMPERE_HOURS, KILOOHM,KILOVOLT_AMPERE,KILOVOLT_AMPERE_REACTIVE,
			...
			VOLT_AMPERE, VOLT_AMPERE_REACTIVE, WATT_HOURS_BY_WATT_PEAK, OHM,SECONDS,THOUSANDTH -> 
		...
		case CUMULATED_SECONDS, WATT_HOURS, KILOWATT_HOURS, VOLT_AMPERE_HOURS, VOLT_AMPERE_REACTIVE_HOURS, KILOVOLT_AMPERE_REACTIVE_HOURS -> 		
			 new ChannelDef(DsType.GAUGE, Double.NaN, Double.NaN, ConsolFun.MAX);
		
		default -> throw new IllegalArgumentException("Unhandled Channel unit [" + channelUnit + "]");
		};		
	}
