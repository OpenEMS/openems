...
public class SmaPvInverterImpl extends AbstractSunSpecPvInverter
		implements SmaPvInverter, SunSpecPvInverter, ManagedSymmetricPvInverter, SymmetricMeter, ModbusComponent,
	...
	public SmaPvInverterImpl() throws OpenemsException {
		super(//
				ACTIVE_MODELS, //
				...
				SmaPvInverter.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(SmaPvInverterImpl.class, accessMode, 100) //
						.build());
	}
}
