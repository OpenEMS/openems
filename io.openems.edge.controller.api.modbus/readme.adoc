...
1. Open UI → Profile → System Settings → System profile
2. Card Configuration, section External interfaces
3. Expand the respective component entry
4. Click button Download protocol
5. The Excel file contains a maping of all registers to components and channels
6. Example file included in bundle's `doc` folder
