...
@ObjectClassDefinition(//
		name = "Controller Api Modbus/Serial Read-Write", //
		description = "This controller provides a read-write Modbus/Serial api.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Controller Api Modbus/Serial Read-Write [{id}]";
}