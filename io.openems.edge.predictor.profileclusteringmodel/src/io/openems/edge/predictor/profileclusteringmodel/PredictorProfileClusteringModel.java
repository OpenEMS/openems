...
public interface PredictorProfileClusteringModel extends Predictor, OpenemsComponent {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		/**
		 * Current state of the predictor profile clustering model training.
		 */
		PREDICTOR_PROFILE_CLUSTERING_MODEL_TRAINING_STATE(Doc.of(TrainingState.values())//
				.persistencePriority(PersistencePriority.HIGH)//
				.text("Current state of the predictor profile clustering model training.")), //
		/**
		 * Current state of the predictor profile clustering model prediction.
		 */
		PREDICTOR_PROFILE_CLUSTERING_MODEL_PREDICTION_STATE(Doc.of(PredictionState.values())//
				.persistencePriority(PersistencePriority.HIGH)//
				.text("Current state of the predictor profile clustering model prediction.")), //
	 ...
	 * {@link ChannelId#PREDICTOR_PROFILE_CLUSTERING_MODEL_TRAINING_STATE}.
	 *
	 * @return the Channel
	 */
	public default Channel<TrainingState> getTrainingStateChannel() {
		return this.channel(ChannelId.PREDICTOR_PROFILE_CLUSTERING_MODEL_TRAINING_STATE);
	}

	/**
	 * Gets the training Status of the predictor profile clustering model. See
	 * {@link ChannelId#PREDICTOR_PROFILE_CLUSTERING_MODEL_TRAINING_STATE}.
	 *
	 ...
	 * {@link ChannelId#PREDICTOR_PROFILE_CLUSTERING_MODEL_TRAINING_STATE} Channel.
	 *
	...
	/**
	 * Gets the Channel for
	 * {@link ChannelId#PREDICTOR_PROFILE_CLUSTERING_MODEL_PREDICTION_STATE}.
	 *
	 * @return the Channel
	 */
	public default Channel<PredictionState> getPredictionStateChannel() {
		return this.channel(ChannelId.PREDICTOR_PROFILE_CLUSTERING_MODEL_PREDICTION_STATE);
	}

	/**
	 * Gets the prediction Status of the predictor profile clustering model. See
	 * {@link ChannelId#PREDICTOR_PROFILE_CLUSTERING_MODEL_PREDICTION_STATE}.
	 *
	 * @return the Channel {@link Value}
	 */
