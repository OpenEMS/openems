...
@interface ConfigWirelessMbus {
    ...
    @AttributeDefinition(name = "Manual record position: Volume", description = "If \"Manual record position\" is selected: "
            + "Record position of metered volume in WM-Bus Telegram.")
    ...
    @AttributeDefinition(name = "Manual record position: Timestamp", description = "If \"Manual record position\" is selected: "
            + "Record position of timestamp in WM-Bus Telegram.")
    ...
    @AttributeDefinition(name = "Decryption key", description = "Decryption key of the WM-Bus telegram. Leave empty if "
            + "not encrypted.", type = AttributeType.PASSWORD)
    String key() default "";
