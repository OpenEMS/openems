...
@interface Config {
	...
	@AttributeDefinition(name = "Schedule", description = "Schedule for automatic mode")
	String schedule() default "________________________________________________________________________________________________";
